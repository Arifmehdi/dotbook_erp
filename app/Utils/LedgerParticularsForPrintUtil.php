...
class LedgerParticularsForPrintUtil
{
    public function particulars($request, $voucherType, $ledger, $by)
    {
        if ($voucherType == 0) {
            ...
            return $this->loanAndLiabilitiesDetails($request, $ledger);
        } elseif ($voucherType == 11) {
            return $this->loanAndAdvanceDetails($request, $ledger);
    ...
    public function salesDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"><strong>('.__('menu.as_per_details').')'.':</strong></td>';
            $voucherDetails .= '</tr>';

            // if ($ledger->account_id != $ledger?->sale?->sale_account_id) {

            //     $voucherDetails .= '<tr>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>Customer</strong></td>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : <a href="' . route('accounting.accounts.ledger', [($ledger?->sale?->customer_account_id ? $ledger?->sale?->customer_account_id : 'null'), 'accountId']) . '" class="text-black">' . $ledger?->sale?->customer?->name . '</a></td>';
            //     $voucherDetails .= '</tr>';
            // }

            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.total_qty').'</strong></td>';
            ...
            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.sale_discount').'</strong></td>';
            ...
            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.sale_tax').'</strong></td>';
            ...
            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.total_invoice_amount').'</strong></td>';
            ...
            $voucherDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.payment_note').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.$ledger?->sale?->payment_note.'</td>';
            $voucherDetails .= '</tr>';
        ...
        if ($request->inventory_list == 1) {
            ...
            foreach ($ledger->sale->saleProducts as $saleProduct) {
                ...
                if ($saleProduct->quantity > 0) {
                    ...
                    $inventoryDetails .= '<tr style="line-height:12px !important;padding:0px!important;">';
                    ...
                    $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">'.\App\Utils\Converter::format_in_bdt($soldQty).'/'.$saleProduct?->saleUnit?->code_name.'</td>';

                    $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($soldQty).'X'.$priceIncTax.')</td>';
        ...
        return '<p>'.$ledgerReferenceUser.'</p><p class="m-0 p-0" style="line-height:12px !important;padding:0px!important;"><strong>'.$showingAccount.'</strong></p>'.$voucherDetails.$inventoryDetails.$note;
    }
    ...
    public function salesReturnDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<table class="w-100">';
            // $voucherDetails .= '<tr>';
            // $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"><strong>Customer</strong></td>';
            // $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : ' . $ledger?->sale?->customer?->name . '</td>';
            // $voucherDetails .= '</tr>';
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"><strong>('.__('menu.as_per_details').')'.':</strong></td>';
            $voucherDetails .= '</tr>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.net_total_amount').'</strong></td>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.return_discount').'</strong></td>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.return_tax').'</strong></td>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.total_returned_amount').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.\App\Utils\Converter::format_in_bdt($ledger?->salesReturn?->total_return_amount).'</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
        ...
        if ($request->inventory_list == 1) {
            ...
            foreach ($ledger->salesReturn->returnProducts as $returnProduct) {
                ...
                if ($returnProduct->return_qty) {
                    ...
                    $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">'.\App\Utils\Converter::format_in_bdt($returnedQty).'/'.$returnProduct?->returnUnit?->code_name.'</td>';

                    $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($returnedQty).'X'.$unitPriceIncTax.')</td>';
        ...
        return '<p>'.$ledgerReferenceUser.'</p><p class="m-0 p-0"><strong>'.$showingAccount.'</strong></p>'.$voucherDetails.$inventoryDetails.$note;
    }
    ...
    public function purchaseDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            //     $voucherDetails .= '<tr>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"><strong>Supplier</strong></td>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : <a href="' . route('accounting.accounts.ledger', [($ledger?->purchase?->supplier_account_id ? $ledger?->purchase?->supplier_account_id : 'null'), 'accountId']) . '" target="_blank" class="text-black">' . $ledger?->purchase?->supplier?->name . '</a></td>';
            //     $voucherDetails .= '</tr>';
            // }
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.purchase_discount').'</strong></td>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.purchase_tax').'</strong></td>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.payment_note').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.$ledger?->purchase?->payment_note.'</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
        ...
        if ($request->inventory_list == 1) {
            ...
            foreach ($ledger->purchase->purchaseProducts as $purchaseProduct) {
                ...
                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">'.\App\Utils\Converter::format_in_bdt($purchasedQty).'/'.$purchaseProduct->purchaseUnit?->code_name.'</td>';

                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($purchasedQty).'X'.$unitCostIncTax.')</td>';
        ...
        return '<p class="m-0 p-0"><strong>'.$showingAccount.'</strong></p>'.$voucherDetails.$inventoryDetails.$note;
    }
    ...
    public function purchaseReturnDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            //     $voucherDetails .= '<tr>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"><strong>Supplier</strong></td>';
            //     $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : ' . $ledger?->purchaseReturn?->supplier?->name . '</td>';
            //     $voucherDetails .= '</tr>';
            // }
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.return_tax').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.\App\Utils\Converter::format_in_bdt($ledger?->purchaseReturn?->return_tax_amount).'</td>';
            $voucherDetails .= '</tr>';
        ...
        if ($request->inventory_list == 1 && isset($ledger->purchaseReturn->returnProducts)) {
            ...
            foreach ($ledger->purchaseReturn->returnProducts as $returnProduct) {
                ...
                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($returnedQty).'X'.$unitCostIncTax.')</td>';
    ...
    public function expenseDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<p><strong>'.$description?->account?->name.($transactionDetails ? '<p class="p-0 m-0">(<small>'.$transactionDetails.'</small>)</p>' : '');
        }
    ...
    {
        $showingAccount = $ledger?->stockAdjustment?->account?->name;
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.total_recovered_amount').'</strong></td>';
        ...
        if ($request->inventory_list == 1 && isset($ledger->stockAdjustment->adjustmentProducts)) {
            ...
            foreach ($ledger->stockAdjustment->adjustmentProducts as $adjustmentProduct) {
                ...
                $inventoryDetails .= '<tr>';
                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-50">- '.$adjustmentProduct?->product?->name.'</td>';
                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">'.\App\Utils\Converter::format_in_bdt($adjustedQty).'/'.$adjustmentProduct?->stockAdjustmentUnit?->code_name.'</td>';

                $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($adjustedQty).'X'.\App\Utils\Converter::format_in_bdt($unitCostIncTax).')</td>';
    ...
    public function paymentOrReceiptDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            foreach ($descriptions as $description) {
                ...
                $voucherDetails .= '<tr>';
                $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60">'.'<strong>'.$description?->account?->name.'</strong>'.$assignedUser.'</td>';
                $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;">: '.$amount.$amount_type.'</td>';
                ...
                if (count($description->references) > 0) {
                    ...
                    $referencesDetails = '';
                    // $referencesDetails = '<tr style="line-height:12px !important;padding:0px!important;"><td colspan="2" style="line-height:12px !important;padding:0px!important;"> </td></tr>';
                    $referencesDetails .= '<tr><td colspan="2" style="line-height:12px !important;padding:0px!important;"><strong>(Against References) :</strong>';
                    foreach ($description->references as $reference) {
                        ...
                        if ($reference->sale) {
                            ...
                            if ($reference->sale->order_status == 1) {
                                ...
                                $sale = '<p class="fw-bold" style="line-height:10px4px">Sales-Order : '.$reference->sale->order_id.' = '.\App\Utils\Converter::format_in_bdt($reference->amount).'<p>';
                            } else {

                                $sale = '<p class="fw-bold" style="line-height:10px4px">Sales : '.$reference?->sale->invoice_id.' = '.\App\Utils\Converter::format_in_bdt($reference->amount).'<p>';
                            }
                        }
                        ...
                        if ($reference->purchase) {
                            ...
                            if ($reference->purchase->purchase_status == 1) {
                                ...
                                $purchase = '<p class="fw-bold" style="line-height:10px4px">Purchase : '.$reference?->purchase->invoice_id.' = '.\App\Utils\Converter::format_in_bdt($reference->amount).'<p>';
                            } else {

                                $purchase = '<p class="fw-bold" style="line-height:10px4px">PO : '.$reference?->purchase->invoice_id.' = '.\App\Utils\Converter::format_in_bdt($reference->amount).'<p>';
                            }
                        }
                        ...
                        if ($reference->stockAdjustment) {
                            ...
                            $stockAdjustment = '<p class="fw-bold" style="line-height:10px4px">PO : '.$reference?->stockAdjustment->voucher_no.' = '.\App\Utils\Converter::format_in_bdt($reference->amount);
                        }
            ...
            $voucherDetails .= '<p>'.$__ledgerReferenceUser.'</p><p><strong>'.$description?->account?->name.'</strong>'.$assignedUser.'</p>'.($transactionDetails ? '<p class="p-0 m-0">'.$transactionDetails.'</p>' : '');
        }
    ...
    public function contraDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<p><strong>'.$description?->account?->name.'</strong></p>'.($transactionDetails ? '<p class="p-0 m-0">'.$transactionDetails.'</p>' : '');
        }
    ...
    public function journalDetails($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1 && isset($entries)) {
            ...
            foreach ($entries as $entry) {
                ...
                $voucherDetails .= '<tr>';
                $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60">'.'<strong>'.$entry?->account?->name.'</a></strong>'.$assignedUser.'</td>';
                $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;">: '.$amount.$amount_type.'</p>'.'</td>';
                $voucherDetails .= '</tr>';

                if ($transactionDetails) {

                    $voucherDetails .= '<tr><td colspan="2" style="line-height:12px !important;padding:0px!important;" class="w-60">'.$transactionDetails.'</td></tr>';
                }
            }
            ...
            $voucherDetails .= '<p>'.$__ledgerReferenceUser.'</p><p><strong>'.$entry?->account?->name.'</strong>'.$assignedUser.'</p>'.($transactionDetails ? '<p class="p-0 m-0">'.$transactionDetails.'</p>' : '');
        }
    ...
    public function saleProductTax($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.sale_tax').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.\App\Utils\Converter::format_in_bdt($saleProduct?->sale?->order_tax_amount).'</td>';
            $voucherDetails .= '</tr>';
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.payment_note').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.$saleProduct?->sale?->payment_note.'</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
        ...
        if ($request->inventory_list == 1 && isset($saleProduct?->sale?->saleProducts)) {
            ...
            foreach ($saleProduct->sale->saleProducts as $saleProduct) {
                ...
                if ($saleProduct->quantity > 0) {
                    ...
                    $inventoryDetails .= '<td style="line-height:12px !important;padding:0px!important;">('.\App\Utils\Converter::format_in_bdt($soldQty).'X'.$saleProduct->unit_price_inc_tax.')</td>';
    ...
    public function purchaseProductTax($request, $ledger)
    {
        ...
        if ($request->voucher_details == 1) {
            ...
            $voucherDetails .= '<tr>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;" class="w-60"><strong>'.__('menu.payment_note').'</strong></td>';
            $voucherDetails .= '<td style="line-height:12px !important;padding:0px!important;"> : '.$purchaseProduct?->purchase?->payment_note.'</td>';
            $voucherDetails .= '</tr>';
            $voucherDetails .= '</table>';
        }
