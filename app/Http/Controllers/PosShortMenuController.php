...
class PosShortMenuController extends Controller
{
    public function showModalForm()
    {
        ...
        return view('sales_app.pos.ajax_view.short-menu-modal-form', compact('posShortMenus'));
    }
    ...
    public function show()
    {
        ...
        return view('sales_app.pos.ajax_view.pos-shortcut-menus', compact('posShortMenus'));
    }
    ...
    public function editPageShow()
    {
        ...
        return view('sales_app.pos.ajax_view.edipos-edit-shortcut-munus', compact('posShortMenus'));
    }
