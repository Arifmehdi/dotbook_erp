...
class ProductionController extends Controller
{
    ...
    public function create()
    {
        ...
        $productionAccounts = DB::table('accounts')
    ...
    public function store(Request $request)
    {
        ...
        $addProduction->tax_ac_id = $tax_ac_id;
        ...
        if (isset($request->is_final)) {
            ...
            if (json_decode($generalSetting->mf_settings, true)['enable_updating_product_price'] == '1') {
                ...
                $this->productionUtil->updateProductAndVariantPriceByProduction($request->product_id, $request->variant_id, $request->per_unit_cost_exc_tax, $request->per_unit_cost_inc_tax, $request->xMargin, $request->selling_price, $tax_ac_id, $request->tax_type);
            }
            ...
            if (isset($request->store_warehouse_count)) {
                ...
                $this->productStockUtil->addBranchProduct($request->product_id, $request->variant_id);
                $this->productStockUtil->adjustBranchStock($request->product_id, $request->variant_id);
            }
    ...
    public function update(Request $request, $productionId)
    {
        ...
        $updateProduction->tax_ac_id = $tax_ac_id;
        ...
        if (json_decode($generalSetting->mf_settings, true)['enable_updating_product_price'] == '1') {
            ...
            if ($updateProduction->is_last_entry == 1) {
                ...
                $this->productionUtil->updateProductAndVariantPriceByProduction($updateProduction->product_id, $updateProduction->variant_id, $request->per_unit_cost_exc_tax, $request->per_unit_cost_inc_tax, $request->xMargin, $request->selling_price, $tax_ac_id, $request->tax_type);
            }
        }
        ...
        if (isset($request->store_warehouse_count)) {
            ...
            $this->productStockUtil->adjustBranchStock($updateProduction->product_id, $updateProduction->variant_id);
        }
