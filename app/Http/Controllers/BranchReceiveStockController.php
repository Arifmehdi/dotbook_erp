...
class BranchReceiveStockController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $users = DB::table('users')->get(['id', 'prefix', 'name', 'last_name', 'email']);
    ...
    {
        $sendStock = TransferStockToBranch::with(['warehouse', 'transfer_products', 'transfer_products.product', 'transfer_products.variant'])->where('id', $sendStockId)->first();
    ...
    {
        $sandStocks = TransferStockToBranch::with(['warehouse', 'transfer_products', 'transfer_products.product', 'transfer_products.variant'])
    ...
    public function receiveProcessSave(Request $request, $sendStockId)
    {
        ...
        foreach ($product_ids as $product_id) {
            ...
            $this->productStockUtil->addBranchProduct($product_id, $variant_id);
