                ...
                <td class="text-start">
                    <div class="dropdown table-dropdown">
                        @if (auth()->user()->can('role_edit'))
                            <a href="{{ route('users.role.edit', $role->id) }}" id="edit" title="Edit details" class="action-btn c-edit" id="edit">
                        ...
                        @if (auth()->user()->can('role_delete') && ($role->name !== 'superadmin'))
                            <a href="{{ route('users.role.delete', $role->id) }}" class="action-btn c-delete" id="delete">
