<div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-8">
                                <input required type="number" step="any" name="received_amount" class="form-control"
                                    id="received_amount" autocomplete="off">
    ...
    <div class="col-md-12 d-flex justify-content-end pt-2">
        <div class="loading-btn-box">
            ...
            <button data-action="save" class="btn btn-success submit_button me-2">@lang('menu.save')</button>
            <button data-action="save_and_print" class="btn btn-success submit_button">@lang('menu.save_and_print')</button>
        </div>
    </div>
</div>
