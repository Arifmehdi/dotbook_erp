...
<div class="modal-dialog four-col-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="payment_heading">@lang('menu.income_receipt')</h6>
        ...
        <div class="modal-body" id="payment-modal-body">
                    ...
                    <div class="col-md-6">
                        <div class="payment_top_card">
                            <ul class="list-unstyled">
                                <li><strong> @lang('menu.voucher_no') : </strong>{{ $income->voucher }} </li>
            ...
            <form id="add_receipt_form" action="{{ route('income.receipts.store', $income->id) }}" method="POST"
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input required type="number" step="any" name="received_amount" class="form-control"
                                id="received_amount" data-name="Amount" value="" />
                        </div>
