...
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            ...
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.customer_balances')</h6>
                </div>
                <x-all-buttons>
                    <x-slot name="after">
                            ...
                            <form id="filter_tax_report_form" action="" method="get">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <select name="customer_id" class="form-control submit_able select2 form-select"
                                    ...
                                    @if (!auth()->user()->can('view_own_sale'))
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="user_id" class="form-control submit_able select2 form-select"
                            ...
                            <table class="display data_tbl data__table">
                                ...
                                <tfoot>
                                    <tr class="bg-secondary">
                                        <th class="text-endx text-white">@lang('menu.total') :
                                            {{ json_decode($generalSettings->business, true)['currency'] }}</th>
                                        <th id="opening_balance" class="text-white">0.00</th>
                                        <th id="debit" class="text-white">0.00</th>
                                        <th id="credit" class="text-white">0.00</th>
                                        <th id="closing_balance" class="text-white">0.00</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
