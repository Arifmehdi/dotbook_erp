<style>
    ...
    @page {size:a4;margin-top: 0.8cm; margin-bottom: 35px; margin-left: 5px!important;margin-right: 5px!important;}
    ...
    td { font-size:10px; }
        ...
        * { box-sizing: border-box;}
        ...
        td.debit_area {line-height: 15px!important;}
        td.credit_area {line-height: 15px!important;}
...
<div class="row mt-2">
    <div class="col-12">
        <table class="w-100 print_table">
            ...
            <tbody>
                <tr>
                    <td class="debit_area" style="border: 1px solid black;width: 50%;">
                    ...
                    <td class="credit_area" style="border-left: 1px solid #000;border-right:1px solid #000">
