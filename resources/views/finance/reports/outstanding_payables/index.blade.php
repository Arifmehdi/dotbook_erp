...
@push('css')
    ...
    <style>
        * {
        ...
        .outstanding_payable_area tbody tr td {
            line-height: 16px;
        }
...
@endpush
@section('title', __('menu.outstanding_payables') . ' - ')
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            ...
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.outstanding_payables')</h6>
                </div>
                <x-all-buttons>
                ...
                <div class="col-md-12">
                    <div class="form_element rounded m-0 h-100">
                        <div class="element-body">
                            <form id="filter_outstanding_payable"
                                action="{{ route('reports.outstanding.payable.data.view') }}" method="get">
                                ...
                                <div id="data-list" class="table-responsive">
                                    <table class="w-100">
                                        ...
                                        <tfoot class="net_total_balance_footer">
                                            <tr>
                                                <td colspan="3" class="text-white footer_total ps-1 fw-bold">
                                                    @lang('menu.total') :</td>
                                                <td class="text-white footer_total_amount ps-1 fw-bold">0.00</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function getOutstandingPayables() {

            $('.data_preloader').show();
            var from_date = $('#from_date').val();
            var to_date = $('#to_date').val();
            $.ajax({
                url: "{{ route('reports.outstanding.payable.data.view') }}",
                data: {
                    from_date,
                    to_date
                },
        ...
        $('#filter_outstanding_payable').on('submit', function(e) {
            e.preventDefault();
        ...
        $(document).on('click', '#print_report_btn', function(e) {
            ...
            var url = "{{ route('reports.outstanding.payable.data.print') }}";
