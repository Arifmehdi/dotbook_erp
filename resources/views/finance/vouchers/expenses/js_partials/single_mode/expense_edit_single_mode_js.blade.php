<script>
    ...
    $(document).on('keypress', '#date', function(e) {
        ...
        if (e.keyCode == 13) {
            ...
            $('#is_transaction_details').focus();
        }
    });

    $(document).on('click keypress', '#is_transaction_details', function(e) {

        if (e.which == 0) {

            $('#maintain_cost_centre').focus();
        }
    });

    $(document).on('click keypress', '#maintain_cost_centre', function(e) {
