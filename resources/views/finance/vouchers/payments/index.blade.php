...
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.payments')</h6>
                </div>
                <x-all-buttons>
                    <x-add-button :modal="'#paymentModeModal'" />
                    <x-slot name="after">
                        <x-help-button />
                    </x-slot>
                </x-all-buttons>
                                ...
                                <table class="display data_tbl data__table">
                                    ...
                                    <tfoot>
                                        <tr class="bg-secondary">
                                            ...
                                            <th id="debit_total" class="text-white text-start"></th>
                                            <th id="credit_total" class="text-white text-start"></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
    ...
    <div class="modal fade" id="paymentModeModal" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog col-30-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">@lang('menu.payment_mode')</h6>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <a href="{{ route('vouchers.payments.create', '1') }}" class="btn btn-primary" id="addPayment">@lang('menu.single_entry')</a>
                        </div>

                        <div class="col-md-6 text-center">
                            <a href="{{ route('vouchers.payments.create', '2') }}" class="btn btn-primary" id="addPayment">@lang('menu.double_entry')</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('vouchers.payments.index') }}",
                "data": function(d) {
            ...
            columns: [{
                ...
                data: 'remarks',
                name: 'payments.remarks'
            }, {
                data: 'descriptions',
                name: 'payments.voucher_no'
            }, {
                data: 'debit_total',
                name: 'payments.debit_total',
                className: 'fw-bold'
            }, {
                data: 'credit_total',
                name: 'payments.credit_total',
                className: 'fw-bold'
            }, ],
