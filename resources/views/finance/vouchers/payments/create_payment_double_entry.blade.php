...
@endpush
@section('title', 'Add Payment (Double Entry) - ')
@section('content')
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="form_element mt-0 border-0">
                    <div class="sec-name">
                        <h6>@lang('menu.add_payment_double_entry')</h6>
                        <x-back-button />
                    </div>
                </div>
            </div>

            <form id="add_payment_double_entry_form" action="{{ route('vouchers.payments.store') }}" method="POST">
                @csrf
                                                                    ...
                                                                    <div class="row py-1">
                                                                        ...
                                                                        <div class="col-4">
                                                                            <p class="fw-bold text-muted curr_bl">Curr.
                                                                                Bal. : <span id="account_balance" class="fw-bold text-dark voidable"></span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="remarks" class="form-control" id="remarks" data-next="payment_submit_btn" placeholder="@lang('menu.remarks')">
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#add_payment_double_entry_form').on('submit', function(e) {
            e.preventDefault();
        ...
        function afterCreateSale() {
            ...
            $('.voidable').html('');
            $('.removable').remove();
            $('#add_payment_double_entry_form')[0].reset();
