        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    @lang('menu.payment_voucher') (@lang('menu.voucher_no') : <strong><span>{{ $payment->voucher_no }}</span></strong>)
                </h5>
            ...
            <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table modal-table table-sm table-striped">
                            ...
                            <tbody class="sale_product_list">
                                @foreach ($payment->descriptions->sortByDesc('amount_type') as $description)
                                    <tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p style="text-transform: uppercase;"><strong>@lang('menu.in_word') : </strong> {{ $inWord->format($payment->credit_total) }} ({{ json_decode($generalSettings->business, true)['currency'] }}) @lang('menu.only').</p>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                @if (auth()->user()->can('payments_edit'))
                    ...
                    <a href="{{ route('vouchers.payments.edit', [$payment->id]) }}" class="btn btn-sm btn-secondary m-0 me-2">@lang('menu.edit')</a>
                @endif
    ...
    <div class="details_area">
        ...
        <div class="row mt-1">
            <div class="col-12 text-center">
                <h5 style="text-transform: uppercase;">@lang('menu.payment_voucher')</h5>
            </div>
        </div>
            ...
            <div class="col-6">
                <ul class="list-unstyled">
                    <li style="font-size:11px!important;">
                        <strong>@lang('menu.date') : </strong> {{ date($dateFormat ,strtotime($payment->date_ts))}}
                    </li>

                    <li style="font-size:11px!important;">
                        <strong>@lang('menu.voucher_no') : </strong> {{ $payment->voucher_no }}
                    </li>
                </ul>
            </div>
        ...
        <div class="sale_product_table mt-2">
            <table class="table report-table table-sm table-bordered print_table">
                ...
                <tfoot>
                    <tr>
                        <th colspan="3" class="text-end text-black"><span class="text-end">{{ __("Total") }} : </span></th>
                        <th class="text-end text-black">{{ App\Utils\Converter::format_in_bdt($payment->debit_total) }}</th>
                        <th class="text-end text-black">{{ App\Utils\Converter::format_in_bdt($payment->credit_total) }}</th>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-transform: uppercase; font-size:11px!important;"><strong>@lang('menu.in_word') : </strong> {{ $inWord->format($payment->debit_total) }} ({{ json_decode($generalSettings->business, true)['currency'] }}) @lang('menu.only').</p>
                <p class="p-0 m-0" style="font-size:11px!important;"><strong>@lang('menu.remarks') :</strong>  {{ $payment->remarks }}</p>
            </div>
        </div>
