...
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.journals')</h6>
                </div>
                <x-all-buttons>
                    <x-add-button :href="route('vouchers.journals.create')" id="addJournal" :is_modal="false" />
                    <x-slot name="after">
                        <x-help-button />
                    </x-slot>
                </x-all-buttons>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('vouchers.journals.index') }}",
                "data": function(d) {
            ...
            columns: [{
                ...
                {
                    data: 'remarks',
                    name: 'journals.remarks'
                }, {
                    data: 'entries',
                    name: 'journals.voucher_no'
                }, {
                    data: 'debit_total',
                    name: 'journals.debit_total',
                    className: 'fw-bold'
                }, {
                    data: 'credit_total',
                    name: 'journals.credit_total',
                    className: 'fw-bold'
                },
            ],
