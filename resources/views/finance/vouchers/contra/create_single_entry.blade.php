...
@endpush
@section('title', 'Add Contra (Single Entry) - ')
@section('content')
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="form_element mt-0 border-0">
                    <div class="sec-name">
                        <h6>@lang('menu.add_contra_single_entry')</h6>
                        <x-back-button />
                    </div>
                </div>
            </div>

            <form id="add_contra_single_entry_form" action="{{ route('vouchers.contras.store') }}" method="POST">
                @csrf
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="remarks" class="form-control" id="remarks" data-next="contra_submit_button" placeholder="@lang('menu.remarks')">
                                    </div>
                                </div>
...
@push('scripts')
            ...
            $.ajax({
                ...
                success: function(accounts) {
                    ...
                    if (isSingleModeFirstAcField == 1) {
                        ...
                        li =
                            '<li><a class="select_account text-danger" data-is_end_list="1" data-account_name="" data-default_account_name="" data-account_id="" data-sub_sub_group_number="" href="#">List-End</a></li>';
                    }
                    ...
                    $.each(accounts, function(key, account) {
                        ...
                        li += '<li>';
                        li += '<a class="select_account ' + (key == 0 && length == 1 ? 'selected_account' : '') + '" data-is_end_list="0" data-account_name="' + account.name + accuntNumber + '" data-default_account_name="' + account.name + '" data-account_id="' + account.id + '" data-sub_sub_group_number="' + account.sub_sub_group_number + '" href="#"> ' + account.name + accuntNumber +
                            groupName + '</a>';
                        li += '</li>';
                    });
    ...
    <script>
        ...
        $('#add_contra_single_entry_form').on('submit', function(e) {
            e.preventDefault();
        ...
        function afterCreateSale() {
            ...
            $('.voidable').val('');
            $('.voidable').html('');
            $('#add_contra_single_entry_form')[0].reset();
