...
@endpush
@section('title', 'Add Receipt (Single Entry) - ')
@section('content')
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="form_element mt-0 border-0">
                    <div class="sec-name">
                        <h6>@lang('menu.add_receipt_single_entry')</h6>
                        <x-back-button />
                    </div>
                </div>
            </div>

            <form id="add_receipt_single_entry_form" action="{{ route('vouchers.receipts.store') }}" method="POST">
                @csrf
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="text" data-only_type="bank_or_cash_accounts" data-is_single_mode_first_ac_field="1" id="search_account" class="form-control fw-bold" autocomplete="off">
                                                                    <input type="hidden" id="account_name" class="voidable">
                                                                    <input type="hidden" id="default_account_name" class="voidable">
                                                                    <input type="hidden" name="account_ids[]" id="account_id" class="voidable debit_account_id">
                                                                    ...
                                                                    <input type="hidden" name="cheque_nos[]" id="cheque_no" class="hidden">
                                                                    ...
                                                                    <input type="hidden" name="debit_amounts[]" class="form-control fw-bold" id="debit_amount" value="0.00">
                                                                    <input type="hidden" name="credit_amounts[]" class="form-control fw-bold" id="credit_amount" value="0.00">
                                                                    <p class="fw-bold text-muted curr_bl">Curr. Bal. : <span id="account_balance" class="fw-bold text-dark voidable"></span></p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="remarks" class="form-control" id="remarks" data-next="receipt_submit_button" placeholder="@lang('menu.remarks')">
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        function addNewRow() {
            ...
            html += '<input readonly type="text" name="amount_types[]" id="amount_type" class="form-control fw-bold" value="Cr" tabindex="-1">';
            html += '</div>';
    ...
    <script>
        ...
        $('#add_receipt_single_entry_form').on('submit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    afterCreateSale();
                    toastr.success('Receipt is created successfully');
                },
                error: function(err) {
        ...
        function afterCreateSale() {
            ...
            $('.voidable').val('');
            $('.voidable').html('');
            $('#add_receipt_single_entry_form')[0].reset();
