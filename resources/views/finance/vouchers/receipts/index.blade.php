...
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.receipts')</h6>
                </div>
                <x-all-buttons>
                    <x-add-button :modal="'#receiptModeModal'" />
                </x-all-buttons>
            </div>
        </div>
    ...
    <div class="modal fade" id="receiptModeModal" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog col-30-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">@lang('menu.receipt_mode')</h6>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <a href="{{ route('vouchers.receipts.create', '1') }}" class="btn btn-primary" id="addReceipt">@lang('menu.single_entry')</a>
                        </div>

                        <div class="col-md-6 text-center">
                            <a href="{{ route('vouchers.receipts.create', '2') }}" class="btn btn-primary" id="addReceipt">@lang('menu.double_entry')</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('vouchers.receipts.index') }}",
                "data": function(d) {
