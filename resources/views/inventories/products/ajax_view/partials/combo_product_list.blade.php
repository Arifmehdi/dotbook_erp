<table id="single_product_pricing_table" class="table modal-table table-sm">
    <thead>
        <tr class="bg-primary">
            <th class="text-white text-start">@lang('menu.item_name')</th>
            <th class="text-white text-start">@lang('menu.product_cost') (Inc.Tax)</th>
            <th class="text-white text-start">@lang('menu.profit_margin')(%)</th>
            <th class="text-white text-start">@lang('menu.default_selling_price') (@lang('menu.exc_tax'))</th>
