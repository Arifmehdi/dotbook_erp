        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    @lang('menu.daily_stock_voucher') (@lang('menu.voucher_no') : <strong><span>{{ $dailyStock->voucher_no }}</span></strong>)
                </h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="details_area">
                            <p style="font-size:11px!important;"><strong>@lang('menu.production_details')</strong> : </p>
                            <p style="font-size:11px!important;">{{ $dailyStock->production_details }}</p>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="details_area">
                            <p style="font-size:11px!important;"><strong>@lang('menu.special_note')</strong> : </p>
                            <p style="font-size:11px!important;">{{ $dailyStock->note }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="footer_btn btn btn-sm btn-primary print_btn m-0 me-2">@lang('menu.print') </button>
