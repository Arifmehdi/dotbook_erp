...
@endpush
@section('title', 'Stock Adjustment Item Report - ')
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.stock_adjusted_item_report')</h6>
                </div>
                <x-all-buttons>
                    <x-slot name="after">
                        <button class="btn text-white btn-sm px-1" id="print_report"><i class="fa-thin fa-print fa-2x"></i><br> @lang('menu.print')</button>
                        <x-help-button />
                    </x-slot>
                </x-all-buttons>
            </div>
...
@push('scripts')
    ...
    <script>
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('reports.stock.adjusted.index') }}",
                "data": function(d) {
        ...
        $(document).on('click', '#print_report', function(e) {
            ...
            var url = "{{ route('reports.stock.adjusted.print') }}";
