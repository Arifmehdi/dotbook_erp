<div class="modal-dialog col-40-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.edit_price_group')</h6>
            ...
            <form id="edit_price_group_form" action="{{ route('product.selling.price.groups.update', $pg->id) }}" method="POST">
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" class="form-control" id="price_group_name" value="{{ $pg->name }}" data-next="price_group_description" placeholder="@lang('menu.name')"/>
                ...
                <div class="form-group row mt-1">
                    <div class="col-md-12">
                        ...
                        <input name="description" class="form-control" id="price_group_description" value="{{ $pg->description }}" data-next="price_group_save_changes_btn" placeholder="@lang('menu.description')">
                    </div>
                </div>
                ...
                <div class="form-group row mt-2">
                    <div class="col-md-12 d-flex justify-content-end">
                        <div class="loading-btn-box">
                            ...
                            <button type="submit" id="price_group_save_changes_btn" class="btn btn-sm btn-success float-end price_group_submit_button">@lang('menu.save_changes')</button>
