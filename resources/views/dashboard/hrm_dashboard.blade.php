                ...
                <div class="breadCrumbHolder module w-100">
                    <div id="breadCrumb3" class="breadCrumb module">
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('hrm.departments') }}" class="text-dark text-muted"><i class="far fa-building"></i> <b>@lang('menu.departments')</b></a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form_element">
                            ...
                            <div class="widget_content">
                                <div class="px-3 pt-2">
                                    <div class="px-1"><strong>@lang('menu.today'):</strong></div>
