                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        @if (auth()->user()->is_marketing_user == 0)
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <select required name="user_id" id="user_id" class="form-control select2" data-next="customer_account_id">
                                                        <option value="">@lang('menu.select_sr')</option>
                                                        @foreach ($users as $user)
                                                            <option data-user_name="{{ $user->prefix . ' ' . $user->name . ' ' . $user->last_name . '/' . $user->phone }}" {{ $sale->sr_user_id == $user->id ? 'SELECTED' : '' }} value="{{ $user->id }}">
                                            ...
                                            <div class="col-8">
                                                <div class="input-group select-customer-input-group">
                                                    <div style="display: inline-block;" class="select-half">
                                                        <select required name="customer_account_id" class="form-control select2" id="customer_account_id" data-next="all_price_type">
                                                            <option value="">@lang('menu.select_customer')</option>
                                                            @foreach ($customerAccounts as $customerAccont)
                                                                <option {{ $sale->customer_account_id == $customerAccont->id ? 'SELECTED' : '' }} data-customer_name="{{ $customerAccont->name }}" data-customer_phone="{{ $customerAccont->phone }}" value="{{ $customerAccont->id }}">
                                        ...
                                        <div class="input-group mt-1">
                                            ...
                                            <div class="col-8">
                                                ...
                                                <input readonly type="hidden" id="debit_amount" value="{{ $amounts['all_total_debit'] }}">
                                                <input readonly type="hidden" id="credit_amount" value="{{ $amounts['all_total_credit'] }}">
                                                <input readonly type="hidden" id="current_customer_account_id" value="{{ $sale->customer_account_id }}">
                                                <input readonly type="hidden" id="current_invoice_amount" value="{{ $sale->total_payable_amount }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="col-8">
                                                <input readonly type="text" name="invoice_id" id="invoice_id" class="form-control fw-bold" value="{{ $sale->invoice_id }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mt-1">
                                            ...
                                            <div class="col-8">
                                                <select required name="all_price_type" class="form-control" id="all_price_type" data-next="warehouse_id">
                                                    <option value="">@lang('menu.select_rate_type')</option>
                                                    <option {{ $sale->all_price_type == 'PR' ? 'SELECTED' : '' }} value="PR">PR</option>
                                                    <option {{ $sale->all_price_type == 'MR' ? 'SELECTED' : '' }} value="MR">MR</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mt-1">
                                            ...
                                            <div class="col-8">
                                                <select name="warehouse_id" class="form-control" id="warehouse_id" data-next="price_group_id">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="input-group mt-1">
                                            ...
                                            <div class="col-8">
                                                <select name="price_group_id" class="form-control" id="price_group_id" data-next="date">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="date" class="form-control" id="date" value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($sale->date)) }}" data-next="sale_account_id" autocomplete="off">
                                                <span class="error error_date"></span>
                                            </div>
                                        </div>

                                        <div class="input-group mt-1">
                                            <label class="col-4"><b>@lang('menu.sales_ledger') </b> <span class="text-danger">*</span></label>
                                            <div class="col-8">
                                                <select name="sale_account_id" class="form-control select2" id="sale_account_id" data-next="search_product">
                                            ...
                                            <div class="row g-1 align-items-end">
                                                <div class="col-md-4">
                                                    <div class="searching_area" style="position: relative;">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="search_product" class="form-control fw-bold" id="search_product" placeholder="{{ __('Search Item By Name/Code') }}" autocomplete="off" autofocus>
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="row g-1">
                                                        <div class="col-xl-6 col-md-6">
                                                            <label class="fw-bold">@lang('menu.imei_sl_no_other_info')</label>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        ...
                                                        <input readonly type="text" class="form-control text-success fw-bold" id="stock_quantity" placeholder="@lang('menu.stock_quantity')" autocomplete="off" tabindex="-1">
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <table class="display data__table table sale-product-table">
                                                                <thead class="staky">
                                                                    <tr>
                                                                        ...
                                                                        @if ($sale->status == 1)
                                                                            <th class="text-startx">@lang('menu.stock_location')</th>
                                                                        @endif
                                                                        ...
                                                                        <tr id="select_item">
                                                                            <td class="text-start">
                                                                                @php
                                                                                    ...
                                                                                    $currentStock = $saleProduct->product_variant_id ? $saleProduct->variant->variant_quantity : $saleProduct->product->quantity;
                                                                                ...
                                                                                @endphp
                                                                                <input type="hidden" value="{{ $saleProduct->unit_discount_type }}" name="unit_discount_types[]" id="unit_discount_type">
                                                                                ...
                                                                                <input type="hidden" class="unique_id" id="{{ $saleProduct->product_id . $variantId . $saleProduct->stock_warehouse_id }}" value="{{ $saleProduct->product_id . $variantId . $saleProduct->stock_warehouse_id }}">
                                                                            </td>

                                                                            <td class="text-start">
                                                                                <input type="hidden" name="warehouse_ids[]" id="warehouse_id" value="{{ $saleProduct->stock_warehouse_id }}">

                                                                                <input type="hidden" id="current_warehouse_id" value="{{ $saleProduct->stock_warehouse_id }}">
                                                                            ...
                                                                            <td>
                                                                                @php
                                                                                    $showingQuantity = $saleProduct->quantity / $baseUnitMultiplier;
                                                                                @endphp
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                @endphp
                                                                                <span id="span_price_type" tabindex="-1">{{ $saleProduct->price_type . $showPrAmount }}</span>
                                                                            ...
                                                                            <td class="text text-center">
                                                                                ...
                                                                                <input value="{{ $saleProduct->subtotal }}" readonly name="subtotals[]" type="hidden" id="subtotal">
                                                                            </td>
                                    ...
                                    <div class="item-details-sec">
                                        <div class="content-inner">
                                            <div class="row mt-1 pb-3">
                                                <div class="col-md-4">
                                                    <label><b>@lang('menu.sale_note')</b></label>
                                                    <input name="sale_note" class="form-control" id="sale_note" value="{{ $sale->sale_note }}" placeholder="@lang('menu.sale_note')" data-next="shipping_address">
                                                </div>

                                                <div class="col-md-4">
                                                    <label><b>@lang('menu.shipping_address')</b></label>
                                                    <input name="shipping_address" class="form-control" id="shipping_address" value="{{ $sale->shipping_address }}" placeholder="@lang('menu.shipping_address')" data-next="payment_note">
                                                </div>

                                                <div class="col-md-4">
                                                    <label><b>@lang('menu.payment_note')</b></label>
                                                    <input name="payment_note" class="form-control" id="payment_note" value="{{ $sale->payment_note }}" placeholder="@lang('menu.payment_note')" data-next="order_discount">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row g-1">
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input readonly type="number" step="any" name="total_qty" class="form-control" id="total_qty" value="{{ $sale->total_sold_qty }}" tabindex="-1">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <label class="col-sm-5 text-end fw-bold">@lang('menu.sale_discount')</label>
                                                        <div class="col-sm-7">
                                                            <div class="input-group">
                                                                <input name="order_discount" type="number" step="any" class="form-control w-60" id="order_discount" value="{{ $sale->order_discount }}" data-next="order_discount_type">
                                                                ...
                                                                <select name="order_discount_type" class="form-control w-40" id="order_discount_type" data-next="order_tax_ac_id">
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select name="order_tax_ac_id" class="form-control" id="order_tax_ac_id" data-next="shipment_charge">
                                                                <option data-order_tax_percent="0.00" value="">
                                                                    @lang('menu.no_tax')</option>
                                                                @foreach ($taxAccounts as $taxAccount)
                                                                    <option {{ $taxAccount->id == $sale->tax_ac_id ? 'SELECTED' : '' }} data-order_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                                        {{ $taxAccount->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input name="shipment_charge" type="number" step="any" class="form-control" id="shipment_charge" value="{{ $sale->shipment_charge }}" data-next="receive_amount">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row g-1">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        <select name="account_id" class="form-control" id="account_id" data-next="transaction_no">
                                                                            <option value="">Select Debit A/c
                                                                            </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="opening_balance_type" class="form-control w-35 input_f form-select">
...
@push('scripts')
    ...
    <script>
        ...
        function searchProduct(keyWord, price_group_id) {
            ...
            var url =
                "{{ route('general.product.search.common', [':keyWord', ':isShowNotForSaleItem', ':price_group_id', ':type', $sale->id]) }}";
                                ...
                                if (product.unit.child_units.length > 0) {
                                    ...
                                    product.unit.child_units.forEach(function(unit) {
                                        ...
                                        $('#e_unit_id').append(
                                            ...
                                            '" data-base_unit_multiplier="' + unit.base_unit_multiplier + '">' + unit.name + multiplierDetails + '</option>'
                                        );
                                    });
                                }
                            ...
                            if (product.namedProducts.length > 0) {
                                ...
                                $.each(products, function(key, product) {
                                    ...
                                    if (product.is_variant == 1) {
                                        ...
                                        li += '<li>';
                                        li += '<a class="select_product" onclick="selectProduct(this); return false;" data-product_type="variant" data-p_id="' + product.id + '" data-v_name="' + product.variant_name +
                                            '" data-is_manage_stock="' + product.is_manage_stock +
                                            '" data-v_id="' + product.variant_id + '" data-p_name="' +
                                            product.name + '" data-p_tax_ac_id="' + (product
                                                .tax_ac_id != null ? product.tax_ac_id : '') +
                                            '" data-tax_type="' + product.tax_type +
                                            '" data-is_show_emi_on_pos="' + product.is_show_emi_on_pos +
                                            '" data-p_code="' + product.variant_code +
                                            '" data-p_price_exc_tax="' + price +
                                            '" data-p_cost_inc_tax="' + product.variant_cost_with_tax +
                                            '" href="#"><img style="width:20px; height:20px;" src="' +
                                            product.thumbnail_photo + '"> ' + product
                                            .name + ' - ' + product.variant_name + '</a>';
                                        li += '</li>';
                ...
                success: function(data) {
                    ...
                    if ($.isEmptyObject(data.errorMsg)) {
                        ...
                        if (uniqueIdValue == undefined) {
                            ...
                            tr += '<input type="hidden" id="showing_unit_discount_amount" value="' + e_discount_amount + '">';
        ...
        function calculateTotalAmount() {
            ...
            subtotals.forEach(function(subtotal) {
                ...
                itemTotalTaxAmount += (quantities[i].value ? quantities[i].value : 0) * (unitTaxAmounts[i].value ?
                    unitTaxAmounts[i].value : 0);
            });
            ...
            $(document).on('submit', '#add_quick_product_form', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#e_variant_id').val('noid');
                        $('#e_base_unit_name').val(product.unit.name);
                        $('#e_showing_quantity').val(parseFloat(product.quantity).toFixed(2)).focus().select();
