            ...
            @if ($defaultLayout->is_header_less == 0)
                ...
                <div class="row mt-1">
                    <div class="col-12 text-center">
                        <h5 style="text-transform: uppercase;">{{ $defaultLayout->invoice_heading }}</h5>
                    </div>
                </div>
            @endif
                ...
                <div class="row">
                    <div class="col-4">
                        <ul class="list-unstyled">
                            ...
                            @if ($defaultLayout->customer_address)
                                <li style="font-size:11px!important;"><strong>@lang('menu.address') : </strong> {{ $sale->customer ? $sale->customer->address : '' }}</li>
                            @endif
                    ...
                    <div class="col-4">
                        <ul class="list-unstyled">
                            ...
                            <li style="font-size:11px!important;"><strong> @lang('menu.do_date') : </strong> {{ $sale->do ? date(json_decode($generalSettings->business, true)['date_format'] ,strtotime($sale->do->do_date)) : '' }}</li>
                            <li style="font-size:11px!important;"><strong>@lang('menu.invoice_id') : </strong> {{ $sale->invoice_id }}</li>
                            <li style="font-size:11px!important;"><strong>@lang('menu.invoice_date') : </strong> {{ date(json_decode($generalSettings->business, true)['date_format'] ,strtotime($sale->date)) }}</li>
                            <li style="font-size:11px!important;"><strong> @lang('menu.sr') : </strong> {{ $sale?->sr?->prefix . ' ' . $sale?->sr?->name . ' ' . $sale?->sr?->last_name }}</li>
                    ...
                    <tbody class="sale_print_product_list">
                        ...
                        @foreach ($customerCopySaleProducts as $saleProduct)
                            <tr>
                                ...
                                @if ($defaultLayout->product_discount)
                                    <td class="text-end" style="font-size:11px!important;">{{ App\Utils\Converter::format_in_bdt($saleProduct->unit_discount_amount) }}
                                    </td>
                                @endif
                    ...
                    <div class="vehicle_details mt-2">
                        <table class="modal-table">
                            <tr>
                                ...
                                <td style="font-size:11px!important;"> : {{ $sale->weight ? $sale->weight->do_car_number : '' }}</td>
                            </tr>

                            <tr>
                                <td style="font-size:11px!important;">@lang('menu.driver_name') </td>
                                <td style="font-size:11px!important;"> : {{ $sale->weight ? $sale->weight->do_driver_name : '' }}</td>
                            </tr>

                            <tr>
                                <td style="font-size:11px!important;">@lang('menu.driver_phone') </td>
                                <td style="font-size:11px!important;"> : {{ $sale->weight ? $sale->weight->do_driver_phone : '' }}</td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <tbody>
                            ...
                            @if (!$sale->delivery_order_id)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end" style="font-size:11px!important;">{{ App\Utils\Converter::format_in_bdt($sale->shipment_charge) }}</td>
                                </tr>
                            @endif
                            ...
                            @if ($sale->sale_return_amount > 0)

                                <tr>
                                    <td class="text-end" style="font-size:11px!important;"><strong>@lang('menu.sale_return') : {{ json_decode($generalSettings->business, true)['currency'] }}</strong></td>
                                    <td class="text-end" style="font-size:11px!important;">
                            ...
                            <tr>
                                <th class="text-end" style="font-size:11px!important;"></strong>@lang('menu.curr_balance') : {{ json_decode($generalSettings->business, true)['currency'] }}</strong></th>
                                <td class="text-end" style="font-size:11px!important;">
                                    @php
                      ...
                      <table class="w-100">
                          <thead>
                              <tr>
                                ...
                                <tr>
                                    <th class="text-center">
                                        <span><strong>@lang('menu.phone') :</strong> {{ json_decode($generalSettings->business, true)['phone'] }} </span>
                                    </th>
                                </tr>

                                <tr>
                                    <th class="text-center">
                                        <span><strong>@lang('menu.email') :</strong> {{ json_decode($generalSettings->business, true)['email'] }} </span>
                                    </th>
                                </tr>
                          </thead>
                      </table>
                  ...
                  <div class="customer_info mt-3">
                      <table class="w-100">
                          <thead>
                              <tr>
                                  <th class="text-center">
                                      <strong>@lang('menu.date'):</strong> <span>{{ date(json_decode($generalSettings->business, true)['date_format'] ,strtotime($sale->date)) . ' ' . date($timeFormat, strtotime($sale->time)) }}</span>
                                  </th>
                              </tr>
                              ...
                              @foreach ($customerCopySaleProducts as $saleProduct)
                                  <tr>
                                    ...
                                    <th class="text-startx">
                                        {{ $loop->index + 1 }}. {{ $saleProduct->p_name.$variant }}
                                    </th>
