...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <div class="sec-name">
                <h6>@lang('menu.edit') @lang('menu.sale_return')</h6>
                <x-back-button />
            </div>
            <div class="p-15">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-6">
                                                @if (auth()->user()->is_marketing_user == 0)
                                                    <div class="input-group">
                                                        ...
                                                        <div class="col-8">
                                                            ...
                                                            <select required name="user_id" id="user_id" class="form-control select2 form-select" data-next="customer_account_id" {{ $return->sale_id ? 'autofocus' : '' }}>
                                                                <option value="">@lang('menu.select_sr')</option>
                                                                @foreach ($users as $user)
                                                                    <option {{ $return->sr_user_id == $user->id ? 'SELECTED' : '' }} data-user_name="{{ $user->prefix . ' ' . $user->name . ' ' . $user->last_name . '/' . $user->phone }}" value="{{ $user->id }}">
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        <select required name="customer_account_id" class="form-control select2 form-select" id="customer_account_id" data-next="sale_invoice_id" {{ $return->sale_id ? 'autofocus' : '' }}>
                                                            <option value="">@lang('menu.select_customer')</option>
                                                            @foreach ($customerAccounts as $customerAccont)
                                                                <option {{ $return->customer_account_id == $customerAccont->id ? 'SELECTED' : '' }} data-customer_name="{{ $customerAccont->name }}" data-customer_phone="{{ $customerAccont->phone }}" value="{{ $customerAccont->id }}">
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        @php
                                                            ...
                                                            $amounts = $accountUtil->accountClosingBalance($return->customer_account_id, $return->sr_user_id);
                                                        @endphp
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <div style="position: relative;">
                                                            <input type="text" name="sale_invoice_id" id="sale_invoice_id" class="form-control fw-bold scanable" placeholder="Search Sale Invoice ID" value="{{ $return->sale ? $return->sale->invoice_id : '' }}" data-next="warehouse_id" autocomplete="off">
                                                ...
                                                @if ($return->warehouse_id)
                                                    ...
                                                    <div class="input-group mt-1">
                                                        ...
                                                        <div class="col-8">
                                                            <select class="form-control changeable form-select" name="warehouse_id" id="warehouse_id" data-next="all_price_type">
                                                                <option value="">@lang('menu.select_warehouse')</option>
                                                                @foreach ($warehouses as $warehouse)
                                                                    <option {{ $return->warehouse_id == $warehouse->id ? 'SELECTED' : '' }} value="{{ $warehouse->id }}">
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        <select required name="all_price_type" class="form-control form-select" id="all_price_type" data-next="date">
                                                            ...
                                                            <option {{ $return->all_price_type == 'PR' ? 'SELECTED' : '' }} value="PR">PR</option>
                                                            <option {{ $return->all_price_type == 'MR' ? 'SELECTED' : '' }} value="MR">MR</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="date" class="form-control add_input" data-name="Date" value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($return->date)) }}" id="date" data-next="price_group_id" autocomplete="off">
                                                    ...
                                                    <div class="col-8">
                                                        <select name="price_group_id" class="form-control form-select" id="price_group_id" data-next="sale_account_id">
                                                            ...
                                                            @foreach ($price_groups as $pg)
                                                                <option {{ json_decode($generalSettings->sale, true)['default_price_group_id'] == $pg->id ? 'SELECTED' : '' }} value="{{ $pg->id }}">{{ $pg->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input readonly type="text" class="form-control fw-bold" value="{{ $return->voucher_no }}" data-next="sale_account_id" tabindex="-1">
                                                    </div>
                                                </div>

                                                <div class="input-group mt-1">
                                                    <label class="col-4">
                                                        <b>@lang('menu.sales_account') : <span class="text-danger">*</span></b>
                                                    </label>
                                                    ...
                                                    <div class="col-8">
                                                        <select name="sale_account_id" class="form-control form-select" id="sale_account_id" data-next="search_product">
                                                            @foreach ($saleAccounts as $saleAccount)
                                                                <option {{ $return->sale_account_id == $saleAccount->id ? 'SELECTED' : '' }} value="{{ $saleAccount->id }}">
                                                                    {{ $saleAccount->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="searching_area" style="position: relative;">
                                                        <div class="input-group">
                                                            ...
                                                            <input {{ $return->sale_id ? 'disabled' : '' }} type="text" name="search_product" class="form-control fw-bold scanable" id="search_product" placeholder="Search Product by product code(SKU) / Scan bar code" autocomplete="off" {{ !$return->sale_id ? 'autofocus' : '' }}>
                                                        </div>
                                                            ...
                                                            <table class="display data__table table sale-product-table">
                                                                <thead class="staky">
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">@lang('menu.unit_price_inc_tax')</th>
                                                                        <th class="text-center">@lang('menu.sold_quantity')</th>
                                                                ...
                                                                <tbody id="return_item_list">
                                                                    @php
                                                                        $itemUnitsArray = [];
                                                                    @endphp
                                                                    @foreach ($return->returnProducts as $returnItem)
                                                                        @php
                                                                            if (isset($returnItem->product_id)) {
                                                                                $itemUnitsArray[$returnItem->product_id][] = [
                                                                                    'unit_id' => $returnItem->product->unit->id,
                                                                                    'unit_name' => $returnItem->product->unit->name,
                                                                                    'unit_code_name' => $returnItem->product->unit->code_name,
                                                                            ...
                                                                            if (count($returnItem?->product?->unit?->childUnits) > 0) {
                                                                                foreach ($returnItem?->product?->unit?->childUnits as $unit) {
                                                                                    $multiplierDetails = '(1 ' . $unit->name . ' = ' . $unit->base_unit_multiplier . '/' . $returnItem?->product?->unit?->name . ')';

                                                                                    array_push($itemUnitsArray[$returnItem->product_id], [
                                                                                        'unit_id' => $unit->id,
                                                                                        'unit_name' => $unit->name,
                                                                        ...
                                                                        @php
                                                                            $variantId = $returnItem->product_variant_id ? $returnItem->product_variant_id : 'noid';

                                                                            $baseUnitMultiplier = $returnItem?->returnUnit?->base_unit_multiplier ? $returnItem?->returnUnit?->base_unit_multiplier : 1;
                                                                        @endphp
                                                                        <tr id="select_item">
                                                                            <td class="text-start">
                                                                                <span class="product_name">{{ $returnItem->product->name . ($returnItem->variant ? ' -' . $returnItem->variant->variant_name : '') }}</span>
                                                                                <input type="hidden" id="item_name" value="{{ $returnItem->product->name . ($returnItem->variant ? ' -' . $returnItem->variant->variant_name : '') }}">
                                                                                <input type="hidden" name="unit_costs_inc_tax[]" value="{{ $returnItem->unit_cost_inc_tax }}">
                                                                                <input type="hidden" value="{{ $returnItem->product_id }}" id="product_id" name="product_ids[]">
                                                                                <input type="hidden" name="variant_ids[]" id="variant_id" value="{{ $variantId }}">
                                                                                @php
                                                                                    $showingUnitDiscount = $returnItem->unit_discount_type == 1 ? $returnItem->doProduct * $baseUnitMultiplier : $returnItem->unit_discount;
                                                                                @endphp
                                                                                <input type="hidden" name="unit_discount_types[]" id="unit_discount_type" value="{{ $returnItem->unit_discount_type }}">
                                                                                <input type="hidden" name="unit_discounts[]" id="unit_discount" value="{{ $returnItem->unit_discount }}">
                                                                                <input type="hidden" id="showing_unit_discount" value="{{ $showingUnitDiscount }}">
                                                                                <input type="hidden" name="unit_discount_amounts[]" id="unit_discount_amount" value="{{ $returnItem->unit_discount_amount }}">
                                                                                <input type="hidden" id="showing_unit_discount_amount" value="{{ $returnItem->unit_discount_amount * $baseUnitMultiplier }}">
                                                                                <input type="hidden" name="tax_ac_ids[]" value="{{ $returnItem->tax_ac_id }}" id="tax_ac_id">
                                                                                <input type="hidden" name="tax_types[]" value="{{ $returnItem->tax_type }}" id="tax_type">
                                                                                <input type="hidden" name="unit_tax_percents[]" id="unit_tax_percent" value="{{ $returnItem->unit_tax_percent }}">
                                                                                <input type="hidden" name="unit_tax_amounts[]" id="unit_tax_amount" value="{{ $returnItem->unit_tax_amount }}">

                                                                                @php
                                                                                    $showingTaxAmount = $returnItem->unit_tax_amount * $baseUnitMultiplier;
                                                                                @endphp
                                                                                <input type="hidden" id="showing_unit_tax_amount" value="{{ bcadd($showingTaxAmount, 0, 2) }}">
                                                                                <input type="hidden" name="price_types[]" id="price_type" value="{{ $returnItem->price_type }}">
                                                                                <input type="hidden" name="pr_amounts[]" id="pr_amount" value="{{ $returnItem->pr_amount }}">
                                                                                <input type="hidden" name="sale_return_product_ids[]" id="sale_return_product_id" value="{{ $returnItem->id }}">
                                                                                <input type="hidden" name="sale_product_ids[]" id="sale_product_id" value="{{ $returnItem->sale_product_id }}">
                                                                                <input type="hidden" id="{{ $returnItem->product_id . $variantId }}" value="{{ $returnItem->product_id . $variantId }}">
                                                                            </td>

                                                                            <td>
                                                                                <input type="hidden" name="unit_prices_exc_tax[]" id="unit_price_exc_tax" value="{{ $returnItem->unit_price_exc_tax }}">
                                                                                @php
                                                                                    $showingPriceExcTax = $returnItem->unit_price_exc_tax * $baseUnitMultiplier;
                                                                                @endphp
                                                                                <input type="hidden" id="showing_unit_price_exc_tax" value="{{ bcadd($showingPriceExcTax, 0, 2) }}">
                                                                                <input type="hidden" name="unit_prices_inc_tax[]" id="unit_price_inc_tax" value="{{ $returnItem->unit_price_inc_tax }}">
                                                                                @php
                                                                                    $showingPriceIncTax = $returnItem->unit_price_inc_tax * $baseUnitMultiplier;
                                                                                @endphp

                                                                                <input type="hidden" id="showing_unit_price_inc_tax" value="{{ bcadd($showingPriceIncTax, 0, 2) }}">
                                                                                <span id="showing_span_unit_price_inc_tax" class="fw-bold">{{ bcadd($showingPriceIncTax, 0, 2) }}</span>
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_sold_qty" class="fw-bold">{{ $returnItem->sold_quantity . '/' . $returnItem?->saleProduct?->saleUnit?->name }}</span>
                                                                                <input type="hidden" name="sold_quantities[]" value="{{ $returnItem->sold_quantity }}">
                                                                            </td>

                                                                            <td>
                                                                                @php
                                                                                    $showingQuantity = $returnItem->return_qty / $baseUnitMultiplier;
                                                                                @endphp
                                                                                <input type="hidden" name="return_quantities[]" id="return_quantity" value="{{ $returnItem->return_qty }}">
                                                                                <input type="hidden" id="showing_return_quantity" value="{{ bcadd($showingQuantity, 0, 2) }}">
                                                                                <span id="showing_span_return_quantity" class="fw-bold">{{ bcadd($showingQuantity, 0, 2) }}</span>
                                                                            </td>

                                                                            <td class="text">
                                                                                <span id="showing_span_unit" class="fw-bold">{{ $returnItem->returnUnit->name }}</span>
                                                                                <input type="hidden" name="unit_ids[]" id="unit_id" value="{{ $returnItem->unit_id }}">
                                                                            </td>

                                                                            <td class="text text-center">
                                                                                <span id="span_subtotal" class="fw-bold">{{ $returnItem->return_subtotal }}</span>
                                                                                <input readonly type="hidden" name="subtotals[]" id="subtotal" value="{{ $returnItem->return_subtotal }}" tabindex="-1">
                                                                            </td>
                                                ...
                                                <div class="row g-1">
                                                            ...
                                                            <div class="col-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select name="return_discount_type" class="form-control form-select" id="return_discount_type" data-next="return_tax_ac_id">
                                                                        <option {{ $return->return_discount_type == 1 ? 'SELECTED' : '' }} value="1">@lang('menu.fixed')(0.00)
                                                                        </option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="col-8">
                                                                <select name="return_tax_ac_id" class="form-control fw-bold form-select" id="return_tax_ac_id" data-next="save">
                                                                    <option data-return_tax_percent="0.00" value="">
                                                                        @lang('menu.no_tax')</option>
                                                                    @foreach ($taxAccounts as $taxAccount)
                                                                        <option {{ $return->tax_ac_id == $taxAccount->id ? 'SELECTED' : '' }} data-return_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                                            {{ $taxAccount->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            <label class="col-4"><b>@lang('menu.total_returned_amount') </b></label>
                                                            <div class="col-8">
                                                                <input readonly type="number" step="any" name="total_return_amount" id="total_return_amount" class="form-control fw-bold" value="{{ $return->total_return_amount }}" placeholder="@lang('menu.total_return_amount')" tabindex="-1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(saleProducts) {
                    ...
                    $.each(saleProducts, function(key, saleProduct) {
                        ...
                        tr += '<td>';
                        tr += '<span id="span_sold_qty" class="fw-bold">' + (saleProduct.quantity / baseUnitMultiplier) + '/' + saleProduct.sale_unit
                            .name + '</span>';
        ...
        function clearEditItemFileds() {
            ...
            if ($('#search_product').is(':disabled') == true) {
                ...
                $('#e_return_quantity').val(0.00).focus().select();
            } else {
        ...
        $('#customer_account_id').on('change', function() {
            ...
            if (user_id == '' && customer_account_id) {
                ...
                toastr.error('Please Select a sr.');
                return;
            }
