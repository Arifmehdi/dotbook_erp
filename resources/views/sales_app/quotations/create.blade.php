...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid" style="padding: 0px;">
            <form id="add_quotation_form" action="{{ route('sales.quotations.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <section class="mt-5x">
                    <div class="container-fluid p-0">
                        <div class="form_element m-0 border-0">
                            <div class="sec-name">
                                <h6>@lang('menu.create_quotation')</h6>
                                <x-all-buttons />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="element-body">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                            ...
                                            <div class="col-8">
                                                <div class="input-group select-customer-input-group">
                                                    <div class="select-half">
                                                        <select required style="margin-bottom: 2px;" name="customer_account_id" class="form-control select2 form-select" id="customer_account_id" data-next="date">
                                        ...
                                        <div class="input-group mt-1">
                                            <label class="col-4 text-danger"><b>@lang('menu.curr_balance') </b> </label>
                                            <div class="col-8">
                                                <input readonly type="text" id="current_balance" class="form-control fw-bold" placeholder="@lang('menu.curr_balance')" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="date" class="form-control" id="date" value="{{ date(json_decode($generalSettings->business, true)['date_format']) }}" data-next="price_group_id" autocomplete="off">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            <label class="col-4"><b>@lang('menu.expire_date') <span class="text-danger">*</span></b></label>
                                            <div class="col-8">
                                                <input type="text" name="expire_date" class="form-control" id="expire_date" data-next="expire_time" placeholder="Expire Date" autocomplete="off">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="col-8">
                                                <input readonly type="text" name="invoice_id" id="invoice_id" class="form-control fw-bold" placeholder="@lang('menu.quotation_id')" autocomplete="off">
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-9 col-md-7">
                            <div class="item-details-sec">
                                <div class="content-inner">
                                    ...
                                    <div class="row mt-1">
                                        <div class="sale-item-sec create-quotation-table-wrap">
                                            <div class="sale-item-inner">
                                                <div class="table-responsive">
                                                    <table class="display data__table table sale-product-table">
                                                        ...
                                                        <tbody id="quotation_item_list"></tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-1">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="number" step="any" name="total_item" id="total_item" class="form-control fw-bold" value="0.00" data-next="net_total_amount" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="number" step="any" name="total_qty" id="total_qty" class="form-control fw-bold" value="0.00"data-next="net_total_amount" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="number" step="any" class="form-control fw-bold" name="net_total_amount" id="net_total_amount" value="0.00" data-next="order_discount" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <input name="order_discount" type="number" step="any" class="form-control fw-bold" id="order_discount" value="0.00" data-next="order_discount_type">
                                                ...
                                                <div class="col-sm-7">
                                                    <select name="order_tax_ac_id" class="form-control form-select" id="order_tax_ac_id" data-next="shipment_charge">
                                                        <option data-order_tax_percent="0.00" value="">
                                                            @lang('menu.no_tax')</option>
                                                        @foreach ($taxAccounts as $taxAccount)
                                                            <option data-order_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                                {{ $taxAccount->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <input type="number" name="order_tax_amount" step="any" class="d-none" id="order_tax_amount" value="0.00">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="shipment_charge" type="number" step="any" class="form-control fw-bold" id="shipment_charge" value="0.00" data-next="save_and_print">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly class="form-control fw-bold" type="number" step="any" name="total_invoice_payable" id="total_invoice_payable" value="0.00" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="submitBtn mt-4">
                                        <div class="row justify-content-center">
                                            <div class="col-12 text-end">
                                                <div class="btn-box btn-box-3 loading-btn-box d-flex flex-wrap">
                                                    <button type="button" class="btn btn-sm loading_button display-none"><i class="fas fa-spinner"></i> </button>
                                                    <button type="submit" id="save_and_print" class="btn py-xxl-3 py-2 btn-success text-white submit_button" value="save_and_print">@lang('menu.save_and_print')</button>
                                                    <button type="submit" id="save" class="btn py-xxl-3 py-2 btn-success submit_button" value="save">@lang('menu.save')</button>
                                                    <button type="button" class="btn py-xxl-3 py-2 btn-danger" data-status="1" value="save">@lang('menu.reset_data')</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="never_show_again" value="" id="never_show_again">
                                    <label class="form-check-label" for="never_show_again">
                                        @lang('menu.never_show_again').
                                    </label>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
                    ...
                    if (
                        ...
                        if (!$.isEmptyObject(product.product)) {
                            ...
                            if (product.variants.length == 0) {
                                ...
                                $('#e_showing_price_inc_tax').val(parseFloat(__price_with_discount).toFixed(2));
                                $('#e_subtotal').val(parseFloat(__price_with_discount).toFixed(2));
                                ...
                                $.each(product.variants, function(key, variant) {
                                    ...
                                    li += '<li>';
                                    li += '<a class="select_variant_product" onclick="selectProduct(this); return false;" data-p_id="' + product.id + '" data-is_manage_stock="' + product.is_manage_stock + '" data-v_id="' + variant.id + '" data-p_name="' + product.name + '" data-v_name="' + variant.variant_name + '" data-p_tax_ac_id="' + (product.tax_ac_id != null ? product.tax_ac_id : '') + '" data-tax_type="' + product.tax_type + '" data-p_code="' + variant.variant_code + '" data-p_price_exc_tax="' + price + '" data-p_cost_inc_tax="' + (variant.update_variant_cost ? variant.update_variant_cost.net_unit_cost : variant.variant_cost_with_tax) + '" data-is_show_emi_on_pos="' + product.is_show_emi_on_pos + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + variant.variant_name + '</a>';
                                    li += '</li>';
                                });
                            ...
                            $('#e_unit_cost_inc_tax').val(variant.update_variant_cost ? variant.update_variant_cost.net_unit_cost : variant_product.variant_cost_with_tax);
                            $('#display_unit_cost').html(variant.update_variant_cost ? variant.update_variant_cost.net_unit_cost : variant_product.variant_cost_with_tax);
                            $('#e_is_show_emi_on_pos').val(product.is_show_emi_on_pos);
                            $('#e_base_unit_price_exc_tax').val(price);
        ...
        $(document).on('click', '#select_item', function(e) {
            ...
            $('#display_unit_cost').html(unit_cost_inc_tax);
            $('#e_is_show_emi_on_pos').val(is_show_emi_on_pos);
            $('#add_item').html('Edit');
        });
        ...
        $('#add_quotation_form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (!$.isEmptyObject(data.quotationMsg)) {

                        toastr.success(data.quotationMsg);
                        afterCreateQuotation();
                    } else {

                        toastr.success('Successfully quotation is created.');
                        $(data).printThis({
                            debug: false,
                            importCSS: true,
                            importStyle: true,
