...
@push('css')
    <style>
        ...
        .quotation-number-fields label {
            font-size: 10px !important;
        }

        /*.quotation-number-fields input {font-size: 18px;font-weight: 500;}
                    .quotation-number-fields select {height: 35px;font-size: 15px;} */
    </style>
...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <div class="sec-name">
                <h6>@lang('menu.edit_quotation')</h6>
                <x-back-button />
            </div>
            <form id="edit_quotation_form" action="{{ route('sales.quotations.update', $quotation->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <section class="p-15">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-md-6">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <select required name="user_id" id="user_id" class="form-control select2 form-select" data-next="customer_account_id">
                                                            ...
                                                            @foreach ($users as $user)
                                                                <option {{ $quotation->quotation_by_id == $user->id ? 'SELECTED' : '' }} value="{{ $user->id }}">
                                                ...
                                                <div class="col-8">
                                                    <div class="input-group select-customer-input-group">
                                                        <div class="select-half">
                                                            <select required style="margin-bottom: 2px;" name="customer_account_id" class="form-control select2 form-select" id="customer_account_id" data-next="sale_account_id">
                                                                <option value="">@lang('menu.select_customer')</option>
                                                                @foreach ($customerAccounts as $customer)
                                                                    <option {{ $quotation->customer_account_id == $customer->id ? 'SELECTED' : '' }} data-customer_name="{{ $customer->name }}" data-customer_phone="{{ $customer->phone }}" value="{{ $customer->id }}">
                                            ...
                                            <div class="input-group mt-1">
                                                ...
                                                <div class="col-8">
                                                    <select name="sale_account_id" class="form-control form-select" id="sale_account_id" data-next="date">
                                                        @foreach ($saleAccounts as $saleAc)
                                                            <option {{ $quotation->sale_account_id && $quotation->sale_account_id == $saleAc->id ? 'SELECTED' : '' }} value="{{ $saleAc->id }}">{{ $saleAc->name }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="date" class="form-control" id="date"value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($quotation->quotation_date)) }}" data-next="price_group_id" autocomplete="off">
                                            ...
                                            <div class="input-group mt-1">
                                                ...
                                                <div class="col-8">
                                                    <select required name="all_price_type" class="form-control form-select" id="all_price_type" data-next="expire_date">
                                                        <option value="">@lang('menu.select_rate_type')</option>
                                                        <option {{ $quotation->all_price_type == 'PR' ? 'SELECTED' : '' }} value="PR">PR</option>
                                                        <option {{ $quotation->all_price_type == 'MR' ? 'SELECTED' : '' }} value="MR">MR</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="expire_date" class="form-control" id="expire_date" value="{{ $quotation->expire_date ? $quotation->expire_date : '' }}" data-next="expire_time" placeholder="@lang('menu.expire_date')" autocomplete="off">
                                            ...
                                            <div class="input-group mt-1">
                                                ...
                                                <div class="col-8">
                                                    <input type="time" name="expire_time" class="form-control" id="expire_time" value="{{ $quotation->expire_date ? date('H:i:s', strtotime($quotation->expire_date)) : '' }}" data-next="status" autocomplete="off">
                                                    <span class="error error_expire_date"></span>
                                                </div>
                                            </div>

                                            <div class="input-group mt-1">
                                                <label class="col-4">@lang('menu.status') </label>
                                                <div class="col-8">
                                                    <select name="status" class="form-control form-select" id="status" data-next="search_product">
                                                        <option value="4">@lang('menu.quotation')</option>
                                                        <option {{ $quotation->order_status == 1 ? 'SELECTED' : '' }} value="3">@lang('menu.order')</option>
                                                    </select>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                <label class="col-4"><b>@lang('menu.quotation_id') </b></label>
                                                <div class="col-8">
                                                    <input readonly type="text" name="invoice_id" id="invoice_id" class="form-control fw-bold" value="{{ $quotation->quotation_id }}" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row g-1">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-xl-8">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <label class="fw-bold">@lang('menu.per') @lang('menu.unit_price_exc_tax')</label>
                                                    <input {{ auth()->user()->can('edit_price_sale_screen')? '': 'readonly' }} type="number" step="any" class="form-control fw-bold" id="e_showing_price_exc_tax" placeholder="@lang('menu.price_exc_tax')" value="0.00">
                                        ...
                                        <div class="col-xl-2 col-md-6">
                                            <div class="btn-box-2">
                                                ...
                                                @if (auth()->user()->can('view_product_cost_is_sale_screed'))
                                                    <p class="m-0 position-relative d-flex" tabindex="-1">
                                                        <span class="btn btn-cost btn-sm btn-primary display-none" id="show_cost_section">
                                                            <span id="display_unit_cost">0.00</span>
                                                        </span>
                                                        <span class="btn btn-sm btn-primary text-white" id="show_cost_button">@lang('menu.cost')</span>
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="sale-item-inner">
                                                <div class="table-responsive">
                                                    <table class="display data__table table sale-product-table">
                                                        ...
                                                        <tbody id="quotation_item_list">
                                                            @php
                                                                $totalQty = 0;
                                                                $itemUnitsArray = [];
                                                            @endphp
                                                            @foreach ($quotation->saleProducts as $q_product)
                                                                @php
                                                                    $totalQty += 1;

                                                                    if (isset($q_product->product_id)) {
                                                                        $itemUnitsArray[$q_product->product_id][] = [
                                                                            'unit_id' => $q_product->product->unit->id,
                                                                            'unit_name' => $q_product->product->unit->name,
                                                                            'unit_code_name' => $q_product->product->unit->code_name,
                                                                    ...
                                                                    if (count($q_product?->product?->unit?->childUnits) > 0) {
                                                                        foreach ($q_product?->product?->unit?->childUnits as $unit) {
                                                                            $multiplierDetails = '(1 ' . $unit->name . ' = ' . $unit->base_unit_multiplier . '/' . $q_product?->product?->unit?->name . ')';

                                                                            array_push($itemUnitsArray[$q_product->product_id], [
                                                                                'unit_id' => $unit->id,
                                                                                'unit_name' => $unit->name,
                                                                ...
                                                                <tr id="select_item">
                                                                    <td>
                                                                        @php
                                                                            $variant = $q_product->product_variant_id ? ' -' . $q_product->variant->variant_name : '';
                                                                            $variantId = $q_product->product_variant_id ? $q_product->product_variant_id : 'noid';

                                                                            $baseUnitMultiplier = $q_product?->saleUnit?->base_unit_multiplier ? $q_product?->saleUnit?->base_unit_multiplier : 1;
                                                                        @endphp

                                                                        <span class="product_name">{{ $q_product->product->name . $variant }}</span>
                                                                        <input type="hidden" name="is_show_emi_on_pos[]" id="is_show_emi_on_pos" id="dsc" value="{{ $q_product->product->is_show_emi_on_pos }}">
                                                                        <input type="hidden" name="descriptions[]" id="descriptions" value="">
                                                                        <input type="hidden" id="item_name" value="{{ $q_product->product->name . $variant }}">
                                                                        <input type="hidden" id="product_id" name="product_ids[]" value="{{ $q_product->product_id }}">
                                                                        <input type="hidden" name="variant_ids[]" class="variantId-{{ $variantId }}" id="variant_id" value="{{ $variantId }}">
                                                                        <input type="hidden" name="tax_ac_ids[]" id="tax_ac_id" value="{{ $q_product->tax_ac_id }}">
                                                                        <input type="hidden" name="tax_types[]" id="tax_type" value="{{ $q_product->tax_type }}">
                                                                        <input type="hidden" name="unit_tax_percents[]" id="unit_tax_percent" value="{{ $q_product->unit_tax_percent }}">
                                                                        <input type="hidden" name="unit_tax_amounts[]" id="unit_tax_amount" value="{{ $q_product->unit_tax_amount }}">
                                                                        @php
                                                                            $showingTaxAmount = $q_product->unit_tax_amount * $baseUnitMultiplier;
                                                                        @endphp

                                                                        <input type="hidden" id="showing_unit_tax_amount" value="{{ bcadd($showingTaxAmount, 0, 2) }}">

                                                                        @php
                                                                            $showingUnitDiscount = $q_product->unit_discount_type == 1 ? $q_product->unit_discount * $baseUnitMultiplier : $q_product->unit_discount;
                                                                        @endphp
                                                                        <input type="hidden" name="unit_discount_types[]" id="unit_discount_type" value="{{ $q_product->unit_discount_type }}">
                                                                        <input type="hidden" name="unit_discounts[]" id="unit_discount" value="{{ $q_product->unit_discount }}">
                                                                        <input type="hidden" id="showing_unit_discount" value="{{ $showingUnitDiscount }}">
                                                                        <input type="hidden" name="unit_discount_amounts[]" id="unit_discount_amount" value="{{ $q_product->unit_discount_amount }}">
                                                                        <input type="hidden" id="showing_unit_discount_amount" value="{{ $q_product->unit_discount_amount * $baseUnitMultiplier }}">
                                                                        <input type="hidden" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax" value="{{ $q_product->unit_cost_inc_tax }}">
                                                                        @php
                                                                            $showingUnitCostIncTax = $q_product->unit_cost_inc_tax * $baseUnitMultiplier;
                                                                        @endphp

                                                                        <input type="hidden" id="showing_unit_cost_inc_tax" value="{{ bcadd($showingUnitCostIncTax, 0, 2) }}">
                                                                        <input type="hidden" class="unique_id" id="{{ $q_product->product_id . $variantId }}" value="{{ $q_product->product_id . $variantId }}">
                                                                        <input type="hidden" name="quotation_product_ids[]" value="{{ $q_product->id }}">
                                                                    </td>

                                                                    <td>
                                                                        @php
                                                                            $showingQuantity = $q_product->ordered_quantity / $baseUnitMultiplier;
                                                                        @endphp
                                                                        <span id="span_showing_quantity" class="fw-bold">{{ bcadd($showingQuantity, 0, 2) }}</span>
                                                                        <input type="hidden" name="quantities[]" id="quantity" value="{{ $q_product->ordered_quantity }}">
                                                                        <input type="hidden" id="showing_quantity" value="{{ bcadd($showingQuantity, 0, 2) }}">
                                                                    </td>

                                                                    <td class="text">
                                                                        <span id="span_unit">{{ $q_product?->saleUnit?->name }}</span>
                                                                        <input type="hidden" name="unit_ids[]" id="unit_id" value="{{ $q_product?->saleUnit?->id }}">
                                                                        <input type="hidden" id="base_unit_name" value="{{ $q_product?->product?->unit?->name }}">
                                                                    </td>

                                                                    <td>
                                                                        <input type="hidden" name="unit_prices_exc_tax[]" id="unit_price_exc_tax" value="{{ $q_product->unit_price_exc_tax }}">

                                                                        @php
                                                                            $showingPriceExcTax = $q_product->unit_price_exc_tax * $baseUnitMultiplier;
                                                                        @endphp

                                                                        <input type="hidden" id="showing_unit_price_exc_tax" value="{{ bcadd($showingPriceExcTax, 0, 2) }}">
                                                                        <input type="hidden" name="unit_prices_inc_tax[]" id="unit_price_inc_tax" value="{{ $q_product->unit_price_inc_tax }}">

                                                                        @php
                                                                            $showingPriceIncTax = $q_product->unit_price_inc_tax * $baseUnitMultiplier;
                                                                        @endphp
                                                                    ...
                                                                    <td class="text-center">
                                                                        @php
                                                                            $showPrAmount = $q_product->price_type == 'PR' ? '(' . $q_product->pr_amount . ')' : '';
                                                                        @endphp
                                                                        <span id="span_price_type">{{ $q_product->price_type . $showPrAmount }}</span>
                                                                        <input type="hidden" name="price_types[]" id="price_type" value="{{ $q_product->price_type }}">
                                                                        <input type="hidden" name="pr_amounts[]" id="pr_amount" value="{{ $q_product->pr_amount }}">
                                                                    </td>

                                                                    <td class="text text-center">
                                                                        <span id="span_subtotal" class="fw-bold">{{ $q_product->subtotal }}</span>
                                                                        <input value="{{ $q_product->subtotal }}" readonly name="subtotals[]" type="hidden" id="subtotal" tabindex="-1">
                                                                    </td>
                        ...
                        <div class="col-xl-3 col-md-5">
                            <div class="item-details-sec mb-3 quotation-number-fields">
                                <div class="content-inner">
                                    <div class="row g-1">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="number" step="any" name="total_item" id="total_item" class="form-control fw-bold" value="{{ $quotation->total_item }}" data-next="net_total_amount" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input readonly type="number" step="any" name="total_qty" id="total_qty" class="form-control fw-bold" value="{{ $totalQty }}" data-next="net_total_amount" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="input-group">
                                                        <input name="order_discount" type="number" step="any" class="form-control fw-bold" id="order_discount" value="{{ $quotation->order_discount }}" data-next="order_discount_type">
                                                        <input name="order_discount_amount" type="number" step="any" class="d-none" id="order_discount_amount" value="{{ $quotation->order_discount_amount }}">

                                                        <select name="order_discount_type" class="form-control form-select" id="order_discount_type" data-next="order_tax_ac_id">
                                                            <option {{ $quotation->order_discount_type == 1 ? 'SELECTED' : '' }} value="1">@lang('menu.fixed')</option>
                                                            <option {{ $quotation->order_discount_type == 2 ? 'SELECTED' : '' }} value="2">@lang('menu.percentage')</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <label class="col-sm-5 text-end fw-bold">@lang('menu.tax') </label>
                                                <div class="col-sm-7">
                                                    <select name="order_tax_ac_id" class="form-control form-select" id="order_tax_ac_id" data-next="shipment_charge">
                                                        <option data-order_tax_percent="0.00" value="">
                                                            @lang('menu.no_tax')</option>
                                                        @foreach ($taxAccounts as $taxAccount)
                                                            <option {{ $quotation->tax_ac_id == $taxAccount->id ? 'SELECTED' : '' }} data-order_tax_percent="{{ $taxAccount->tax_percent }}" value="{{ $taxAccount->id }}">
                                                                {{ $taxAccount->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input name="shipment_charge" type="number" step="any" class="form-control fw-bold" id="shipment_charge" value="{{ $quotation->shipment_charge }}" data-next="save">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                <label class="col-sm-5 text-end fw-bold">@lang('menu.total_amount') </label>
                                                <div class="col-sm-7">
                                                    <input readonly class="form-control fw-bold" type="number" step="any" name="total_invoice_amount" id="total_invoice_amount" value="{{ $quotation->total_payable_amount }}" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        ...
        $('#search_product').on('input', function(e) {
            ...
            delay(function() {
                searchProduct(keyWord, __priceGroupId);
                    ...
                    if (
                        ...
                        if (!$.isEmptyObject(product.product)) {
                            ...
                            if (product.variants.length == 0) {
                                ...
                                $('#e_unit_cost_inc_tax').val(product.update_product_cost ? product
                                    .update_product_cost.net_unit_cost : product.product_cost_with_tax);
                                $('#display_unit_cost').html(product.update_product_cost ? product
                                    .update_product_cost.net_unit_cost : product.product_cost_with_tax);
                                ...
                                $.each(product.variants, function(key, variant) {
                                    ...
                                    var name = product.name.length > 35 ? product.name.substring(0,
                                        35) + '...' : product.name;

                                    li += '<li>';
                                    li += '<a class="select_variant_product" onclick="selectProduct(this); return false;" data-p_id="' +
                                        product.id + '" data-is_manage_stock="' + product.is_manage_stock + '" data-v_id="' + variant.id + '" data-p_name="' + product.name + '" data-v_name="' + variant.variant_name + '" data-p_tax_ac_id="' + (product.tax_ac_id != null ? product.tax_ac_id : '') + '" data-tax_type="' + product.tax_type + '" data-p_code="' + variant.variant_code + '" data-p_price_exc_tax="' + price + '" data-p_cost_inc_tax="' + (variant.update_variant_cost ? variant.update_variant_cost.net_unit_cost : variant.variant_cost_with_tax) + '" data-is_show_emi_on_pos="' + product.is_show_emi_on_pos + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + variant.variant_name + '</a>';
                                    li += '</li>';
                                });
                            ...
                            if (product.namedProducts.length > 0) {
                                ...
                                $.each(products, function(key, product) {
                                    ...
                                    if (product.is_variant == 1) {
                                        ...
                                        li += '<li>';
                                        li += '<a class="select_product" onclick="selectProduct(this); return false;" data-product_type="variant" data-p_id="' + product.id + '" data-v_name="' + product.variant_name + '" data-is_manage_stock="' + product.is_manage_stock + '" data-v_id="' + product.variant_id + '" data-p_name="' + product.name + '" data-p_tax_ac_id="' + (product.tax_ac_id != null ? product.tax_ac_id : '') + '" data-tax_type="' + product.tax_type + '" data-p_code="' + product.variant_code + '" data-p_price_exc_tax="' + price + '" data-p_cost_inc_tax="' + product.variant_cost_with_tax + '" data-is_show_emi_on_pos="' + product.is_show_emi_on_pos + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + product.variant_name + '</a>';
                                        li += '</li>';
                                    } else {
                                        ...
                                        li += '<li>';
                                        li += '<a class="select_single_product" onclick="selectProduct(this); return false;" data-product_type="single" data-p_id="' + product.id + '" data-v_id="" data-is_manage_stock="' + product.is_manage_stock + '" data-p_name="' + product.name + '" data-v_name="" data-p_code="' + product.product_code + '" data-p_tax_ac_id="' + (product.tax_ac_id != null ? product.tax_ac_id : '') + '" data-tax_type="' + product.tax_type + '" data-p_price_exc_tax="' + price + '" data-p_cost_inc_tax="' + product.product_cost_with_tax + '" data-is_show_emi_on_pos="' + product.is_show_emi_on_pos + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + '</a>';
                                        li += '</li>';
                                    }
                                });
        ...
        $('#add_item').on('click', function(e) {
            ...
            if (uniqueIdValue == undefined) {
                ...
                tr += '<input type="hidden" name="quotation_product_ids[]" value="">';
        ...
        function calculateEditOrAddAmount() {
            ...
            var discount_amount = 0;
            $('#e_discount').val(parseFloat(e_showing_discount).toFixed(2));
            ...
            $('#e_showing_discount_amount').val(parseFloat(showing_discount_amount).toFixed(2));
