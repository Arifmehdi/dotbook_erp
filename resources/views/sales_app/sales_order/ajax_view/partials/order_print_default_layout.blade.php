            ...
            <div class="row">
                <div class="col-4">
                    <ul class="list-unstyled">
                        <li style="font-size:11px!important;"><strong>@lang('menu.customer') : </strong> {{ $order?->customer?->name }}</li>

                        @if ($defaultLayout->customer_phone)
                            <li style="font-size:11px!important;">
                                <strong>@lang('menu.phone') : </strong> {{ $order?->customer?->phone }}
                            </li>
                        @endif

                        @if ($defaultLayout->customer_address)
                            <li style="font-size:11px!important;">
                                <strong>@lang('menu.address') : </strong> {{ $order?->customer?->address }}
                            </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="col-4">
                    <ul class="list-unstyled">
                        <li style="font-size:11px!important;"><strong> @lang('menu.order_id') : </strong> {{ $order->order_id }}</li>
                        <li style="font-size:11px!important;"><strong>@lang('menu.order_date') : </strong> {{ date(json_decode($generalSettings->business, true)['date_format'] ,strtotime($order->order_date)) }}</li>
                ...
                <table class="table modal-table table-sm">
                    <tbody>
                        <tr>
                            ...
                            <td class="net_total text-end" style="font-size:11px!important;">{{ $order->all_price_type }}{{ $order->all_price_type == 'PR' ? '('.App\Utils\Converter::format_in_bdt($totalPrAmount).')' : '' }}</td>
                        </tr>

                        <tr>
                            <td class="text-end" style="font-size:11px!important;"><strong>@lang('menu.total_ordered_qty') : </strong></td>
                            <td class="net_total text-end" style="font-size:11px!important;">
                        ...
                        <tr>
                            ...
                            <td class="text-end" style="font-size:11px!important;">{{ App\Utils\Converter::format_in_bdt($order->shipment_charge) }}</td>
                        </tr>
