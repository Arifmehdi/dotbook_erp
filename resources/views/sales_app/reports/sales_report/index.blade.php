                            ...
                            <table class="display data_tbl data__table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('menu.sale_discount')</th>
                                        <th>@lang('menu.sale_tax')</th>
                                ...
                                <tfoot>
                                    <tr class="bg-secondary">
                                        ...
                                        <th id="net_weight" class="text-white"></th>
    ...
    <script>
        ...
        var sales_table = $('.data_tbl').DataTable({
            ...
            fnDrawCallback: function() {
                ...
                $('#total_qty').text(bdFormat(total_sold_qty));
