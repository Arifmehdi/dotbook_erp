...
<div class="row mt-2">
    <div class="col-12 text-center">
        <h6 style="text-transform:uppercase;"><strong>@lang('menu.sales_return_report') </strong></h6>
    </div>
</div>
            ...
            <tbody class="sale_print_product_list">
                ...
                @foreach ($returns as $return)
                    ...
                    @if ($previousDate != $return->date)
                        ...
                        <tr>
                            <th colspan="10" style="font-size: 11px!important;; font-weight:600;">{{ date($__date_format, strtotime($return->date)) }}</th>
                        </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <td class="text-end fw-bold">
                            {{ App\Utils\Converter::format_in_bdt($return->return_tax_amount). '(' . $return->return_tax_percent . '%)' }}
                            @php
