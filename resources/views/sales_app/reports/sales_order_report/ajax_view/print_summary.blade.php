<style>
    ...
    .print_table td { font-size:15px!important;}
...
<div class="row mt-1">
    <div class="col-12 text-center">
        <h6 style="text-transform:uppercase;"><strong>@lang('menu.sales_order_summary') </strong></h6>
    </div>
</div>
        ...
        <table class="display table table-sm print_table">
            <thead>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        {{ App\Utils\Converter::format_in_bdt($sales->sum('total_order_discount')) }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        {{ App\Utils\Converter::format_in_bdt($sales->sum('total_ordered_amount')) }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        @php
                            $averageUnitPrice = $sales->sum('total_ordered_amount') / $sales->sum('total_qty');
                        @endphp
