...
@endpush
@section('title', 'Sr. Wise Sales Order Statements - ')
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.sr_wise_sales_order_report')</h6>
                </div>
                <x-all-buttons>
                    <x-slot name="after">
...
@push('scripts')
    ...
    <script>
        ...
        var sales_table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('reports.sales.order.report.user.wise.index') }}",
                "data": function(d) {
        ...
        $(document).on('click', '#print_report', function(e) {
            ...
            var url = "{{ route('reports.sales.order.report.user.wise.print') }}";
