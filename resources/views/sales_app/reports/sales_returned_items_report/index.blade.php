...
@endpush
@section('title', 'Sales Returned Items Report - ')
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang('menu.sales_returned_items_report')</h6>
                </div>
                <x-all-buttons>
                    <x-slot name="after">
                                    ...
                                    <div class="col-xl-2 col-md-4 search_area">
                                        ...
                                        <div class="search_result display-none">
                                            <ul id="list" class="list-unstyled">
                                                <li><a id="select_product" data-p_id="" data-v_id=""
                                    ...
                                    <div class="col-xl-2 col-md-4">
                                        ...
                                        <select name="customer_account_id" class="form-control select2 form-select"
                                            ...
                                            @foreach ($customerAccounts as $customerAccount)
                                                <option
                                                    data-customer_name="{{ $customerAccount->name . '/' . $customerAccount->phone }}"
...
@push('scripts')
    ...
    <script>
        ...
        var table = $('.data_tbl').DataTable({
            ...
            "ajax": {
                "url": "{{ route('reports.sales.returned.items.report.index') }}",
                "data": function(d) {
        ...
        $(document).on('click', '#print_report', function(e) {
            ...
            var url = "{{ route('reports.sales.returned.items.report.print') }}";
