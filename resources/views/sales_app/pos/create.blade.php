...
@section('pos_content')
    <!-- Pos Header -->
    @include('sales_app.pos.partial.pos_header')
    <!-- Pos Header End-->
                ...
                <div class="row g-1">
                    <div class="col-lg-9">
                        <div class="row g-1">
                            ...
                            @include('sales_app.pos.partial.select_product_section')
                            <!-- Select Category, Brand and Product Area -->
                            <div class="col-lg-7">
                                    ...
                                    <div class="cart-table-inner-pos">
                                        <div class="tbl-head">
                                            <ul class="tbl-head-shortcut-menus" id="pos-shortcut-menus">
                                                <li>
                                                    <a href="{{ route('pos.short.menus.modal.form') }}" id="addPosShortcutBtn" class="head-tbl-icon border-none" tabindex="-1">
                                        ...
                                        <!-- Sale Product Table -->
                                        @include('sales_app.pos.partial.sale_product_table')
                                        <!-- Sale Product Table End -->

                                        <!-- Total Item & Qty section -->
                                        @include('sales_app.pos.partial.total_item_and_qty')
                        ...
                        <!-- Pos Footer -->
                        @include('sales_app.pos.partial.pos_footer')
                        <!-- Pos Footer End -->
                    </div>

                    <!-- Pos Total Sum And Buttons section -->
                    @include('sales_app.pos.partial.total_sum_and_butten')
...
@push('js')
    <script>
        ...
        $('#search_product').on('input', function(e) {
            ...
            delay(function() {
                searchProduct(status, __product_code, __price_group_id, warehouse_id);
