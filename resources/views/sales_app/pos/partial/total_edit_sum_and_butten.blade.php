                        ...
                        <div class="btn-bg">
                            <a href="#"
                                ...
                                @else
                                    ...
                                    " @endif
                                class="bg-gren function-card" tabindex="-1">Hold @lang('menu.invoice')<p>F8</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="checkout-input-sec">
                    <div class="row">
                        <label for="inputEmail3"
                            class="col-sm-3 col-form-label text-white"><b>@lang('menu.total')</b></label>
                        <div class="col-sm-9">
                    ...
                    @if (json_decode($generalSettings->pos, true)['is_enabled_order_tax'] == '1')
                        <div class="row">
                            ...
                            <div class="col-sm-9 ">
                                <select name="order_tax" class="form-control form-select" id="order_tax">
                    ...
                    @if (json_decode($generalSettings->pos, true)['is_enabled_discount'] == '1')
                        <div class="row">
                            <label for="inputEmail3"
                                class="col-sm-3 col-form-label text-white">@lang('menu.discount')</label>
                            <div class="col-sm-9 ">
                                ...
                                <input name="order_discount_amount" type="number" class="d-none"
                                    id="order_discount_amount" value="0.00">
                                <input name="order_discount_type" class="d-none" id="order_discount_type"
                                    value="1">
                            </div>
                        </div>
                    @else
                    ...
                    <div class="row">
                        ...
                        <label for="inputEmail3" class="col-sm-3 col-form-label text-white">@lang('menu.payable')</label>
                        <div class="col-sm-9 ">
                    ...
                    <div class="row">
                        <label for="inputEmail3" class="col-sm-6 col-form-label text-danger"><b>@lang('menu.due')
                            </b></label>
                        <div class="col-sm-6 ">
                ...
                <div class="sub-btn-sec">
                    <div class="row">
                        <div class="col-lg-4 col-12 p-1 pb-1">
                            ...
                            <div class="btn-bg">
                                <a href="#" class="bg-parpal btn-pos" id="reedem_point_button"
                        ...
                        <div class="col-lg-4 col-6 p-1 pb-0 btn-bottom">
                            <div class="btn-bg">
                                <a href="#" class="bg-parpal function-card cash-btn" id="submit_btn"
