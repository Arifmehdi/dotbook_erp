    ...
    <nav class="pos-navigation">
        <div class="col-lg-4 col-sm-12 col-12 nav-left-sec">
            ...
            <div class="col-lg-8 col-sm-12 col-12 address">
                ...
                <p class="address-name">{{ json_decode($generalSettings->business, true)['address'] }} </p>
            ...
            <div class="input-section">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-12 sm-input-sec-w">
                                <div class="input-group mb-1">
                                    <input readonly type="text" class="form-control form-select"
                                        value="{{ $sale->customer ? $sale->customer->name . ' (' . $sale->customer->phone . ')' : 'Walk-In-Customer' }}">
                                </div>
                                ...
                                <div class="search_item_area">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search_product" class="form-control"
                                            id="search_product" placeholder="Scan/Search Items by SKU/Barcode"
                                            autofocus>
                                ...
                                @if (json_decode($generalSettings->reward_poing_settings, true)['enable_cus_point'] == '1')
                                    <div class="input-group mb-1">
                                        ...
                                        <input readonly type="number" step="any" class="form-control"
                                            name="earned_point" id="earned_point">
                    ...
                    <div class="col-lg-4 btn-section">
                        ...
                        <div class="btn-sec">
                            <a href="{{ route('sales.pos.suspended.list') }}" class="pos-btn status" id="suspends"
                                tabindex="-1"><i class="fas text-warning fa-pause"></i></a>
                            <a href="#" class="pos-btn mr-1" data-bs-toggle="modal"
                                data-bs-target="#calculatorModal" tabindex="-1">
                            ...
                            <a href="#" class="pos-btn" id="pos_exit_button" tabindex="-1"><span
