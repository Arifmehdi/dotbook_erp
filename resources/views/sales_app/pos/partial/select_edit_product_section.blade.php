            ...
            <div class="left-cat-pos">
                <div class="all-cat">
                    ...
                    @foreach ($categories as $cate)
                        <a href="#" data-id="{{ $cate->id }}" class="cat-button"
                            tabindex="-1">{{ $cate->name }}</a>
                    @endforeach
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <select name="category_id" id="category_id"
                                        class="form-select form-control cat-bg-1 common_submitable form-select"
                                        tabindex="-1">
                                ...
                                <div class="col-6">
                                    <select id="brand_id" id="brand_id"
                                        class="form-select form-control cat-bg-2 bg common_submitable form-select"
                                        tabindex="-1">
