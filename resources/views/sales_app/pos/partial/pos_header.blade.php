                    ...
                    <div class="row g-1">
                        <div class="col-xl-4 logo-sec">
                            <div class="pos-logo d-flex justify-content-center">
                                <span
                                    style="font-family: 'Anton', sans-serif;font-size:15px;color:white;">{{ json_decode($generalSettings->business, true)['shop_name'] }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-sm-12 col-12 address">
                            ...
                            <small class="login-user-name">
                                <span class="text-highlight">@lang('menu.logged_in') : </span>
                                {{ auth()->user()->prefix .
                                    ' ' .
                                    auth()->user()->name .
                                    '
                                    ...
                                    auth()->user()->last_name }}.
                                <span>
                                    <span class="text-highlight">C.@lang('menu.register') : </span>
                                ...
                                <span> <span class="text-highlight">@lang('menu.cash_counter') : </span>
                                    {{ $openedCashRegister->cash_counter ? $openedCashRegister->cash_counter->counter_name : 'N/A' }}.</span>
                            </small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-1">
                            <div class="col-lg-6 col-12 sm-input-sec-w">
                                <div class="input-group mb-1">
                                    ...
                                    <select name="customer_id" class="form-control form-select form-select"
                                        id="customer_id">
                                        <option value="">@lang('menu.walk_in_customer')</option>
                            ...
                            <div class="col-lg-6 input-value-sec">
                                <div class="input-group mb-1">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text valus">@lang('menu.point')</span>
                                    </div>
                                    <input readonly type="number" step="any" class="form-control"
                                        name="earned_point" id="earned_point" tabindex="-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" class="form-control" id="stock_quantity"
                                        tabindex="-1">

                                    <div class="input-group-prepend ms-1">
                                        <select name="price_group_id" class="form-control form-select"
                                            id="price_group_id">
        ...
        <div class="col-lg-3 col-sm-9 col-12 input-buttob-sec">
            <div class="input-section">
                <div class="btn-section">
                    ...
                    <div class="btn-sec">
                        {{-- Shortcut Manual --}}
                        <a href="#" class="pos-btn position-relative" id="readDocument"
                            title="Shortcut button list" tabindex="-1">
                            <i class="fas fa-file-alt"></i>
                            <div class="position-absolute doc">
                                <ul class="p-2 pt-3">
                                    <li>
                                        <span class="icon shortcut">F2</span>
                                        <span class="desc">@lang('menu.save_as_draft')</span>
                                    </li>
                                    <li>
                                        <span class="icon shortcut">F3</span>
                                        <span class="desc">@lang('menu.view_stock')</span>
                                    </li>
                                    <li>
                                        <span class="icon shortcut">Ctrl+Q</span>
                                        <span class="desc">@lang('menu.quick_setup')</span>
                                    </li>
                                    <li>
                                        <span class="icon shortcut">Ctrl+C</span>
                                        <span class="desc">@lang('menu.copy_element')</span>
                                    </li>
                                    <li>
                                        <span class="icon shortcut">Ctrl+V</span>
                                        <span class="desc">@lang('menu.paste_copied')</span>
                                    </li>
                                    <li>
                                        <span class="icon shortcut">F2</span>
                                        <span class="desc">@lang('menu.save_as_draft')</span>
                        ...
                        <a href="#" class="pos-btn status" id="suspends" title="Suspended Invoice"
                            tabindex="-1">
                                    ...
                                    <div class="modail-body" id="calculator">
                                        <div class="calculator-bg">
                                            <div class="calculator-bg__main">
                                                ...
                                                <button class="calculator-bg__main__ac">@lang('menu.ac')</button>
                                                <button class="calculator-bg__main__del">@lang('menu.del')</button>
                        ...
                        @if (auth()->user()->can('register_view'))
                            <a href="#" class="pos-btn text-info" id="cash_register_details"
                                title="Register Details" tabindex="-1"><i class="fas fa-cash-register"></i></a>
                        @endif

                        @if (auth()->user()->can('register_close'))
                            <a href="#" class="pos-btn text-danger" id="close_register" title="Close Register"
                                tabindex="-1">
...
<script>
    ...
    $('#customer_id').on('change', function() {
        ...
        $.get(url, function(data) {
            ...
            if (rp_settings.enable_rp == '1') {
                ...
                var __point_amount = parseFloat(data.point) * parseFloat(rp_settings
    ...
    $(document).on('click', '#redeem_btn', function(e) {
        ...
        if (rp_settings.min_order_total_for_redeem && total_invoice_payable < parseFloat(rp_settings
                .min_order_total_for_redeem)) {

            toastr.error('Minimum order amount is ' + rp_settings.min_order_total_for_redeem +
                ' to redeem the points.');
            return;
        }

        if (rp_settings.min_redeem_point && parseFloat(total_redeem_point) < parseFloat(rp_settings
                .min_redeem_point)) {
        ...
        if (rp_settings.max_redeem_point && parseFloat(total_redeem_point) > parseFloat(rp_settings
                .max_redeem_point)) {
        ...
        var calcLastAmount = parseFloat(calcLastPoint) * parseFloat(parseFloat(rp_settings
            .redeem_amount_per_unit_rp));
