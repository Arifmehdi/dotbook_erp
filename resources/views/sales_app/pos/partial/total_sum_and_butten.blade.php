            ...
            <div class="function-sec">
                <div class="row g-xxl-3 g-xl-2 g-lg-1">
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#"
                                @if (json_decode($generalSettings->pos, true)['is_enabled_draft'] == '1') data-button_type="0"
                                    data-action_id="2"
                                    id="submit_btn"
                                @else
                                    onclick="
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#"
                                @if (json_decode($generalSettings->pos, true)['is_enabled_quotation'] == '1') data-action_id="4"
                                    data-button_type="0"
                                    id="submit_btn"
                                @else
                                    onclick="
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#" class="function-card" id="exchange_btn" data-bs-toggle="modal"
                                data-bs-target="#exchangeModal" tabindex="-1">
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#" class="function-card" id="show_stock" tabindex="-1">@lang('menu.stock')<p>
                                    Alt+C</p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#"
                                @if (json_decode($generalSettings->pos, true)['is_enabled_hold_invoice'] == '1') data-button_type="0"
                                    data-action_id="5"
                                    id="submit_btn"
                                @else
                                    onclick="
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#"
                                @if (json_decode($generalSettings->pos, true)['is_enabled_hold_invoice'] == '1') id="pick_hold_btn"
                                @else
                                    onclick="
                                        event.preventDefault();
                                        toastr.error('Hold invoice is disabled in POS.');
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#"
                                @if (json_decode($generalSettings->pos, true)['is_enabled_suspend'] == '1') data-button_type="0"
                                    data-action_id="6"
                                    id="submit_btn"
                                @else
                                    onclick="
                    ...
                    <div class="col-4">
                        <div class="btn-bg">
                            <a href="#" class="function-card function-card-danger"
                                onclick="cancel(); return false;" tabindex="-1">
                                Cancel <p>Ctrl+M</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="checkout-input-sec">
                    <div class="row g-1">
                        ...
                        <div class="col-sm-9 col-8">
                            <input readonly type="number" class="form-control pos-amounts" name="net_total_amount"
                                id="net_total_amount" value="0.00" tabindex="-1">
                        </div>
                    </div>
                    ...
                    @if (json_decode($generalSettings->pos, true)['is_enabled_discount'] == '1')
                        <div class="row g-1">
                            ...
                            <div class="col-sm-9 col-8">
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <select name="order_discount_type" id="order_discount_type"
                                            class="form-control pos-amounts form-select">
                                    ...
                                    <div class="col-6">
                                        <input name="order_discount" type="number" step="any"
                                            class="form-control pos-amounts" id="order_discount" value="0.00">
                                    </div>
                                </div>

                                <input name="order_discount_amount" type="number" class="d-none"
                                    id="order_discount_amount" value="0.00" tabindex="-1">
                            </div>
                        </div>
                    @else
                    ...
                    @if (json_decode($generalSettings->pos, true)['is_enabled_order_tax'] == '1')
                        <div class="row g-1">
                            ...
                            <div class="col-sm-9 col-8">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <select name="order_tax" class="form-control pos-amounts form-select"
                                            id="order_tax"></select>
                                    </div>

                                    <div class="col-6">
                                        <input type="number" class="form-control pos-amounts"
                                            name="order_tax_amount" id="order_tax_amount" value="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-1">
                        ...
                        <div class="col-sm-9 col-8">
                            <input readonly class="form-control pos-amounts" type="number" step="any"
                                name="previous_due" id="previous_due" value="0.00" tabindex="-1">
                        </div>

                        <label class="col-sm-3 col-4 col-form-label text-white">@lang('menu.payable')</label>
                        <div class="col-sm-9 col-8">
                            <input readonly class="form-control pos-amounts" type="number" step="any"
                    ...
                    <div class="row g-1">
                        ...
                        <div class="col-sm-6 col-7">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="any" name="paying_amount" id="paying_amount"
                                    value="0" class="form-control pos-amounts input_i" autocomplete="off">
                            </div>
                        </div>
                    </div>
                ...
                <div class="sub-btn-sec">
                    <div class="row g-xxl-3 g-1">
                        <div class="col-lg-4 col-6 m-order-2">
                            <div class="btn-bg mb-xxl-1 mb-xl-1">
                                <a href="#" class=" btn-pos"
                                    @if (json_decode($generalSettings->pos, true)['is_enabled_credit_full_sale'] == '1') data-button_type="0"
                                        id="full_due_button"
                                    @else
                                        onclick="
                                            event.preventDefault();
                            ...
                            <div class="btn-bg">
                                <a href="#" class="btn-pos" id="reedem_point_button"
                                    tabindex="-1">@lang('menu.reedem_oint')</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 btn-bottom">
                            <div class="btn-bg">
                                <a href="#" class="function-card cash-btn" id="submit_btn"
                                    data-button_type="1" data-action_id="1" tabindex="-1">
