...
@section('content')
    <div class="body-wraper">
        <div class="main__content">
            <div class="sec-name">
                ...
                <x-all-buttons>
                    <x-add-button :can="'purchase_add'" :href="route('sales.create')" :text="'New Order'" :is_modal="false" />
                    <x-slot name="after">
                        <x-help-button />
                    </x-slot>
                </x-all-buttons>
                                ...
                                <form id="filter_form">
                                    <div class="form-group row align-items-end g-2">
                                        <div class="col-xl-2 col-md-4">
                                            ...
                                            <select name="customer_id" class="form-control submit_able form-select"
                                        ...
                                        <div class="col-xl-2 col-md-4">
                                            <button type="submit" id="filter_button" class="btn btn-sm btn-info"><i
    ...
    <!-- Edit Shipping modal -->
    <div class="modal fade" id="editShipmentModal" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
        aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <ul class="list-unstyled">
                                    ...
                                    <button type="submit" id="print_payment"
                                        class="btn btn-sm btn-success">@lang('menu.print')</button>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        var sales_table = $('.data_tbl').DataTable({
            ...
            columns: [{
                ...
                name: 'sales.total_payable_amount',
                className: 'text-end'
            }, {
                data: 'paid',
                name: 'sales.paid',
