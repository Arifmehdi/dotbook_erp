        ...
        <div class="modal-content">
                        ...
                        <table id="" class="table modal-table table-sm table-striped">
                            <thead>
                                <tr class="bg-primary text-white">
                                    ...
                                    <th class="text-startx">@lang('menu.unit_discount')</th>
                                    <th class="text-startx">@lang('menu.unit_tax')</th>
                                    <th class="text-startx">@lang('menu.unit_price_inc_tax')</th>
            ...
            <div class="modal-footer">
                ...
                @if (auth()->user()->can('shipment_access'))
                    ...
                    class="btn btn-sm btn-success">@lang('menu.print') @lang('menu.packing_slip')</button>
                @endif
