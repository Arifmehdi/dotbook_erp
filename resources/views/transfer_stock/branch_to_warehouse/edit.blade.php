...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <div class="sec-name">
                <h6>@lang('menu.edit_transfer_stock_business_location')</h6>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            <label class="col-4"><b>@lang('menu.b_location') </b><span class="text-danger">*</span></label>
                                            <div class="col-8">
                                            ...
                                            <div class="col-8">
                                                <select class="form-control changeable add_input form-select" name="warehouse_id" data-name="Warehouse" id="warehouse_id">
                                                    ...
                                                    @foreach ($warehouses as $warehouse)
                                                        <option {{ $warehouse->id == $transfer->warehouse_id ? 'SELECTED' : '' }} value="{{ $warehouse->id }}">
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            ...
                                            <div class="col-8">
                                                <input required type="text" name="date" class="form-control changeable" value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($transfer->date)) }}" id="datepicker">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group">
                                            <label class=" col-4"><b>@lang('menu.ref_id') </b> </label>
                                            <div class="col-8">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex justify-content-end">
                                <div class="loading-btn-box">
                                    ...
                                    <button type="submit" class="btn btn-success submit_button">@lang('menu.save_change')
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        if (!$.isEmptyObject(product.product)) {
                            ...
                            if (product.variants.length == 0) {
                                ...
                                $.each(product.variants, function(key, variant) {
                                    ...
                                    li += '<a class="select_variant_product" onclick="salectVariant(this); return false;" data-p_id="' + product.id + '" data-v_id="' + variant.id + '" data-p_name="' + product.name + '" data-p_tax_id="' + product.tax_id + '" data-unit="' + product.unit.name + '" data-tax_percent="' + tax_percent + '" data-tax_amount="' + tax_amount + '" data-v_code="' + variant.variant_code + '" data-v_price="' + variant.variant_price + '" data-v_name="' + variant.variant_name + '" data-v_cost_inc_tax="' + variant.variant_cost_with_tax + '" href="#"><img style="width:30px; height:30px;"  src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + variant.variant_name + ' (' + variant.variant_code +')' + ' - Price: ' + parseFloat(unitPriceIncTax).toFixed(2) + '</a>';
                                    li += '</li>';
                                });
                ...
                success: function(branchVariantQty) {
                    ...
                    if ($.isEmptyObject(branchVariantQty.errorMsg)) {
                        ...
                        if (sameVariant == 0) {
                            ...
                            tr += '</a><br/>';
                            tr += '<small class="text-muted">Current Stock - ' + branchVariantQty + ' (' +
                                product_unit + ')' + '<small>';
                            tr += '<input value="' + product_id + '" type="hidden" class="productId-' +
                                product_id + '" id="product_id" name="product_ids[]">';
