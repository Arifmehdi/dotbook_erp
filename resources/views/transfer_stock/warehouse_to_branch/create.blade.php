...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            <h6>@lang('menu.add_transfer_stock') <small class="text-white">(@lang('menu.warehouse_to_business_location'))</small></h6>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input required type="text" name="date" class="form-control changeable" id="datepicker" value="{{ date(json_decode($generalSettings->business, true)['date_format']) }}" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                <label class="col-4"><b>@lang('menu.ref_id') </b> <i data-bs-toggle="tooltip" data-bs-placement="right" title="If you keep this field empty, The Reference ID will be generated automatically." class="fas fa-info-circle tp"></i></label>
                                                <div class="col-8">
                                                    <input type="text" name="invoice_id" id="invoice_id" class="form-control" placeholder="@lang('menu.reference_id')" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="searching_area" style="position: relative;">
                                                    ...
                                                    <div class="input-group ">
                                                        ...
                                                        <input type="text" name="search_product" class="form-control scanable" autocomplete="off" id="search_product" placeholder="@lang('menu.search_item_item_code_scan_bar_code')" autofocus>
                                                    </div>
                            ...
                            <div class="form_element rounded m-0">
                                <div class="element-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                <label class="col-2"><b>@lang('menu.note') </b></label>
                                                <div class="col-10">
    ...
    <script>
        ...
        $('#search_product').on('input', function(e) {
            ...
            delay(function() {
                ...
                searchProduct(__product_code, warehouse_id);
                    ...
                    if (!$.isEmptyObject(product.product) || !$.isEmptyObject(product.variant_product) || !$
                        ...
                        if (!$.isEmptyObject(product.product)) {
                                ...
                                product_ids.forEach(function(input) {
                                    ...
                                    if (input.value == product.id) {
                                        ...
                                        if (parseFloat(qty_limit) == parseFloat(presentQty)) {
                                            toastr.error('Quantity Limit is - ' + qty_limit + ' ' +
                                                product.unit.name);
                                            return;
                                        }
                            ...
                            if (sameVariant == 0) {
                                ...
                                tr += '</a><br/>';
                                tr += '<small class="text-muted">Current Stock - ' + qty_limit + ' (' +
                                    variant_product.product.unit.name + ')' + '<small>';
                ...
                success: function(singleProductQty) {
                    ...
                    if ($.isEmptyObject(singleProductQty.errorMsg)) {
                        ...
                        if (sameProduct == 0) {
                            ...
                            tr += '</a><br/>';
                            tr += '<small class="text-muted">Current Stock - ' + singleProductQty + ' (' +
                                product_unit + ')' + '<small>';
        ...
        function salectVariant(e) {
            ...
            var url =
                "{{ route('transfer.branch.to.branch.search.item', [':product_id', ':variant_id', ':warehouse_id']) }}";
            var route = url.replace(':product_id', product_id);
                ...
                success: function(warehouseVariantQty) {
                    ...
                    if ($.isEmptyObject(warehouseVariantQty.errorMsg)) {
                        ...
                        if (sameVariant == 0) {
                            ...
                            tr += '</a><br/>';
                            tr += '<small class="text-muted">Current Stock - ' + warehouseVariantQty + ' (' +
                                product_unit + ')' + '<small>';
                            tr += '<input value="' + product_id + '" type="hidden" class="productId-' +
                                product_id + '" id="product_id" name="product_ids[]">';
                        ...
                        toastr.error(warehouseVariantQty.errorMsg);
                    }
                }
            });
        }
