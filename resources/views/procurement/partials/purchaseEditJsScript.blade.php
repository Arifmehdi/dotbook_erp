...
<script>
    ...
    function calculateTotalAmount() {
        ...
        var purchaseTaxPercent = $('#purchase_tax_ac_id').find('option:selected').data('purchase_tax_percent') ? $(
            '#purchase_tax_ac_id').find('option:selected').data('purchase_tax_percent') : 0;
        ...
        var currentSupplierAccountId = $('#current_supplier_account_id').val();
        var selectedSupplierAccountId = $('#supplier_account_id').val();

        if (currentSupplierAccountId == selectedSupplierAccountId) {

            currentCreditAmount -= parseFloat(currentInvoiceAmount);
        }
    ...
    function calculateAdditionalExpense() {
        ...
        var total_additional_expense = parseFloat(scale_charge) + parseFloat(transport_cost) + parseFloat(labour_cost) +
            parseFloat(others);
        ...
        var previousExpensePaid = $('#previous_expense_paid').val() ? $('#previous_expense_paid').val() : 0;
        var currentExpensePayable = parseFloat(total_additional_expense) - parseFloat(previousExpensePaid);
        $('#current_expense_payable').val(parseFloat(currentExpensePayable).toFixed(2));
    }
    ...
    $(document).on('change', '#purchase_tax_ac_id', function() {
        ...
        calculateTotalAmount();
        var purchaseTaxPercent = $(this).find('option:selected').data('purchase_tax_percent') ? $(this).find(
            'option:selected').data('purchase_tax_percent') : 0;
