...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <form id="add_stock_issue_form" action="{{ route('stock.issue.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <section class="mt-5x">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="sec-name">
                                <h6>@lang('menu.create_stock_issue')</h6>
                                <x-back-button />
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <select name="warehouse_id" class="form-control form-select" id="warehouse_id" data-next="department_id">
                                                                ...
                                                                @foreach ($warehouses as $warehouse)
                                                                    <option data-w_name="{{ $warehouse->name . '/' . $warehouse->code }}" value="{{ $warehouse->id }}">{{ $warehouse->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="input-group mt-1">
                                                    <label class="col-4"><b>@lang('menu.receiver_dep') </b><span class="text-danger">*</span> </label>
                                                    <div class="col-8">
                                                        <div class="input-group select-customer-input-group">
                                                            <select required name="department_id" class="form-control select2 form-select" id="department_id" data-next="stock_event_id">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="text" name="voucher_no" id="voucher_no" class="form-control" data-next="stock_event_id" placeholder="@lang('menu.voucher_no')" autocomplete="off">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group select-customer-input-group">
                                                            ...
                                                            <div style="display: inline-block;margin-top:0px;" class="style-btn">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text add_button" id="addStockEvent"><i class="fas fa-plus-square text-dark"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="input-group">
                                                    <label class="col-4"><b>@lang('menu.issue_date') </b><span class="text-danger">*</span> </label>
                                                    <div class="col-8">
                                                        <input type="text" name="date" class="form-control" value="{{ date(json_decode($generalSettings->business, true)['date_format']) }}" id="date" data-next="search_product" placeholder="dd-mm-yyyy" autocomplete="off">
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        ...
                                                        <input name="total_qty" type="hidden" step="any" class="form-control" id="total_qty" value="0.00" tabindex="-1">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="sale-item-inner">
                                                    <div class="table-responsive">
                                                        <table class="display data__table table-striped">
                                                            ...
                                                            <tbody id="issue_item_list"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="element-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input name="note" class="form-control" id="note" data-next="save_and_print" placeholder="@lang('menu.stock_issue_note')">
    ...
    <x-shortcut-key-bar.shortcut-key-bar :items="[['key' => 'Ctrl + Enter', 'value' => __('menu.save_and_print')], ['key' => 'Shift + Enter', 'value' => __('menu.save')], ['key' => 'Alt + G', 'value' => __('menu.add_department')], ['key' => 'Alt + V', 'value' => __('menu.add_event')]]">
...
@push('scripts')
    ...
    <script>
        ...
        $('#addStockEvent').on('click', function() {

            $.get("{{ route('stock.issues.events.create') }}", function(data) {
                            ...
                            if (product.namedProducts.length > 0) {
                                ...
                                $.each(products, function(key, product) {
                                    ...
                                    if (product.is_variant == 1) {
                                        ...
                                        li += '<li>';
                                        li += '<a onclick="selectProduct(this); return false;" data-product_type="single" data-p_id="' + product.id + '" data-v_id="" data-p_name="' + product.name + '" data-v_name="" data-p_code="' + product.product_code + '" data-p_cost_inc_tax="' + product.product_cost_with_tax + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + '</a>';
                                        li += '</li>';
                                    }
                                });
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (!$.isEmptyObject(data.errorMsg)) {
                        ...
                        toastr.success('Successfully Stock Issue is Created.');
                        afterCreateSale();
        ...
        function afterCreateSale() {
            ...
            $('#issue_item_list').empty();
            $("#department_id").select2("destroy");
            $("#stock_event_id").select2("destroy");

            $("#department_id").select2();
            $("#stock_event_id").select2();
