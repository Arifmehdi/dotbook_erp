...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            ...
            <form id="add_purchase_return_form" action="{{ route('purchases.returns.store') }}" method="POST">
                @csrf
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <div style="position: relative;">
                                                        <input type="text" name="purchase_invoice_id" id="purchase_invoice_id" class="form-control fw-bold" data-next="warehouse_id" placeholder="Purchase Invoice ID" autocomplete="off">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="date" class="form-control" id="date" value="{{ date(json_decode($generalSettings->business, true)['date_format']) }}" data-next="search_product" autocomplete="off">
    ...
    <x-shortcut-key-bar.shortcut-key-bar :items="[['key' => 'Ctrl + Enter', 'value' => __('menu.save_and_print')], ['key' => 'Shift + Enter', 'value' => __('menu.save')]]">
    ...
    <script>
        ...
        $('#add_item').on('click', function(e) {
            ...
            if (e_variant_id != 'noid') {
                ...
                var url =
                    "{{ route('general.product.search.variant.product.stock', [':e_product_id', ':e_variant_id', ':warehouse_id']) }}";
                ...
                var url =
                    "{{ route('general.product.search.single.product.stock', [':e_product_id', ':warehouse_id']) }}";
                route = url.replace(':e_product_id', e_product_id);
                route = route.replace(':warehouse_id', warehouse_id);
            }
        ...
        function calculateTotalAmount() {
            ...
            if ($('#return_discount_type').val() == 2) {
                ...
                var returnDisAmount = parseFloat(netTotalAmount) / 100 * parseFloat($('#return_discount').val() ? $(
        ...
        $(document).on('change keypress', 'input', function(e) {
            ...
            if (e.which == 13) {
                ...
                if ($(this).attr('id') == 'date' && $('#search_product').is(':disabled') == true) {
                    ...
                    $('#e_showing_return_quantity').focus().select();
                    return;
                }
