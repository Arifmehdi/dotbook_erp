...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <div class="sec-name">
                <h6>@lang('menu.edit_purchase_requisition')</h6>
            ...
            <div class="p-15">
                <form id="edit_requisition_form" action="{{ route('purchases.requisition.update', $requisition->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input readonly type="text" name="requisition_no" id="requisition_no" class="form-control fw-bold" placeholder="Purchase requisition No" value="{{ $requisition->requisition_no }}" autocomplete="off">
                                                    </div>
                                                </div>

                                                <div class="input-group mt-1">
                                                    <label class="col-4"><span class="text-danger">*</span>
                                                        <b>@lang('menu.department') </b></label>
                                                    <div class="col-8">
                                                        <div class="input-group select-customer-input-group">
                                                            <select required name="department_id" class="form-control select2 form-select" id="department_id" data-next="date">
                                                                ...
                                                                @foreach ($departments as $department)
                                                                    <option {{ $requisition->department_id == $department->id ? 'SELECTED' : '' }} value="{{ $department->id }}">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="input-group">
                                                    <label class="col-4"><b>@lang('menu.requisition_date') </b></label>
                                                    <div class="col-8">
                                                        <input type="text" name="date" class="form-control" id="date" value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($requisition->date)) }}" data-next="requester_id" placeholder="dd-mm-yyyy" autocomplete="off">
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        <div class="input-group select-customer-input-group">
                                                            <select required name="requester_id" class="form-control select2 form-select" id="requester_id" data-next="search_product">
                                                                <option value="">@lang('menu.requested_by')</option>
                                                                @foreach ($requesters as $requester)
                                                                    @php
                                                                        $phone = $requester->phone_number ? '/' . $requester->phone_number : '';
                                                                    @endphp
                                                                    <option {{ $requisition->requester_id == $requester->id ? 'SELECTED' : '' }} value="{{ $requester->id }}">
                                                                        {{ $requester->name . $phone }}</option>
                                                                @endforeach
                                                            </select>
                                                            <div class="input-group-prepend">
                                            ...
                                            <div class="col-xl-4 col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <div class="col-8">
                                                        <input readonly name="total_item" type="number" step="any" class="form-control fw-bold" id="total_item" value="{{ $requisition->total_item }}" tabindex="-1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-group mt-1">
                                                    ...
                                                    <div class="col-8">
                                                        <input type="hidden" name="total_qty" step="any" id="total_qty" value="{{ $requisition->total_qty }}" tabindex="-1">
                                                        <input readonly type="number" step="any" class="form-control fw-bold" id="showing_total_qty" value="{{ $requisition->total_qty }}" tabindex="-1">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-details-sec rounded mt-0 mb-1">
                                        <div class="content-inner">
                                            <div class="row align-items-end">
                                                ...
                                                <div class="col-xl-2 col-md-4 mt-1">
                                                    <label class="fw-bold">@lang('menu.requisition_note')</label>
                                                ...
                                                <div class="col-xl-1 col-md-4">
                                                    <a href="#" class="btn btn-sm btn-success mt-4" id="add_item">@lang('menu.add')</a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="sale-item-inner">
                                                        <div class="table-responsive">
                                                            <table class="display data__table table-striped">
                                                                ...
                                                                <tbody id="requisition_item_list">
                                                                    @php
                                                                        $totalQty = 0;
                                                                        $itemUnitsArray = [];
                                                                    @endphp
                                                                    @foreach ($requisition->requisitionProducts as $rqProduct)
                                                                        @php
                                                                            ...
                                                                            $variant = $rqProduct->variant_id != null ? ' -' . $rqProduct->variant->variant_name : '';
                                                                            $variant_id = $rqProduct->variant_id ? $rqProduct->variant_id : 'noid';
                                                                        @endphp
                                                                        <tr id="select_item">
                                                                            <td>
                                                                                <span id="span_item_name">{{ $rqProduct->product->name . $variant }}</span>
                                                                                <input type="hidden" id="item_name" value="{{ $rqProduct->product->name . $variant }}">
                                                                                <input type="hidden" name="descriptions[]" id="description" value="">
                                                                                <input type="hidden" name="product_ids[]" class="productId-{{ $rqProduct->product_id }}" id="product_id" value="{{ $rqProduct->product_id }}">
                                                                                <input type="hidden" id="variant_id" name="variant_ids[]" value="{{ $variant_id }}">
                                                                                <input type="hidden" name="requisition_product_ids[]" value="{{ $rqProduct->id }}">
                                                                                <input type="hidden" id="{{ $rqProduct->product_id . $variant_id }}" value="{{ $rqProduct->product_id . $variant_id }}">
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_last_unit_cost" class="fw-bold">
                                                                                    {{ $rqProduct->last_purchase_price . ' ' . __('menu.per') . ': ' }}
                                                                                    {{ $rqProduct->requisitionUnit?->baseUnit ? $rqProduct->requisitionUnit?->baseUnit->name : $rqProduct?->product->unit?->name }}
                                                                                </span>
                                                                                <input type="hidden" name="last_unit_costs[]" id="last_unit_cost" value="{{ $rqProduct->last_purchase_price }}">
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_current_stock" class="fw-bold">
                                                                                    {{ $rqProduct->current_stock }}/{{ $rqProduct->requisitionUnit?->baseUnit ? $rqProduct->requisitionUnit?->baseUnit->name : $rqProduct?->product->unit?->name }}
                                                                                </span>
                                                                                <input name="current_stocks[]" type="hidden" id="current_stock" value="{{ $rqProduct->current_stock }}">
                                                                            </td>

                                                                            @php
                                                                                $baseUnitMultiplier = $rqProduct?->requisitionUnit?->base_unit_multiplier ? $rqProduct?->requisitionUnit?->base_unit_multiplier : 1;
                                                                                $requestedQty = $rqProduct->quantity / $baseUnitMultiplier;
                                                                                $totalQty += $requestedQty;
                                                                            @endphp

                                                                            <td>
                                                                                <span id="span_showing_quantity" class="fw-bold">{{ bcadd($requestedQty, 0, 2) }}</span>
                                                                                <input type="hidden" id="showing_quantity" value="{{ bcadd($requestedQty, 0, 2) }}">
                                                                                <input type="hidden" name="quantities[]" id="quantity" value="{{ $rqProduct->quantity }}">
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_unit_name" class="fw-bold">{{ $rqProduct?->requisitionUnit?->name }}</span>
                                                                                <input type="hidden" name="unit_ids[]" id="unit_id" value="{{ $rqProduct->unit_id }}">
                                                                                <input type="hidden" id="base_unit_name" value="{{ $rqProduct?->product->unit?->name }}">
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_purpose" class="fw-bold">{{ $rqProduct->purpose }}</span>
                                                                                <input type="hidden" name="purposes[]" id="purpose" value="{{ $rqProduct->purpose }}">
                                                                            </td>

                                                                            <td>
                                                                                <span id="span_pr_type_name" class="fw-bold">{{ $rqProduct->pr_type == 1 ? __('menu.normal') : __('menu.emergency') }}</span>
                                                                                <input type="hidden" name="pr_types[]" id="pr_type" value="{{ $rqProduct->pr_type }}">
                                                                            </td>
                                    ...
                                    <div class="element-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input name="note" class="form-control" value="{{ $requisition->note }}" data-next="save" placeholder="@lang('menu.requisition_note')">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 d-flex justify-content-end">
                            <div class="loading-btn-box">
                                ...
                                <button type="button" id="save" class="btn btn-success submit_button">@lang('menu.save_change')</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <x-shortcut-key-bar.shortcut-key-bar :items="[['key' => 'Ctrl + Enter', 'value' => __('menu.save_changes')], ['key' => 'Alt + G', 'value' => __('menu.add_department')], ['key' => 'Alt + R', 'value' => __('menu.add_requester')]]">
    ...
    <div class="modal fade" id="requestAddOrEditModal" data-bs-backdrop="static" data-bs-keyboard="true" aria-labelledby="staticBackdrop"></div>
...
@push('scripts')
    ...
    <script>
                            ...
                            if (product.namedProducts.length > 0) {
                                ...
                                $.each(products, function(key, product) {
                                    ...
                                    if (product.is_variant == 1) {
                                        ...
                                        li += '<li class="mt-1">';
                                        li += '<a class="select_variant_product" onclick="selectProduct(this); return false;" data-p_id="' + product.id + '" data-v_id="' + product.variant_id + '" data-p_name="' + product.name + '" data-base_unit_name="' + product.unit_name + '" data-v_name="' + product.variant_name + '" data-current_stock="' + product.variant_quantity + '" data-p_code="' + product.variant_code + '" data-p_cost_exc_tax="' + product.variant_cost_with_tax + '" href="#"><img style="width:20px; height:20px;" src="' + product.thumbnail_photo + '"> ' + product.name + ' - ' + product.variant_name + '</a>';
                                        li += '</li>';
                                    } else {
        ...
        $('#add_item').on('click', function(e) {
            ...
            if (uniqueIdValue == undefined) {
                ...
                tr += '<input type="hidden" name="requisition_product_ids[]" value="">';
                ...
                tr += '<input type="hidden" name="current_stocks[]" id="current_stock" value="' + parseFloat(e_current_stock).toFixed(2) + '">';
                tr += '</td>';
    ...
    <script>
        ...
        $('#edit_requisition_form').on('submit', function(e) {
            e.preventDefault();
            $('.loading_button').show();
            ...
            $(document).on('submit', '#add_quick_product_form', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#e_variant_id').val('noid');
                        $('#e_showing_quantity').val(parseFloat(1).toFixed(2)).focus().select();
                        $('#e_last_purchase_cost').val(parseFloat(product.product_cost_with_tax).toFixed(2));
