...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            ...
            <form id="edit_process_form" action="{{ route('manufacturing.process.update', $process->id) }}"
                ...
                <section class="p-15">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="form_element m-0 rounded">
                                <div class="element-body mb-2">
                                    <div class="row">
                                        <div class="col-md-12">
                                            @php
                                                $p_code = $process->v_code ? $process->v_code : $process->p_code;
                                            @endphp
                                            <p> <strong>@lang('menu.product') :</strong>
                                                {{ $process->p_name . ' ' . $process->v_name . ' (' . $process->p_code . ')' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="searching_area" style="position: relative;">
                                                    <label for="inputEmail3"
                                                        class="col-form-label">@lang('menu.select_ingredients')</label>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="search_product"
                                                            ...
                                                            id="search_product"
                                                            placeholder="Search Ingredient by product code(SKU) / Scan bar code"
                                                            autofocus>
                                                    </div>
                                                            ...
                                                            <tbody id="ingredient_list">
                                                                @foreach ($processIngredients as $ingredient)
                                                                    <tr class="text-start">
                                                                        <td>
                                                                            <span
                                                                                class="product_name">{{ $ingredient->p_name }}</span><br>
                                                                            <span
                                                                                class="product_variant">{{ $ingredient->v_name }}</span>
                                                                            <input value="{{ $ingredient->p_id }}"
                                                                                type="hidden"
                                                                                class="productId-{{ $ingredient->p_id }}"
                                                                                id="product_id" name="product_ids[]">
                                                                            <input
                                                                                value="{{ $ingredient->v_id ? $ingredient->v_id : 'noid' }}"
                                                                                type="hidden" id="variant_id"
                                                                                name="variant_ids[]">
                                                                        </td>

                                                                        <td>
                                                                            <input value="{{ $ingredient->final_qty }}"
                                                                                required name="final_quantities[]"
                                                                        ...
                                                                        <td>
                                                                            <select name="unit_ids[]" id="unit_id"
                                                                        ...
                                                                        <td>
                                                                            <input readonly
                                                                                value="{{ $ingredient->unit_cost_inc_tax }}"
                                                                                name="unit_costs_inc_tax[]" type="text"
                                                                                id="unit_cost_inc_tax"
                                                                                class="form-control text-center">
                                                                        </td>

                                                                        <td>
                                                                            <input value="{{ $ingredient->subtotal }}"
                                                                                type="text"
                                                                                class="form-control text-center"
                                                                                name="subtotals[]" id="subtotal">
                                                                        </td>

                                                                        <td class="text-start">
                                                                            <a href="#" id="remove_product_btn"
                                                                                class="c-delete"><span
                    ...
                    <input type="hidden" name="total_ingredient_cost" id="total_ingredient_cost"
                        value="{{ $process->total_ingredient_cost }}">
                                ...
                                <div class="element-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="row">
                                                <div class="col-7">
                                                    <input type="number" step="any" name="total_output_qty"
                                                        class="form-control" autocomplete="off" id="total_output_qty"
                                                        placeholder="Total Output Quantity"
                                                        value="{{ $process->total_output_qty }}">
                                                </div>
                                                ...
                                                <div class="col-5">
                                                    <select name="unit_id" class="form-control form-select"
                                                        id="unit_id">
                                                        @foreach ($units as $unit)
                                                            <option {{ $unit->id == $process->unit_id ? 'SELECTED' : '' }}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" step="any" name="production_cost"
                                                class="form-control" autocomplete="off" id="production_cost"
                                                placeholder="@lang('menu.production_cost')" value="{{ $process->production_cost }}">
                                        </div>

                                        <div class="col-md-3">
                                            <label><b>@lang('menu.total_cost') </b></label>
                                            <input required type="number" step="any" name="total_cost"
                                                class="form-control" autocomplete="off" id="total_cost"
                                                placeholder="@lang('menu.total_cost')" value="{{ $process->total_cost }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(units) {
                    $.each(units, function(key, unit) {
                        $('#unit_id').append('<option value="' + unit.id + '">' + unit.name +
                            '</option>');
                        unites.push({
                            id: unit.id,
                            name: unit.name
                    ...
                    if (!$.isEmptyObject(product.product) || !$.isEmptyObject(product.variant_product) || !$
                        ...
                        if (!$.isEmptyObject(product.product)) {
                            ...
                            if (product.variants.length == 0) {
                                ...
                                product_ids.forEach(function(input) {
                                    ...
                                    if (input.value == product.id) {
                                        ...
                                        // update subtotal
                                        var totalCost = parseFloat(unitCostIncTax) * parseFloat(
                                            updateQty);
                                        closestTr.find('#subtotal').val(parseFloat(totalCost).toFixed(
                                            2));
                                        closestTr.find('#span_subtotal').html(parseFloat(totalCost)
                                            .toFixed(2));
                                ...
                                if (sameProduct == 0) {
                                    ...
                                    tr += '<td>';
                                    tr +=
                                        '<input value="1" required name="final_quantities[]" type="number" step="any" class="form-control text-center" id="final_quantity">';
                                    tr += '</td>';

                                    tr += '<td>';
                                    tr +=
                                        '<select name="unit_ids[]" id="unit_id" class="form-control form-select">';
                                    unites.forEach(function(unit) {

                                        if (product.unit.id == unit.id) {

                                            tr += '<option SELECTED value="' + unit.id + '">' + unit
                                                .name + '</option>';
                                        } else {

                                            tr += '<option value="' + unit.id + '">' + unit.name +
                                                '</option>';
                                        }
                                    });
                                    ...
                                    tr += '<td>';
                                    tr += '<input readonly value="' + product.product_cost_with_tax +
                                        '" type="text" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax" class="form-control text-center">';
                                    tr += '<span id="span_price">' + product.product_cost_with_tax + '</span>';
                                    tr += '</td>';

                                    tr += '<td>';
                                    tr += '<input readonly value="' + product.product_cost_with_tax +
                                        '" type="text" name="subtotals[]" id="subtotal" class="form-control text-center">';
                                    tr += '</td>';
                                ...
                                $.each(product.variants, function(key, variant) {
                                    ...
                                    li +=
                                        ...
                                        product.name + '"  data-unit="' + product.unit.id +
                                        '" data-v_code="' + variant.variant_code + '" data-v_cost="' +
                                        variant.variant_cost + '" data-v_cost_with_tax="' + variant
                                        .variant_cost_with_tax + '"  data-v_name="' + variant
                                        .variant_name + '" href="#">' + product.name + ' - ' + variant
                                        .variant_name + ' (' + variant.variant_code + ')' +
                                        ' - Unit Cost: ' + variant.variant_cost_with_tax + '</a>';
                                    li += '</li>';
                                });
                                ...
                                $.each(products, function(key, product) {
                                    ...
                                    if (product.is_variant == 1) {
                                        ...
                                        li +=
                                            ...
                                            '" data-p_name="' + product.name + '"  data-unit="' +
                                            product.unit_id + '" data-v_code="' + product.variant_code +
                                            '" data-v_cost="' + product.variant_cost +
                                            '" data-v_cost_with_tax="' + product.variant_cost_with_tax +
                                            '" data-v_name="' + product.variant_name + '" href="#">' +
                                            product.name + ' - ' + product.variant_name + ' (' + product
                                            .variant_code + ')' + ' - Unit Cost: ' + product
                                            .variant_cost_with_tax + '</a>';
                                        li += '</li>';
                                        ...
                                        li += '<li class="mt-1">';
                                        li +=
                                            '<a class="select_single_product" onclick="singleProduct(this); return false;" data-p_id="' +
                                            product.id + '" data-p_name="' + product.name +
                                            '" data-p_tax_id="' + product.tax_ac_id + '" data-unit="' +
                                            product.unit_id + '" data-p_code="' + product.product_code +
                                            '" data-p_cost_with_tax="' + product.product_cost_with_tax +
                                            '" data-p_name="' + product.name + '" href="#">' + product
                                            .name + ' (' + product.product_code + ')' +
                                            ' - Unit Cost: ' + product.product_cost_with_tax + '</a>';
                                        li += '</li>';
                                    }
                                });
                            ...
                            if (sameVariant == 0) {
                                ...
                                tr += '<td>';
                                tr +=
                                    '<input value="1" required name="final_quantities[]" type="number" step="any" class="form-control text-start" id="final_quantity">';
                                tr += '</td>';
                                ...
                                unites.forEach(function(unit) {
                                    ...
                                    if (product.unit.id == unit.id) {
                                        ...
                                        tr += '<option SELECTED value="' + unit.id + '">' + unit.name +
                                            '</option>';
                                    } else {
                                ...
                                tr += '<td>';
                                tr += '<input readonly value="' + variant_product.variant_cost_with_tax +
                                    '" type="text" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax" class="form-control text-start">';
                                tr += '</td>';

                                tr += '<td>';
                                tr += '<input readonly value="' + variant_product.variant_cost_with_tax +
                                    '" type="text" name="subtotals[]" id="subtotal" class="form-control text-start">';
                                tr += '</td>';
        ...
        function singleProduct(e) {
            ...
            if (sameProduct == 0) {
                ...
                tr += '<span class="product_variant"></span>';
                tr += '<input value="' + productId + '" type="hidden" class="productId-' + productId +
                    '" id="product_id" name="product_ids[]">';
                ...
                tr += '<td>';
                tr += '<select name="unit_ids[]" id="unit_id" class="form-control form-select">';
                unites.forEach(function(unit) {
                ...
                tr += '<td>';
                tr += '<input readonly value="' + productCostIncTax +
                    '" type="text" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax" class="form-control text-center">';
                tr += '</td>';
        ...
        function salectVariant(e) {
            ...
            if (sameVariant == 0) {
                ...
                tr += '<input value="' + productId + '" type="hidden" class="productId-' + productId +
                    '" id="product_id" name="product_ids[]">';
                tr += '<input value="' + variantId + '" type="hidden" class="variantId-' + variantId +
                    '" id="variant_id" name="variant_ids[]">';
                tr += '</td>';
                ...
                tr += '<td class="text-start">';
                tr += '<input readonly value="' + variantCost +
                    '" type="text" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax" class="form-control text-center">';
                tr += '</td>';
