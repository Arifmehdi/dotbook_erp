...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <form id="add_process_form" action="{{ route('manufacturing.process.store') }}" enctype="multipart/form-data"
                method="POST">
                @csrf
                ...
                <section>
                    <div class="sec-name">
                        <h6>@lang('menu.create_process')</h6>
                        <div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p> <strong>@lang('menu.product') :</strong>
                                            {{ $product['p_name'] . ' ' . $product['v_name'] . ' (' . $p_code . ')' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form_element rounded">
                                <div class="element-body">
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-7">
                                                    <input type="number" step="any" name="total_output_qty"
                                                        ...
                                                        placeholder="Total Output Quantity" value="1.00">
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <label><b>@lang('menu.additional_production_cost') </b></label>
                                            <input type="number" step="any" name="production_cost" class="form-control"
                                                autocomplete="off" id="production_cost" placeholder="Production Cost"
                                                value="0">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input required type="number" step="any" name="total_cost"
                                                ...
                                                placeholder="@lang('menu.total_cost')">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="submit_button_area p-15">
                    <div class="row">
            ...
            $.ajax({
                ...
                success: function(units) {
                    $.each(units, function(key, unit) {
                        ...
                        $('#unit_id').append('<option ' + (unit.id == unit_id ? 'SELECTED' : '') +
        ...
        function salectVariant(e) {
            ...
            if (sameVariant == 0) {
                ...
                tr += '<input value="' + variantId + '" type="hidden" class="variantId-' + variantId +
                    '" id="variant_id" name="variant_ids[]">';
                tr += '<input type="hidden" value="' + variantCost +
                '" name="unit_costs_inc_tax[]" id="unit_cost_inc_tax">';
                tr += '</td>';
