    ...
    <div class="modal-dialog modal-full-display">
        <div class="modal-content">
                            ...
                            <table class="table modal-table table-sm table-striped">
                                <thead>
                                    <tr class="bg-primary">
                                        ...
                                        <th class="text-white text-start">@lang('menu.unit_cost_inc_tax')</th>
                                ...
                                <tbody class="purchase_print_product_list">
                                    @foreach ($production->ingredients as $ingredient)
                                        <tr>
                                            ...
                                            <td class="text-start">{{ $ingredient->product->name.' '.$variant }}</td>
            ...
            <div class="modal-footer">
                <a href="{{ route('manufacturing.productions.edit', $production->id) }}" class="btn btn-sm btn-secondary m-0 me-2">@lang('menu.edit')</a>
