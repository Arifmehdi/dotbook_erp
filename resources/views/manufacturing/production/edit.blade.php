...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid">
            <form id="update_production_form" action="{{ route('manufacturing.productions.update', $production->id) }}"
                method="POST">
                @csrf
                <input name="product_id" type="text" id="product_id" class="d-none"
                    value="{{ $production->product_id }}">
                <input name="variant_id" type="text" id="variant_id" class="d-none"
                    value="{{ $production->variant_id }}">
                <section class="mt-5x">
                    <div class="container-fluid">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            <select name="production_account_id" class="form-control add_input form-select"
                                                ...
                                                @foreach ($productionAccounts as $productionAccount)
                                                    <option
                                                        {{ $productionAccount->id == $production->production_account_id ? 'SELECTED' : '' }}
                                                        value="{{ $productionAccount->id }}">
                                            ...
                                            @if ($production->warehouse_id)
                                                ...
                                                <select class="form-control changeable add_input form-select"
                                                    ...
                                                    @foreach ($warehouses as $w)
                                                        <option {{ $production->warehouse_id == $w->id ? 'SELECTED' : '' }}
                                                            value="{{ $w->id }}">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="reference_no" class="form-control changeable"
                                                placeholder="@lang('menu.voucher_no')" value="{{ $production->reference_no }}" />
                                        </div>

                                        <div class="col-md-2">
                                            <label><b>@lang('menu.date') </b></label>
                                            <input required type="text" name="date" class="form-control changeable"
                                                value="{{ date(json_decode($generalSettings->business, true)['date_format'], strtotime($production->date)) }}"
                                                id="datepicker">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            @if ($production->stock_warehouse_id)
                                                ...
                                                <input readonly type="text" class="form-control"
                                                    value="{{ $production->stock_warehouse->warehouse_name . '/' . $production->stock_warehouse->warehouse_code }}"
                                                    tabindex="-1">
                                            @else
                                                <label><b>@lang('menu.ingredient_stock_location') </b> </label>
                                                <input readonly type="text" name="stock_branch_id" class="form-control"
                                                    value="{{ json_decode($generalSettings->business, true)['shop_name'] . ' ' }}"
                                                    tabindex="-1" />
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input readonly type="text"
                                                value="{{ $production->product->name }} {{ $production->variant ? $production->variant->variant_name : '' }}"
                                                            ...
                                                            <tbody id="ingredient_list">
                                                                @foreach ($production->ingredients as $ingredient)
                                                                            ...
                                                                            if ($production->stock_warehouse_id) {
                                                                                ...
                                                                                if ($productWarehouse) {
                                                                                    $productWarehouseVariant = DB::table('product_warehouse_variants')
                                                                                        ...
                                                                                        ->where('product_variant_id', $ingredient->variant_id)
                                                                                        ->first();
                                                                    ...
                                                                    <tr class="text-start">
                                                                        <td>
                                                                            <span
                                                                                class="product_name">{{ $ingredient->product->name }}</span><br>
                                                                            <span
                                                                                class="product_variant">{{ $ingredient->variant_id ? $ingredient->variant->variant_name : '' }}</span>
                                                                            <input value="{{ $ingredient->product_id }}"
                                                                                type="hidden"
                                                                                class="productId-{{ $ingredient->product_id }}"
                                                                                id="product_id" name="product_ids[]">
                                                                            <input
                                                                                value="{{ $ingredient->variant_id ? $ingredient->variant_id : 'noid' }}"
                                                                                type="hidden" id="variant_id"
                                                                                name="variant_ids[]">
                                                                            <input value="{{ $ingredient->unit->id }}"
                                                                                name="unit_ids[]" type="hidden"
                                                                                step="any" id="unit_id">
                                                                            <input
                                                                                value="{{ bcadd($ingredient->input_qty, 0, 2) }}"
                                                                                type="hidden" step="any"
                                                                                id="previous_qty">
                                                                            <input value="{{ bcadd($stock, 0, 2) }}"
                                                                                type="hidden" step="any"
                                                                        ...
                                                                        <td>
                                                                            <div class="input-group p-2">
                                                                                <input
                                                                                    value="{{ $ingredient->input_qty }}"
                                                                                    required name="input_quantities[]"
                                                                                    type="number"
                                                                                    class="form-control text-center"
                                                                                    id="input_quantity">
                                                                                <input
                                                                                    value="{{ $ingredient->parameter_quantity }}"
                                                                                    name="parameter_input_quantities[]"
                                                                                    type="hidden"
                                                                                    id="parameter_input_quantity">
                                                                                <div class="input-group-prepend">
                                                                                    <span
                                                                                        class="input-group-text input-group-text-custom">{{ $ingredient->unit->name }}</span>
                                                                                </div>
                                                                                &nbsp;<strong>
                                                                                    <p class="text-danger m-0 p-0"
                                                                                        id="input_qty_error"></p>
                                                                                </strong>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <input
                                                                                ...
                                                                                required name="unit_costs_inc_tax[]"
                                                                                type="hidden" id="unit_cost_inc_tax">
                                                                            <span
                                                                                id="span_unit_cost_inc_tax">{{ $ingredient->unit_cost_inc_tax }}</span>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <span
                                                                                id="span_subtotal">{{ $ingredient->subtotal }}</span>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" class="d-none" name="total_ingredient_cost" id="total_ingredient_cost"
                            value="{{ $production->total_ingredient_cost }}">
                        <p class="mt-1 float-end clearfix"><strong>@lang('menu.total_ingredient_cost') : </strong> <span
                                id="span_total_ingredient_cost">{{ $production->total_ingredient_cost }}</span></p>
                    </div>
                </div>
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input required type="number" step="any" data-name="Quantity"
                                                        class="form-control add_input" name="output_quantity"
                                                        id="output_quantity" value="{{ $production->quantity }}">
                                                    <input type="text" name="parameter_quantity" class="d-none"
                                                        id="parameter_quantity"
                                                        value="{{ $production->parameter_quantity }}">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" step="any" name="wasted_quantity"
                                                        class="form-control" id="wasted_quantity"
                                                        value="{{ $production->wasted_quantity }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input readonly type="text" step="any" class="form-control"
                                                        ...
                                                        value="{{ $production->total_final_quantity }}" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input name="production_cost" type="number" class="form-control"
                                                        id="production_cost" value="{{ $production->production_cost }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input readonly type="number" step="any" name="total_cost"
                                                        ...
                                                        value="{{ $production->total_cost }}" tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-8">
                                                    <select class="form-control form-select" name="tax_ac_id"
                                                        ...
                                                        @foreach ($taxes as $tax)
                                                            <option
                                                                {{ $tax->id == $production->tax_ac_id ? 'SELECTED' : '' }}
                                                                value="{{ $tax->id . '-' . $tax->tax_percent }}">
                                                                {{ $tax->tax_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-8">
                                                    <select name="tax_type" class="form-control form-select"
                                                        id="tax_type">
                                                        <option {{ $production->tax_type == 1 ? 'SELECTED' : '' }}
                                                            value="1">@lang('menu.exclusive')</option>
                                                        <option {{ $production->tax_type == 2 ? 'SELECTED' : '' }}
                                                            value="2">@lang('menu.inclusive')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input readonly type="text" name="per_unit_cost_inc_tax"
                                                        ...
                                                        value="{{ $production->unit_cost_inc_tax }}" tabindex="-1"
                                                        tabindex="-1">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="xMargin" id="xMargin"
                                                        ...
                                                        autocomplete="off" value="{{ $production->x_margin }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="selling_price" id="selling_price"
                                                        ...
                                                        autocomplete="off" value="{{ $production->price_exc_tax }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="float-end is_final">
                                        <input type="checkbox" {{ $production->is_final == 1 ? 'CHECKED' : '' }}
                                            name="is_final" id="is_final"> &nbsp; <b> @lang('menu.finalize')</b> <i
                                ...
                                <div class="row mt-1">
                                    <div class="col-md-12 d-flex justify-content-end">
                                        <div class="loading-btn-box">
                                            ...
                                            <button
                                                class="btn btn-sm btn-success submit_button float-end">@lang('menu.save_change')</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
