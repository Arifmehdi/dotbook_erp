                ...
                <div class="row g-1">
                    <div class="col-md-3">
                        <div class="card mail-sidebar">
                            <div class="card-body">
                                <button class="btn btn-default btn-block mb-2 px-4 rounded-pill" data-bs-toggle="modal"
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    <form id="all_delete_form" action="{{ route('communication.whatsapp.delete_all') }}"
                                        method="post">
                                        @csrf
                        ...
                        <div class="row">
                            <div class="col-5">
                                <button type="button" class="btn btn-primary btn-sm mb-2 p-1" id="addMoreButton"><i
                                        class="fas fa-plus"></i> Add More Whatsapp Numbers</button>
                            </div>
                        ...
                        <div class="row" id="to_area">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="to[]" class="form-control add_input" data-name="To"
                                    id="phone_number" placeholder="Whatsapp Number" />
