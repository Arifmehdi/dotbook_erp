<form id="update_number_form" action="{{ route('communication.contacts.number.update') }}" method="POST"
    ...
    <div class="form-group">
        ...
        <select name="group_name" required class="form-control submit_able form-select" id="e_group_name" autofocus>
    ...
    <div class="form-group">
        ...
        <input required type="text" name="name" class="form-control " id="name"
            placeholder="@lang('menu.name')" value="{{ $number->name }}" />
        <span class="error error_e_name"></span>
    </div>

    <div class="form-group">
        <label><b>@lang('menu.phone_number')</b> <span class="text-danger">*</span></label>
        <input required type="text" name="phone_number" class="form-control " id="phone_number"
            placeholder="@lang('menu.phone_number')" value="{{ $number->phone_number }}" />
        <span class="error error_e_phone_number"></span>
    </div>

    <div class="form-group">
        <label><b>Whatsapp Number </b> <span class="text-danger">*</span></label>
        <input required type="text" name="whatsapp_number" class="form-control " id="phone_number"
            placeholder="Whatsapp Number" value="{{ $number->whatsapp_number }}" />
    ...
    <div class="form-group">
        ...
        <input required type="text" name="mailing_address" class="form-control " id="mailing_address"
            placeholder="Mailing Address" value="{{ $number->mailing_address }}" />
        ...
        <div class="col-md-12 d-flex justify-content-end">
            <div class="loading-btn-box">
                ...
                <button type="submit" class="btn btn-sm btn-success float-end"
                    id="update_number_btn">@lang('menu.save_change')</button>
                <button type="button" class="btn btn-sm btn-danger float-end me-2"
                    id="close_number_form">@lang('menu.close')</button>
            </div>
        </div>
    </div>
</form>
