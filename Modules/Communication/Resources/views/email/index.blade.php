                ...
                <div class="row g-1">
                    <div class="col-md-3">
                        <div class="card mail-sidebar">
                            <div class="card-body">
                                <button class="btn btn-primary rounded-pill mb-2"
                                    data-bs-toggle="modal" data-bs-target="#addCompose"><i
                                        class="fa-light fa-pen-fancy"></i> Compose</button>
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                ...
                                <div class="table-responsive mailbox-messages">
                                    <form id="all_delete_form" action="{{ route('communication.email.delete_all') }}"
                                        method="post">
                                        @csrf
...
@push('scripts')
    ...
    <script>
        ...
        child +=
            '<input type="email" name="to[]" class="form-control add_input" data-name="To" id="email" placeholder="Email" />';
