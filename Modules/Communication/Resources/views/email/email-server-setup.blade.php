                            ...
                            <div class="form-area customFormDedign">
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="loading-btn-box">
                                        ...
                                        <button type="button" id="resetForm" class="btn btn-sm btn-danger me-2">@lang('menu.reset')</button>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mailbox-controls">
                            <button type="button" class="btn btn-primary checkbox-toggle" id="check_all"><i class="far fa-square"></i></button>
                            ...
                            <form id="all_delete_form" action="{{ route('communication.email.server.delete_all') }}" method="post">
                                ...
                                <div class="form-area customFormDedign">
                                    <div class="row g-3 mb-1">
                                        <label for="" class="col-3">Server</label>
                                        <div class="col-9">
                                            <input name="server_name" id="server_name" class="form-control" type="text"
                                                placeholder="E.x. smtp">
                                            <input name="mail_server_primary_id" id="mail_server_primary_id" type="hidden">
                                            <span class="error error_server_name"></span>
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-1">
                                        <label for="" class="col-3">Host</label>
                                        <div class="col-9">
                                            <input name="host" id="host" name="" id=""
                                                class="form-control" type="text" placeholder="E.x. smtp.gmail.com">
                                            <span class="error error_host"></span>
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-4">
                                        <label for="" class="col-3">Port</label>
                                        <div class="col-9">
                                            <input name="port" id="port" class="form-control" type="number"
                                                placeholder="E.x. 587">
                                            <span class="error error_port"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        <label for="" class="col-3">Encryption</label>
                                        <div class="col-9">
                                            <input name="encryption" id="encryption" class="form-control" type="text"
                                                placeholder="E.x. Tls/Ssl">
                                            <span class="error error_encryption"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 mb-1">
                                        ...
                                        <div class="col-9">
                                            <input name="address" id="address" class="form-control" type="text"
                                                placeholder="E.x. xyz@example.com">
                                            <span class="error error_address"></span>
                                        </div>
                                    </div>
                                    <div class="row g-3 mb-1">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <form id="all_delete_form" action="{{ route('communication.email.server.delete_all') }}"
                                method="post">
                                @csrf
