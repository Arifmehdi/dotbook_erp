<style>
    #submit_bulk_phone_number_form .form-group label {
        text-align: right;
    }
</style>
...
<div class="modal-dialog col-30-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">Import phone Number Address <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_bulk_phone_number_form" action="{{ route('communication.sms.manual-service.phone-number-import-store') }}" enctype="multipart/form-data" method="POST">
                @csrf
...
<script>
    $('#submit_bulk_phone_number_form').on('submit',function(e) {
        e.preventDefault();
        $('.loading_button').show();
