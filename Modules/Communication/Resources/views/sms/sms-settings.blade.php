                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-2">
                            <form id="sms_settings_form" class="setting_form"
                                action="{{ route('communication.sms.settings.store') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <div class="setting_form_heading">
                                        <h6 class="text-primary"><code>{{ strtoupper($smsSetting['type']) }}</code> REQUEST
                                            TO :</h6>
                                        <p class="py-2">
                                        <p class="mb-3"><code style="font-size: 12px;"
                                                id="url">{{ $smsSetting['final_url'] }}</code></p>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row g-2 mb-3">
                                            <div class="col-md-10">
                                                <input type="text" name="url" class="form-control" placeholder="URL"
                                                    autocomplete="off" value="{{ $smsSetting['url'] ?? '' }}">
                                            </div>
                                            <div class="col-md-1">
                                                <select name="type" class="form-control form-select" placeholder="">
                                                    <option value="get"
                                                        {{ $smsSetting['type'] == 'get' ? 'selected' : '' }}>GET</option>
                                                    <option value="post"
                                                        {{ $smsSetting['type'] == 'post' ? 'selected' : '' }}>POST</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                                            ...
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-md-6 mt-1">
                                                                    <input type="text" name="value[]"
                                                                        class="form-control" placeholder="REPLACING VALUE"
                                        ...
                                        <div class="row mt-4">
                                            <p class="checkbox_input_wrap d-flex align-items-center">
                                                <input type="checkbox" name="status"
                                                    {{ $smsSetting['status'] === 1 ? 'checked' : '' }}> &nbsp;
                                                <b>@lang('menu.is_active')</b>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12 d-flex justify-content-end">
                                        <div class="loading-btn-box">
                                            ...
                                            <button
                                                class="btn w-auto btn-success submit_button float-end">@lang('menu.save_change')</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
