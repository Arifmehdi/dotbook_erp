...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('core.bd-districts.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table district-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('core.bd-districts.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('District Name') }}" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bn_name" class="form-control form-control-sm add_input"
                                data-name="{{ __('District Name (Bangla)') }}" id="bn_name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="url" class="form-control form-control-sm add_input"
                                data-name="{{ __('Web Address') }}" id="url"
                        ...
                        <div class="col-xl-12 col-md-12">
                            ...
                            <select name="division_id" class="form-control submit_able form-select" id="division_id"
                                autofocus="">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.district-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('core.bd-districts.index') }}",
                    "data": function(data) {
