...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :can="'customer_add'" />
                </x-slot>
            </x-all-buttons>
        </div>

        <form id="bulk_action_form" action="{{ route('core.bd-upazila.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table thana-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
                                                    ...
                                                    <th class="text-start">{{ __('English Name') }}</th>
                                                    <th class="text-start">{{ __('Bangla Name') }}</th>
                                                    <th class="text-start">{{ __('Web Address') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('core.bd-upazila.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <label><b> {{ __('Upazila Name') }}</b> <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Upazila Name') }}" id="name" placeholder="{{ __('Upazila Name') }}"
                                required />
                            <span class="error error_name"></span>
                        </div>

                        <div class="form-group">
                            <label><b> {{ __('Upazila Name (Bangla)') }}</b> <span class="text-danger">*</span></label>
                            <input type="text" name="bn_name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Upazila Name (Bangla)') }}" id="bn_name"
                                placeholder="{{ __('Upazila Name (Bangla)') }}" required />
                        ...
                        <div class="col-xl-12 col-md-12">
                            ...
                            <select name="district_id" class="form-control submit_able" id="district_id" autofocus=""
                                required>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            var allRow = '';
            var trashedRow = '';
            var table = $('.thana-table').DataTable({
                dom: "lBfrtip",
                buttons: [{
                        extend: 'pdf',
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('core.bd-upazila.index') }}",
                    "data": function(data) {
