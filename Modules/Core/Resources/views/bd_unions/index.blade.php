...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('core.bd-unions.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table union-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('core.bd-unions.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bn_name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Unions Name (Bangla)') }}" id="bn_name"
                                placeholder="{{ __('Unions Name (Bangla)') }}" required />
                        ...
                        <div class="col-xl-12 col-md-12">
                            ...
                            <select name="upazilla_id" class="form-control submit_able" id="upazilla_id" autofocus=""
                                required>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            var allRow = '';
            var trashedRow = '';
            var table = $('.union-table').DataTable({
                dom: "lBfrtip",
                buttons: [{
                        extend: 'pdf',
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('core.bd-unions.index') }}",
                    "data": function(data) {
