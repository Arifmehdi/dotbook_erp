...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('core.bd-divisions.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table division-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('core.bd-divisions.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label><b> {{ __('Division Namer') }}</b> <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Division Name') }}" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="bn_name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Division Name (Bangla)') }}" id="bn_name"
                                placeholder="{{ __('Division Name (Bangla)') }}" />
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.division-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('core.bd-divisions.index') }}",
                    "data": function(data) {
