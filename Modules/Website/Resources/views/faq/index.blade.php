...
@section('content')
    <div class="body-wraper">
        @if (auth()->user()->can('web_manage_faq') ||
                auth()->user()->can('web_add_faq') ||
                auth()->user()->can('web_edit_faq') ||
                auth()->user()->can('web_delete_faq'))
            <div class="main__content">
                <div class="sec-name">
                    <div class="name-head">
                        <h6>@lang('menu.faqs')</h6>
                    </div>
                    <x-all-buttons>
                        <x-add-button :can="'web_add_faq'" id="add_customer" />
                        <x-slot name="after">
                            <x-help-button />
                        </x-slot>
                    </x-all-buttons>
                                    ...
                                    <table class="display data_tbl data__table customerTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-start">@lang('menu.question')</th>
                                                <th class="text-start">@lang('menu.answer')</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add_customer').on('click', function(e) {
                e.preventDefault();
                $.get("{{ route('website.faq.create') }}", function(data) {
