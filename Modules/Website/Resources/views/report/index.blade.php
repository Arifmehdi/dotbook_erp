...
<div class="body-wraper">
    @if(auth()->user()->can('web_manage_report') || auth()->user()->can('web_add_report')
    || auth()->user()->can('web_edit_report') || auth()->user()->can('web_delete_report'))
    <div class="main__content">
        <div class="sec-name">
            <div class="name-head">
                <h6>@lang('menu.reports')</h6>
            </div>
            <div class="d-flex">
    ...
    @if(auth()->user()->can('web_manage_report') || auth()->user()->can('web_edit_report') || auth()->user()->can('web_delete_report'))
    <div class="p-15">
        <div class="card">
            <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.customerTable').DataTable({
            ...
            , ajax: "{{ route('website.report.index') }}"
            , columns: [{
                    data: 'action'
                    , name: 'action'
                }
        ...
        $('#add_customer').on('click', function(e) {
            e.preventDefault();
            $.get("{{ route('website.report.create') }}", function(data) {
