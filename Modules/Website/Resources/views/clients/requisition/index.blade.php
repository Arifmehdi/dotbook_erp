...
<div class="body-wraper">
    @if(auth()->user()->can('web_requisition_show') || auth()->user()->can('web_requisition_delete'))
    <div class="main__content">
        <div class="sec-name">
            <div class="name-head">
                <h6>@lang('menu.buyer_requisitions')</h6>
            </div>
            <div class="d-flex">
                        ...
                        <table class="display data_tbl data__table customerTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">@lang('menu.company')</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.customerTable').DataTable({
            ...
            , ajax: "{{ route('website.buyer-requisition.index') }}"
            , columns: [{
                    data: 'action'
                    , name: 'action'
                }
