...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.add_team') <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                    class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.teams.store') }}" method="POST"
                ...
                <div class="form-group row mt-1">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="phone"><b>Phone </b> <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
