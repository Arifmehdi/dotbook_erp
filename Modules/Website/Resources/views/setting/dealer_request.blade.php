...
<div class="body-wraper">
    @if(auth()->user()->can('dealership-request'))
                    ...
                    <table class="display data_tbl data__table customerTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-start">@lang('menu.shop_name')</th>
                                <th class="text-start">@lang('menu.contact_address')</th>
                                <th class="text-start">@lang('menu.nid')</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.customerTable').DataTable({
            ...
            , ajax: "{{ route('website.dealership.request') }}"
            , columns: [{
                    data: 'action'
                    , name: 'action'
                }
