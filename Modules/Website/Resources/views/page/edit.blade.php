...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.edit_page') <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                    class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.pages.update', $page->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="title" name="title" class="form-control"
                                    placeholder="Title" required value="{{ $page->title }}">
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="basic-url"
                                        aria-describedby="basic-addon3" value="{{ $page->slug }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" id="description" name="description" class="form-control ckEditor" placeholder="Description">{{ $page->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="position">
                                    ...
                                    <option @if ($page->position == 'top_header') selected @endif value="top_header">Top
                                        Header</option>
                                    <option @if ($page->position == 'menu_header') selected @endif value="menu_header">Menu
                                        Header</option>
                                    <option @if ($page->position == 'footer') selected @endif value="footer">Footer
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="status">
                                    ...
                                    <option @if ($page->status == 0) selected @endif value="0">In-Active
                                    </option>
                                </select>
                            </div>
                        </div>
