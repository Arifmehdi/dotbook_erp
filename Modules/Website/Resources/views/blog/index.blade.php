...
<div class="body-wraper">
    @if(auth()->user()->can('web_manage_blog') || auth()->user()->can('web_add_blog')
    || auth()->user()->can('web_edit_blog') || auth()->user()->can('web_delete_blog'))
    <div class="main__content">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-add-button :can="'web_add_blog'" id="add_customer" />
                <x-slot name="after">
                    <x-help-button />
                </x-slot>
            </x-all-buttons>
    ...
    @if(auth()->user()->can('web_manage_blog') || auth()->user()->can('web_edit_blog') || auth()->user()->can('web_delete_blog'))
    <div class="p-15">
...
<script>
    $(document).ready(function() {
        ...
        $('#add_customer').on('click', function(e) {
            e.preventDefault();
            $.get("{{ route('website.blog.create') }}", function(data) {
