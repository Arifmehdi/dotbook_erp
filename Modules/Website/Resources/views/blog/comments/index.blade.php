...
<div class="body-wraper">
    @if(auth()->user()->can('web_manage_comment') || auth()->user()->can('web_edit_comment')
    || auth()->user()->can('web_delete_comment'))
    <div class="main__content">
        <div class="sec-name">
            <div class="name-head">
                <h6>@lang('menu.comments')</h6>
            </div>
            <x-all-buttons>
                <x-slot name="after">
                    <x-help-button />
                        ...
                        <table class="display data_tbl data__table customerTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-start">@lang('menu.blog')</th>
                                    <th class="text-start">@lang('menu.website')</th>
...
<form id="status_form" action="" method="GET">
    @csrf
</form>
