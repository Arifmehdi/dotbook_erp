...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.edit_category') <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                    class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.categories.update', $category->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group row p-1">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control form-select" name="status">
                                ...
                                <option @if ($category->status == 0) selected @endif value="0">In-Active
                                </option>
                            </select>
                        </div>
                    </div>
