...
<div class="body-wraper">
    @if(auth()->user()->can('web_manage_product') || auth()->user()->can('web_add_product')
    || auth()->user()->can('web_edit_product') || auth()->user()->can('web_delete_product'))
    <div class="main__content">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-add-button id="add_customer" :can="'web_add_product'" />
                <x-slot name="after">
                    <x-help-button />
                </x-slot>
            </x-all-buttons>
    ...
    @if(auth()->user()->can('web_manage_product') || auth()->user()->can('web_edit_product') || auth()->user()->can('web_delete_product'))
    <div class="p-15">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('.customerTable').DataTable({
            ...
            , ajax: "{{ route('website.products.index') }}"
            , columns: [{
                    data: 'action'
                    , name: 'action'
                }
        ...
        $('#add_customer').on('click', function(e) {
            e.preventDefault();
            $.get("{{ route('website.products.create') }}", function(data) {
