...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.edit_product') <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                    class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.products.update', $product->id) }}"
                ...
                <div class="form-group row mt-1">
                    <div class="col-lg-12">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="category_id">
                                    ...
                                    @foreach ($categories as $categories)
                                        <option @if ($product->category_id == $categories->id) selected @endif
                        ...
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" id="description" name="description" class="form-control ckEditor" placeholder="Description">{{ $product->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="status">
                                    ...
                                    <option @if ($product->status == 0) selected @endif value="0">In-Active
                                    </option>
                                </select>
                            </div>
                        </div>
