...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title" id="exampleModalLabel">@lang('menu.edit_video') <span class="type_name"></span></h6>
            <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                    class="fas fa-times"></span></a>
        </div>
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.video.update', $video->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                <div class="form-group row mt-1">
                    <div class="form-group row p-1">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="title" name="title" placeholder="Link"
                                value="{{ $video->title }}" required>
                        </div>
                    </div>
                    <div class="form-group row p-1">
                        <label class="col-sm-3" for="link"><b>Link</b> <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row p-1">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" class="form-control ckEditor" id="description" name="description" placeholder="Description">{{ $video->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row p-1">
                        ...
                        <div class="col-sm-9">
                            ...
                            <img src="{{ asset($video->thumbnail) }} " id="one"
                                class="preview-image @if ($video->thumbnail == null) d-none @endif"
                    ...
                    <div class="form-group row p-1">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control form-select" name="status" id="status">
                                ...
                                <option @if ($video->status == 0) selected @endif value="0">In-Active
                                </option>
                            </select>
                        </div>
                    </div>
