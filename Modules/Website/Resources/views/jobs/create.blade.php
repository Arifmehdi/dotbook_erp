...
<div class="modal-dialog col-60-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="submit_customer_basic_form" action="{{ route('website.jobs.store') }}" method="POST"
                    ...
                    <div class="col-lg-12">
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="job_type" id="job_type" required>
                                    ...
                                    <option value="projectbase">Project Base</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                        ...
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="location"><b>Location </b> <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <textarea type="text" id="location" name="location" class="form-control ckEditor" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                        ...
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="website"><b>Website </b></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="city"><b>City </b> <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="salary_type"><b>Salary Type </b> <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <select class="form-control form-select" name="salary_type" id="salary_type">
                                    <option value="fixes">Fixed</option>
                                    <option value="negotible">Negotible</option>
                                    <option value="oncall">On Call</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="salary"><b>Salary </b></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <input type="date" id="deadline" class="form-control"
                                    value="{{ old('deadline') }}" name="deadline" placeholder="Enter Deadline"
                                    required>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                        ...
                        <div class="form-group row p-1">
                            ...
                            <div class="col-sm-9">
                                <textarea required type="text" id="responsibility" name="responsibility" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="facilities"><b>Facilities</b></label>
                            <div class="col-sm-9">
                                <textarea required type="text" id="facilities" name="facilities" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="education"><b>Education</b></label>
                            <div class="col-sm-9">
                                <textarea required type="text" id="education" name="education" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="skill"><b>Skills</b></label>
                            <div class="col-sm-9">
                                <textarea required type="text" id="skill" name="skill" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="experience"><b>Experience</b></label>
                            <div class="col-sm-9">
                                <textarea required type="text" id="experience" name="experience" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                        <div class="form-group row p-1">
                            <label class="col-sm-3" for="description"><b>Description</b></label>
                            <div class="col-sm-9">
                                <textarea required type="text" id="description" name="description" class="form-control ckEditor"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
