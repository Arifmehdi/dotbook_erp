                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive h-350" id="data-list">
                                <table class="display data_tbl data__table lifeStageTable">
                                    <thead>
                                        <tr>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Add Life Stage</h6>
                    <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></a>
                </div>
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_life_stage_form" action="{{ route('crm.life.stage.store') }}">
                        @csrf
                        <div class="form-group">
                            ...
                            <input required type="text" name="name" class="form-control add_input"
                                data-name="Life Stage" id="name" placeholder="Life Stage" />
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                var table = $('.lifeStageTable').DataTable({
                    processing: true,
                    dom: "lBfrtip",
                    buttons: [{
                        extend: 'pdf',
                    ...
                    ajax: "{{ route('crm.life.stage.index') }}",
                    columns: [{
                        data: 'action',
                        name: 'action'
                    }, {
                ...
                $('#add_life_stage_form').on('submit', function(e) {
                    e.preventDefault();
