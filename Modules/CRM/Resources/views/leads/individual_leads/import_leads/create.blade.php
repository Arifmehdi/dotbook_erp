...
@section('content')
    <div class="body-wraper">
        <div class="container-fluid p-0">
            <form id="add_user_form" action="{{ route('crm.individual-leads.import.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <section class="mt-5x">
                    <div class="row g-0">
                                            ...
                                            <div class="row mt-1">
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="col-8">
                                                            <a href="{{ asset('import_template/individual_leads_import_template.xlsx') }}" class="btn btn-sm btn-success" download>@lang('menu.download_template_click')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-sm modal-table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-start">Companies</td>
