...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('crm.individual-leads.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card m-0">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table individual_leads_table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
        ...
        <div class="modal-dialog four-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Add Individual Leads</h6>
                    <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></a>
                </div>
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('crm.individual-leads.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row mt-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="companies" class="form-control" id="companies"
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            var allRow = '';
            var trashedRow = '';
            var table = $('.individual_leads_table').DataTable({
                dom: "lBfrtip",
                buttons: [{
                    extend: 'pdf',
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('crm.individual-leads.index') }}",
                    "data": function(data) {
                ...
                columns: [{
                    ...
                    name: 'name',
                    data: 'name'
                    // , "class": "btn btn-status_color" // or "className" : "class001" - the same result
        ...
        $(document).on('click', '#trashed_item', function(e) {
            ...
            $('.individual_leads_table').DataTable().draw(false);
            $('#is_check_all').prop('checked', false);
