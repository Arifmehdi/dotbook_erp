...
<div class="row p-1">
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Name : {{ $businessLeads->name }}</h6>
                <p class="card-title">Location : {{ $businessLeads->location }}</p>
                <p class="card-text">Description : {{ $businessLeads->description }}</p>
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Email : {{ $businessLeads->email_addresses }}</h6>
                <p class="card-title">Phone : {{ $businessLeads->phone_numbers }}</p>
                <p class="card-text">Additional Information : {{ $businessLeads->additional_information }}</p>
    ...
    <div class="form-group row mt-1">
        ...
        <div class="col-md-6">
            ...
            <input required type="text" name="title" class="form-control" id="title" value=""
                placeholder="Title" />
            <input type="hidden" name="business_id" id="business_id" value="{{ $businessLeads->id }}" />
    ...
    {{-- @isset($files_array)
        <div class="uploaded-image-preview">
            @foreach ($files_array as $file)
                <div class="single-img-box"><a href="#" class="img-close deleteAdditionalFile" data-url="{{ route('crm.individual-leads.additional-file.delete', [$businessLeads->id, $file]) }}"><i class="fas fa-times"></i></a><img src="{{ asset('uploads/leads/individual_leads/'. $file) }}" id="" alt=""></div>
    @endforeach
    </div>
    @endisset --}}
