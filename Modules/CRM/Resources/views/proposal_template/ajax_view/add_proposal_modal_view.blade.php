...
<form id="add_product_form" action="{{ route('purchases.add.product') }}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-3">
            ...
            <select class="form-control form-select" name="barcode_type" id="barcode_type">
        ...
        <div class="col-md-3 ">
            ...
            <select class="form-control product_unit form-select" name="unit_id" id="add_unit_id">
    ...
    <div class="form-group row mt-1">
        @if (json_decode($generalSettings->product, true)['is_enable_categories'] == '1')
            <div class="col-md-3">
                ...
                <select class="form-control category form-select" name="category_id" id="add_category_id">
        ...
        @if (json_decode($generalSettings->product, true)['is_enable_categories'] == '1' &&
            ...
            <div class="col-md-3 parent_category">
                ...
                <select class="form-control form-select" name="child_category_id" id="add_child_category_id">
        ...
        @if (json_decode($generalSettings->product, true)['is_enable_brands'] == '1')
            <div class="col-md-3">
                ...
                <select class="form-control form-select" data-live-search="true" name="brand_id" id="add_brand_id">
        ...
        @if (json_decode($generalSettings->product, true)['is_enable_warranty'] == '1')
            <div class="col-md-3">
                ...
                <select class="form-control form-select" name="warranty_id" id="add_warranty_id">
                    <option value="">@lang('menu.select_warranty')</option>
                    @foreach ($warranties as $warranty)
                        <option value="{{ $warranty->id }}">{{ $warranty->name }}
                            ({{ $warranty->type == 1 ? 'Warranty' : 'Guaranty' }})
                        </option>
                    @endforeach
                </select>
            </div>
    ...
    <div class="form-group row mt-1">
        <div class="col-md-8">
            ...
            <textarea name="product_details" class="form-control ckEditor" cols="10" rows="3">
            </textarea>
        </div>

        <div class="col-md-4">
            <div class="row mt-5">
                <p class="checkbox_input_wrap p-0 m-0"> <input type="checkbox" name="is_show_in_ecom"
                        id="is_show_in_ecom" value="1"> &nbsp; @lang('menu.product_displayed_ecommerce') &nbsp; </p>
                <p class="checkbox_input_wrap p-0 m-0"> <input type="checkbox" name="is_show_emi_on_pos"
                        id="is_show_emi_on_pos" value="1"> &nbsp; @lang('menu.enable_imei_or_serial') &nbsp;</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-group row mt-1">
        @if (json_decode($generalSettings->product, true)['is_enable_price_tax'] == '1')
            <div class="col-md-3 ">
                ...
                <select class="form-control form-select" name="tax_id" id="add_tax_id">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="alert_quantity" class="form-control" autocomplete="off" id="add_alert_quantity"
                value="0">
        </div>
    </div>
                    ...
                    <tr>
                        <td>
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <label><b>@lang('menu.unit_cost') Exc.Tax </b> <span
                                            class="text-danger">*</span></label>
                                    <input type="number" step="any" name="product_cost" id="add_product_cost"
                                        class="form-control" autocomplete="off" placeholder="Unit Cost Exc.Tax">
                                ...
                                <div class="col-md-6 text-start">
                                    ...
                                    <input type="number" step="any" name="product_cost_with_tax"
                                        class="form-control" autocomplete="off" id="add_product_cost_with_tax"
                                        placeholder="@lang('menu.unit_cost_inc_tax')">
                        ...
                        <td>
                            ...
                            <input type="number" step="any" name="profit" class="form-control"
                                autocomplete="off" id="add_profit"
    ...
    $('#add_product_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var url = "{{ route('purchases.get.recent.product', ':product_id') }}";
        ...
        $.ajax({
            ...
            success: function(subcate) {
                ...
                $.each(subcate, function(key, val) {
                    ...
                    $('#add_child_category_id').append('<option value="' + val.id + '">' +
                        val.name + '</option>');
                });
            }
        });
