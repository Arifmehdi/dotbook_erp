                    ...
                    <div class="card m-0">
                        <div class="card-body">
                            ...
                            <div class="table-responsive h-350" id="data-list">
                                <table class="display data_tbl data__table sourceTable">
                                    <thead>
                                        <tr>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Add Source</h6>
                    <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></a>
                </div>
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_source_form" action="{{ route('crm.source.store') }}">
                        @csrf
                        <div class="form-group">
                            ...
                            <input required type="text" name="name" class="form-control add_input" data-name="Sources"
                                id="source" placeholder="@lang('menu.source')" />
