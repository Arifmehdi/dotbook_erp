...
<div class="modal-dialog col-80-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form id="submit_customer_detailed_form" action="{{ route('crm.customers.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" name="opening_balance"
                                                ...
                                                value="0">
                                            <select name="balance_type" class="form-control big_balance_type"
                                                id="balance_type">
                                ...
                                <div class="form-group row p-1 big_modal_term_hide d-none">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="pay_term" class="form-control big_pay_term form-select"
                                            id="customer-type">
