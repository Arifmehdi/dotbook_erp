...
<div class="modal-dialog col-80-modal" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body" id="edit-modal-form-body">
            <form id="edit_customer_form" action="{{ route('crm.customer.update', $customer->id) }}" method="post"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <input type="number" name="opening_balance" class="form-control"
                                                id="opening_balance"
                                                value="{{ $userOpeningBalance ? $userOpeningBalance->amount : 0 }}">
                                            <select class="form-control form-select" name="balance_type"
                                                id="balance_type">
                                                <option
                                                    {{ $userOpeningBalance?->balance_type == 'debit' ? 'SELECTED' : '' }}
                                                    value="debit">@lang('menu.debit')</option>
                                                <option
                                                    {{ $userOpeningBalance?->balance_type == 'credit' ? 'SELECTED' : '' }}
                                ...
                                <div class="form-group row p-1">
                                    ...
                                    <div class="col-sm-3">
                                        <select class=" form-control form-select" name="customer_type"
                                            id="customer_type">
                                            <option value="1"
                                                {{ $customerCreditLimit?->customer_type == 1 ? 'SELECTED' : '' }}>
                                                @lang('menu.non_credit')</option>
                                            <option value="2"
                                                {{ $customerCreditLimit?->customer_type == 2 ? 'SELECTED' : '' }}>
                                                @lang('menu.credit')</option>
                                        </select>
                                    </div>

                                    <label
                                        class="col-sm-2 term_hide {{ $customerCreditLimit?->customer_type == 1 ? 'd-none' : '' }}"><b>Credit
                                            Limit :</b></label>
                                    <div
                                        class="col-sm-3 term_hide {{ $customerCreditLimit?->customer_type == 1 ? 'd-none' : '' }}">
                                        <input type="number" name="credit_limit" class="form-control"
                                            id="credit_limit"
                                            value="{{ $customerCreditLimit?->credit_limit ? $customerCreditLimit?->credit_limit : 0 }}">
                                    </div>
                                </div>

                                <div
                                    class="form-group row p-1 term_hide {{ $customerCreditLimit?->customer_type == 1 ? 'd-none' : '' }}">
                                    <label class="col-sm-4"><b>Term :</b></label>
                                    <div class="col-sm-3">
                                        <select class="form-control form-select" name="pay_term" id="customer-type">
                                            <option value="" selected>Term</option>
                                            <option
                                                value="2"{{ $customerCreditLimit?->pay_term == 2 ? 'SELECTED' : '' }}>
                                                Days</option>
                                            <option value="1"
                                                {{ $customerCreditLimit?->pay_term == 1 ? 'SELECTED' : '' }}>Months
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="pay_term_number" class="form-control"
                                            placeholder="Number"
                                            value="{{ $customerCreditLimit?->pay_term_number }}">
                                    </div>
                                </div>
                            </div>
                        </div>
