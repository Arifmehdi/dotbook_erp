<div class="modal-content">
    <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Edit Followup Category</h6>
        <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times"></span></a>
    </div>
    <div class="modal-body">
        <!--begin::Form-->
        <form id="edit_followup_category_form"
            action="{{ route('crm.followup.category.update', $followup_category->id) }}">
            @csrf
            <div class="form-group">
                ...
                <input required type="text" name="name" class="form-control add_input" data-name="Name"
                    id="name" value="{{ $followup_category->name }}" placeholder="Life Stage Name" />
            ...
            <div class="form-group mt-1">
                ...
                <textarea name="description" class="form-control form-control-sm ckEditor" id="description" cols="10"
                    rows="5" placeholder="@lang('menu.description')">{{ $followup_category->description }}</textarea>
            </div>
...
<script>
    $(document).ready(function() {
        $('#edit_followup_category_form').on('submit', function(e) {
            e.preventDefault();
            $('.loading_button').show();
