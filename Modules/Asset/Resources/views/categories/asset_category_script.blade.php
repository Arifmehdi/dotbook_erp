<script>
    var table = $('.categoryTable').DataTable({
        ...
        , ajax: "{{ route('assets.categories.index') }}"
        , columns: [{
                data: 'DT_RowIndex'
                , name: 'DT_RowIndex'
            }
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#edit_category', function(e) {
            ...
            $.ajax({
                ...
                , type: 'get'
                , success: function(data) {
                    $('#edit_category_form_body').html(data);
                    $('#add_category_form_div').hide();
        ...
        $(document).on('click', '#update_category_btn', function(e) {
            e.preventDefault();
            var url = $(this).attr('href');
            $('#category_deleted_form').attr('action', url);
            $.confirm({
        ...
        //data delete by ajax
        $(document).on('submit', '#category_deleted_form', function(e) {
            e.preventDefault();
            var url = $(this).attr('action');
        ...
        $(document).on('click', '#category_close_form', function() {
            $('#add_category_form_div').show();
            $('#edit_category_form').hide();
        });
