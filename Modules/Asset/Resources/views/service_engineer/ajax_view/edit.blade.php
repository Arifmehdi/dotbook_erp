<div class="modal-content">
    <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel">Edit Services Engineer</h6>
        <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                class="fas fa-times"></span></a>
    </div>
    <div class="modal-body">
        <!--begin::Form-->
        <form id="edit_supplier_form" action="{{ route('assets.services.engineer.update', $asset_service_engineer->id) }}" method="POST"
            ...
            <div class="form-group row mt-1">
                <div class="col-md-3">
                    ...
                    <input type="text" required name="supplier_code" class="form-control add_input"
                        data-name="Supplier Code" id="supplier_code" placeholder="@lang('menu.name')" value="{{ $asset_service_engineer->code }}" disabled/>
                </div>
                <div class="col-md-3">
                    <label><strong>@lang('menu.name') </strong> <span class="text-danger">*</span></label>
                    <input type="text" required name="name" class="form-control add_input"
                        data-name="Name" id="name" placeholder="@lang('menu.name')" value="{{ $asset_service_engineer->name }}"/>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" required name="phone" class="form-control add_input"
                        data-name="Phone" id="phone" placeholder="Phone" value="{{ $asset_service_engineer->phone }}"/>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="alternative_phone" class="form-control add_input"
                        data-name="Alternative Phone" id="alternative_phone" placeholder="Alternative Phone" value="{{ $asset_service_engineer->alternative_phone }}"/>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" required name="email" class="form-control add_input"
                        data-name="Email" id="email" placeholder="Email" value="{{ $asset_service_engineer->email }}"/>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="address" class="form-control add_input"
                        data-name="Address" id="address" placeholder="Address" value="{{ $asset_service_engineer->address }}"/>
                ...
                <div class="col-md-3">
                    <div class="row mt-4">
                        <p class="checkbox_input_wrap">
                            <input type="checkbox" name="status" id="status" @if ($asset_service_engineer->status == 1) checked @endif> &nbsp;
