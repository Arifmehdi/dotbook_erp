...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :can="'hrm_payments_types_create'" />
                </x-slot>
            </x-all-buttons>
        </div>
                                    ...
                                    <table class="display data_tbl data__table leave-type-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-start">{{ __('Type Name') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.payment-types.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row mt-1">
                            <div class="col-xl-12 col-md-12">
                                <label><strong> {{ __('Payment Type Name') }}</strong> <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control"
                                    data-name="{{ __('Payment Type Name') }}" id="name"
                                    placeholder="{{ __('Payment Type Name') }}" />
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.leave-type-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('hrm.payment-types.index') }}",
                    "data": function(data) {
