...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :href="route('hrm.designations.create')" :can="'hrm_designations_create'" />
                </x-slot>
            </x-all-buttons>
        </div>

        <form id="bulk_action_form" action="{{ route('hrm.designations.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="card">
                    <div class="card-body">
                                ...
                                <table class="display data_tbl data__table designation-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-start">{{ __('Designation Name') }}</th>
                                            <th class="text-start">{{ __('Give Report To') }}</th>
