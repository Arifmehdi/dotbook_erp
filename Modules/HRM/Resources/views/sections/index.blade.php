...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons :can="'hrm_sections_create'">
                <x-slot name="before">
                    <x-add-button />
                </x-slot>
            </x-all-buttons>
        ...
        <form id="bulk_action_form" action="{{ route('hrm.sections.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive h-350" id="data-list">
                            <table class="display data_tbl data__table section-table">
                                <thead>
                                    <tr>
                                        <th class="text-start">
                                            <div>
                                        ...
                                        <th class="text-start">{{ __('Department Name') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.sections.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-xl-12 col-md-12">
                            <label> {{ __('Department') }} <span class="text-danger">*</span></label>
                            <select name="hrm_department_id" required class="form-control submit_able form-select"
                                id="hrm_department_id" autofocus="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Section Name') }}" id="name" placeholder="{{ __('Section Name') }}"
                                required />
