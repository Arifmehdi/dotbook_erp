...
@section('content')
    ...
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('hrm.departments.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="bulk_action">
                            <div class="table-responsive h-350" id="data-list">
                                <table class="display data_tbl data__table department-table">
                                    <thead>
                                        <tr>
                                            <th class="text-start">
                                                <div>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.departments.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Department Name') }}" id="name"
