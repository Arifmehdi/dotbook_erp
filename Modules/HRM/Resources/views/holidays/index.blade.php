...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :can="'hrm_holidays_create'" />
                </x-slot>
            </x-all-buttons>
        </div>

        <form id="bulk_action_form" action="{{ route('hrm.holidays.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="row mt-1">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="bulk_action">
                                    <div class="table-responsive h-350" id="data-list">
                                        <table class="display data_tbl data__table holiday-table">
                                            <thead>
                                                <tr>
                                                    <th class="text-start">
                                                        <div>
                                                    ...
                                                    <th class="text-start">{{ __('Holiday Name') }}</th>
                                                    <th class="text-start">{{ __('From') }}</th>
                                                    <th class="text-start">{{ __('To') }}</th>
                                                    <th class="text-start">{{ __('Num of Days') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.holidays.store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="form-group col-xl-6 col-md-6">
                                ...
                                <input type="text" name="name" class="form-control form-control-sm add_input"
                                    data-name="{{ __('Holiday Name') }}" id="name"
                                    placeholder="{{ __('Holiday Name') }}" required />
                                <span class="error error_name"></span>
                            </div>
                            <div class="col-xl-6 col-md-6">
                                <label> {{ __('Holiday Type') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-6 col-md-6">
                                ...
                                <input type="date" name="to" class="form-control form-control-sm add_input enddate"
                        ...
                        <div class="form-group col-xl-6 col-md-6">
                            ...
                            <input type="number" name="num_of_days"
                                class="form-control form-control-sm add_input num_of_days"
                                data-name="{{ __('Num of Days') }}" id="num_of_days" placeholder="{{ __('Num of Days') }}"
                                required readonly />
