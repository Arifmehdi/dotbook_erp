...
@section('content')
    <div class="body-wraper">
        <div class="sec-name">
            ...
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :can="'hrm_shifts_create'" />
                </x-slot>
            </x-all-buttons>
        </div>

        <form id="bulk_action_form" action="{{ route('hrm.shifts.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="card">
                    <div class="card-body">
                                ...
                                <table class="display data_tbl data__table department-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-start">{{ __('Allow Overtime') }}</th>
        ...
        <div class="modal-dialog four-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.shifts.store') }}" method="POST"
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-xl-3 col-md-6">
                                ...
                                <input type="text" name="name" class="form-control"
                                    data-name="{{ __('Shift Name') }}" id="name" placeholder="{{ __('Shift Name') }}"
                                    required />
                                <span class="error error_name"></span>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    <label><strong>{{ __('Start Time') }}</strong> <span
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="late_count" class="form-control add_input"
                                        data-name="Late Count" id="late_count" placeholder="Late Count" />
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="time" name="end_time" class="form-control add_input"
                                        data-name="End Time" id="end_time" placeholder="End Time" />
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="row mt-4">
                                    <p class="checkbox_input_wrap">
                                        <input type="checkbox" name="is_allowed_overtime" id="is_allowed_overtime" checked>
                                        &nbsp;
                                        <label id="overtime-checkbox"
                                            for="is_allowed_overtime">{{ __('Allow Overtime') }}</label>
                                    </p>
                                </div>
                            </div>
                            <div>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.department-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        name: 'is_allowed_overtime',
                        data: 'is_allowed_overtime'
                    },
                    {
                        name: 'action',
                        data: 'action'
        ...
        if ($('#is_allowed_overtime').is(':checked')) {
            $('#is_allowed_overtime').val(1);
        } else {
            $('#is_allowed_overtime').val(0);
        }

        $(document).on('change', '#is_allowed_overtime', function() {
            if ($(this).is(':checked')) {
                $('#is_allowed_overtime').val(1);
            } else {
                $('#is_allowed_overtime').val(0);
