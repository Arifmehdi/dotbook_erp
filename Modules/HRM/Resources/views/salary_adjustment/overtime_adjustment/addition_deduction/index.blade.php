...
@section('title', 'Over Time Adjust - Add / Deduct - ')
@push('css')
    ...
    <div class="body-wraper">
        <div class="sec-name">
            <div class="employee-header">
                <h6>{{ __('Over Time Adjust - Add / Deduct') }}</h6>
            </div>
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :href="route('hrm.overtimeAdjustments.create')" :can="'hrm_employees_create'" />
                </x-slot>
            </x-all-buttons>
        </div>
        <div class="p-15">
            ...
            <form id="bulk_action_form" action="{{ route('hrm.overtimeAdjustments.bulk-action') }}" method="POST">
                <div class="row mt-1">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">
                        {{ __('Create Over Time Adjustment') }}
                    </h6>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.employee-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('hrm.overtimeAdjustments.index') }}",
                    "data": function(data) {
                        //filter options
