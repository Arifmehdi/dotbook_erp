<form id="add_form" action="{{ route('hrm.salaryAdjustments.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="form-group col-xl-6 col-md-6">
            ...
            <input type="number" name="amount" class="form-control form-control-sm add_input" id="amount"
    ...
    <div class="row">
        <div class="form-group col-xl-12 col-md-12">
            ...
            <textarea name="" id="" cols="30" rows="3" name="month"
                class="form-control form-control-sm add_input ckEditor" id="description" placeholder="{{ __('Description') }}"></textarea>
