    ...
    <div class="body-wraper">
        <div class="sec-name">
            <div class="employee-header">
                <h6>{{ __('Salary Advance') }}</h6>
            </div>
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :href="route('hrm.salary-advances.create')" :can="'hrm_salary_advances_create'" />
                </x-slot>
            </x-all-buttons>
        </div>
        ...
        <div class="p-15">
                                    ...
                                    <form id="filter_form">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xl-3 col-md-4">
                                                <label><strong>{{ __('Employee Name - ID') }} </strong></label>
                                            ...
                                            <div class="col-xl-2 col-md-4">
                                                <label><strong>{{ __('Deduction Month') }}</strong></label>
                                            ...
                                            <div class="col-xl-2 col-md-4">
                                                <label><strong>{{ __('Deduction Year') }}</strong></label>
                                            ...
                                            <div class="col-xl-2 col-md-4">
                                                <label><strong>{{ __('Permitted By') }}</strong></label>
                                                <select name="permitted_by" class="form-control submitable form-select"
                                                    id="permitted_by">
                                                    <option value="">@lang('menu.all')</option>
            ...
            <form id="bulk_action_form" action="{{ route('hrm.salary-advances.bulk-action') }}" method="POST">
                <div class="row mt-1">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <table class="display data_tbl data__table employee-table">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th>{{ __('Deduct Month') }}</th>
                                                    <th>{{ __('Deduct Year') }}</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">
                        {{ __('Create Salary Advance Adjustment') }}
                    </h6>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">
                        {{ __('Edit Salary Advance Adjustment') }}
                    </h6>
                    <a href="#" class="close-btn" data-bs-dismiss="modal" aria-label="Close"><span
                            class="fas fa-times"></span></a>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.employee-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('hrm.salary-advances.index') }}",
                    "data": function(data) {
                        //filter options
                        ...
                        data.permitted_by = $('#permitted_by').val();
                ...
                columns: [{
                    ...
                    // employee_id`, `permitted_by`, `date`, `amount`, `month`, `year`, `detail
                ],
                "lengthMenu": [
                    [10, 25, 50, 100, 500, 1000, -1],
                    [10, 25, 50, 100, 500, 1000, "All"]
