                            ...
                            <div class="col-md-12">
                                <form id="filter_form">
                                    <div class="form-group row align-items-end g-2">
                                        ...
                                        <div class="col-xl-3 col-md-3 mr-0 d-flex">
                                            <div class="loading-btn-box">
                                                <a href="#" class="btn btn-sm btn-info " name="jobPrint"
                                                    id="jobPrint">{{ __('Single Job Card') }}</a>
                                                <a href="#" class="btn btn-sm btn-info" name="summeryprint"
                                                    id="summeryprint">{{ __('Card Summary') }}</a>
                                                <button type="btn"
                                                    class="btn btn-sm summery_button loading_button display-none"><i
