            ...
            <div class="col-md-12 p-15 pb-0">
                <div class="form_element m-0 rounded">
                    <div class="element-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="{{ route('hrm.final_settlement.paper') }}" method="POST" target="_blank">
                                    @csrf
                                    <div class="form-group row align-items-end g-2">
                                        ...
                                        <div class="col-md-2">
                                            <label><strong>{{ __('Resign Submission Date') }} </strong></label>
                                            <input type="date" class="form-control" name="submission_date"
                                                value="{{ date('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label><strong>{{ __('Resign Approval Date') }} </strong></label>
                                            <input type="date" class="form-control" name="approval_date"
                                                value="{{ date('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="stamp"><strong>{{ __('Stamp Fee') }} </strong></label>
                                            <select class="form-control selectpicker" name="stamp" id="stamp"
                                                required>
                                        ...
                                        <div class="col-md-2 d-flex justify-content-center align-items-center">
                                            <input type="submit" class="btn btn-sm btn-primary" value="Get Settlement Paper">
                                        </div>
                                    </div>
                                </form>
                            </div>
