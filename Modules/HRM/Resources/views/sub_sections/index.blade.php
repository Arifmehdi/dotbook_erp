    ...
    <div class="body-wraper">
        <div class="sec-name">
            <div class="sub-section-header">
                <h6>{{ __('Sub Section') }}</h6>
            </div>
            <x-all-buttons>
                <x-slot name="before">
                    <x-add-button :can="'hrm_sub_sections_create'" />
                </x-slot>
            </x-all-buttons>
        </div>

        <form id="bulk_action_form" action="{{ route('hrm.subsections.bulk-action') }}" method="POST">
            <div class="p-15">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive h-350" id="data-list">
                            <table class="display data_tbl data__table sub-section-table">
                                <thead>
                                    <tr>
                                        <th class="text-start">
                                            <div>
                                        ...
                                        <th class="text-start">{{ __('Sub Section Name') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.subsections.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="col-xl-12 col-md-12">
                            <label> {{ __('Section') }} <span class="text-danger">*</span></label>
                            <select name="section_id" required class="form-control submit_able form-select" id="section_id"
                                autofocus="">
                        ...
                        <div class="form-group">
                            <label>{{ __('Sub Section Name') }} <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="form-control form-control-sm add_input"
                                data-name="{{ __('Sub Section Name') }}" id="name"
                                placeholder="{{ __('Sub Section Name') }}" required />
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            var allRow = '';
            var trashedRow = '';
            var table = $('.sub-section-table').DataTable({
                dom: "lBfrtip",
                buttons: [{
                        extend: 'pdf',
