...
@section('content')
    ...
    <form id="bulk_action_form" action="{{ route('hrm.interview_bulk_action') }}" method="POST">
        <div class="p-15">
            <div class="row">
                <div class="col-12">
                    <div class="card">
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.interview_store') }}" method="POST"
