...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('hrm.schedule_bulk_action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                                    ...
                                    <table class="display data_tbl data__table leave-type-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-start">{{ __('Interview Title') }}</th>
                                                <th class="text-start">{{ __('Interviewers') }}</th>
                                                <th class="text-start">{{ __('Interviewees') }}</th>
                                                <th class="text-start">{{ __('Description') }}</th>
                                                <th class="text-start">{{ __('Interview Date Time') }}</th>
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.schedule_store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row mt-1">
                            <div class="col-xl-6 col-md-12">
                                <label><strong> {{ __('Interview Title') }}</strong> <span
                                ...
                                <select name="interview_id" required class="form-control submit_able form-select" id="interview_id"
                                    ...
                                    @foreach ($interviewTitles as $interviewTitle)
                                        <option value="{{ $interviewTitle->id }}">{{ $interviewTitle->title }}</option>
                                    @endforeach
                                </select>
                                <span class="error error_interview_id"></span>
                            </div>
                            <div class="col-xl-6 col-md-12">
                                <label><strong> {{ __('Interviewers') }}</strong> <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="interviewers" class="form-control"
                                    data-name="{{ __('Interviewers Name') }}" id="interviewers"
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-xl-6 col-md-12">
                                <label><strong> {{ __('Interviewees') }}</strong> <span
                                        class="text-danger">*</span></label>
                                <select name="applicant_id" required class="form-control submit_able form-select" id="applicant_id"
                                    ...
                                    @foreach ($selectedForInterviees as $selectedForInterview)
                                        <option value="{{ $selectedForInterview->id }}">
                                            {{ $selectedForInterview->fullName }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-xl-6 col-md-12">
                                ...
                                <input type="datetime-local" name="date_time" class="form-control"
                                    data-name="{{ __('Interviewees Name') }}" id="date_time"
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-xl-12 col-md-12">
                                <label><strong> {{ __('Email Template') }}</strong> <span
                                        class="text-danger">*</span></label>
                                <select name="email_template_id" required class="form-control submit_able form-select"
