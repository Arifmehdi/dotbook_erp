...
@section('content')
    <div class="body-wraper">
        @canany(['web_job_applied_download', 'web_job_applied_delete'])
            <div class="main__content">
                <div class="sec-name">
                    <div class="name-head">
                        <h6>@lang(__('Applicants Offer Letter List'))</h6>
                    </div>
                    <x-all-buttons>
                        <x-slot name="after">
                            <x-help-button />
            ...
            <div class="p-15">
                ...
                <form id="bulk_action_form" action="{{ route('hrm.applicant_bulk_hired') }}" method="POST">
                    @csrf
    ...
    @else
        <div class="bd-callout bd-callout-info">
            <code>Warning!!</code> You do not have permission to access please contact with
            administrator.
        </div>
    @endcanany
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.selectedForInterviewTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hrm.applicant_offer_letter_list') }}",
                    "data": function(data) {
                        //filter options
                ...
                initComplete: function() {
                        ...
                        <div class="form-group row align-items-end g-2">
                            <div class="col-8" >
                                <select name="action_type" id="bulk_action_field" class="form-control submit_able form-select" required>
                                    ...
                                    <option value="select_bulk_hired" id="select_bulk_hired">Bulk Hired</option>
                    ...
                    $("#select_bulk_hired").css('display', 'block');
                    $('#all_item').text('All (' + allRow + ')');
                    $('#is_check_all').prop('checked', false);
                    $('#selected_for_interview_item').text('');
                    $('#selected_for_interview_item_separator').text('');
            ...
            $(document).on('click', '#selected_for_interview_item', function(e) {
                ...
                $("#select_bulk_hired").css('display', 'none');
            })
