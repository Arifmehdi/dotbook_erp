    ...
    <div class="body-wraper">
        @canany(['web_job_applied_download', 'web_job_applied_delete'])
            <div class="main__content">
                <div class="sec-name">
                    <div class="name-head">
                        <h6>@lang(__('Applicants Interview Pariticipate'))</h6>
                    </div>
                    <x-all-buttons>
                        <x-slot name="after">
            ...
            <form id="bulk_action_form" action="{{ route('hrm.applicant_final_selected_bulk-action') }}" method="POST">
                @csrf
                <div class="p-15 pt-0">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.selectedForInterviewTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hrm.interview_participate_list') }}",
                    "data": function(data) {
                        //filter options
                        ...
                        <div class="form-group row align-items-end g-2">
                            <div class="col-8" >
                                <select name="action_type" id="bulk_action_field" class="form-control submit_able form-select" required>
                                    ...
                                    <option value="bulk_select_for_interview" id="bulk_select_for_interview">Bulk For Final Select </option>
