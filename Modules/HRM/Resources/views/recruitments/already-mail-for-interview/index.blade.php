    ...
    <div class="body-wraper">
        @canany(['web_job_applied_download', 'web_job_applied_delete'])
            <div class="main__content">
                <div class="sec-name">
                    <div class="name-head">
                        <h6>@lang(__('Applicants Already Mailed For Interview'))</h6>
                    </div>
                    <x-all-buttons>
                        <x-slot name="after">
            ...
            <div class="row g-0">
                <div class="col-md-12 p-15 pb-0">
                    <div class="form_element m-0 rounded">
                        ...
                        <form id="bulk_action_form"
                            action="{{ route('hrm.applicant_move_to_participate_interview_bulk-action') }}" method="POST">
                            @csrf
                            <div class="p-15">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.selectedForInterviewTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hrm.already_mail_for_interview_list') }}",
                    "data": function(data) {
                        //filter options
                                    ...
                                    <div class="form-group row align-items-end g-2">
                                        <div class="col-8" >
                                            <select name="action_type" id="bulk_action_field" class="form-control submit_able form-select" required>
                                                ...
                                                <option value="bulk_select_for_interview" id="bulk_select_for_interview">Bulk Select Interview Participant</option>
