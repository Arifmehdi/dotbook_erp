    ...
    <div class="body-wraper">
        @canany(['web_job_applied_download', 'web_job_applied_delete'])
            <div class="main__content">
                <div class="sec-name">
                    <div class="name-head">
                        <h6>@lang(__('Applicants Final Selected'))</h6>
                    </div>
                    <x-all-buttons>
                        <x-slot name="after">
                                                    ...
                                                    <select name="job_category_id" class="form-control submitable"
                                                        ...
                                                        @foreach ($jobCategories as $jobCategory)
                                                            <option value="{{ $jobCategory->id }}">
                                                                {{ $jobCategory->jobCategory_id }} -{{ $jobCategory->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.selectedForInterviewTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hrm.applicant_final_selected_list') }}",
                    "data": function(data) {
                        //filter options
                ...
                initComplete: function() {
                    ...
                    <div class="col-8" >
                        <select name="action_type" id="bulk_action_field" class="form-control submit_able form-select" required>
                            ...
                            <option value="bulk_select_for_interview" id="bulk_select_for_interview">Bulk Select For Offer Letter</option>
