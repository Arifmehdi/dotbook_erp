...
@section('content')
    <div class="body-wraper">
        ...
        <div class="main__content">
            <div class="sec-name">
                <div class="name-head">
                    <h6>@lang(__('Job Applicant List'))</h6>
                </div>
                <x-all-buttons>
                    <x-slot name="after">
                        <x-help-button />
        ...
        <div class="p-15 pt-0">
                    ...
                    <div class="card-counter-wrap my-2">
                        <div class="row g-2">
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('hrm.job_applicant_list') }}">
                                    <div class="card-counter alert-primary">
                                        ...
                                        <div class="numbers px-1">
                                            <h3 class="sub-title">{{ __('Applied') }}</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('hrm.interview_participate_list') }}">
                                    <div class="card-counter alert-info">
                                        <div class="top-box">
                                            ...
                                            <h1 class="title">
                                                <strong>
                                                    {{ $interviewParticipatesCount }}
                                                </strong>
                                            </h1>
                                        </div>
                                        <div class="numbers px-1">
                                            <h3 class="sub-title">{{ __('Interview') }}</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('hrm.applicant_hired_list') }}">
                                    <div class="card-counter alert-success">
                                        <div class="top-box">
                                            ...
                                            <h1 class="title">
                                                <strong>
                                                    {{ $applicantsHiredCount }}
                                                </strong>
                                            </h1>
                                        </div>
                                        <div class="numbers px-1">
                                            <h3 class="sub-title">{{ __('Hired') }}</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('hrm.applicant_reject_list') }}">
                                    <div class="card-counter alert-danger">
                                        <div class="top-box">
                                            ...
                                            <h1 class="title">
                                                <strong>
                                                    {{ $applicantsRejectListCount }}
                                                </strong>
                                            </h1>
                                        </div>
                                        <div class="numbers px-1">
                                            <h3 class="sub-title">{{ __('Rejected') }}</h3>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <form id="bulk_action_form" action="{{ route('hrm.applicant_select_bulk-action') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="bulk_action">
                            <div class="table-responsive p-0 h-350" id="data-list">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('.selectedForInterviewTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('hrm.job_applicant_list') }}",
                    "data": function(data) {
                        console.log(data);
                        //filter options
                ...
                initComplete: function() {
                    ...
                    <div class="form-group row align-items-end g-2 me-1">
                        <div class="col-xl-2 col-md-4" >
                            <select name="action_type" id="bulk_action_field" class="form-control submit_able form-select" required>
                                <option value="" selected>Bulk Actions</option>
                                <option value="bulk_select_for_interview" id="bulk_select_for_interview">Bulk Select For Interview</option>
