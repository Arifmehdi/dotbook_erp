...
@section('content')
    <div class="body-wraper">
        ...
        <form id="bulk_action_form" action="{{ route('hrm.interview_question_bulk_action') }}" method="POST">
            <div class="p-15">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
        ...
        <div class="modal-dialog double-col-modal" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form id="add_form" action="{{ route('hrm.interview_question_store') }}" method="POST"
                        ...
                        <div class="form-group row mt-1">
                            <div class="col-xl-12 col-md-12">
                                ...
                                <input type="text" name="title" class="form-control"
                                    data-name="{{ __('Interview Title') }}" id="title"
                                    placeholder="{{ __('Interview Title') }}" required />
                                <span class="error error_title"></span>
                            </div>
                            <div class="col-xl-12 col-md-12">
                                <label><strong> {{ __('Description') }}</strong> <span class="text-danger">*</span></label>
                                <textarea class="form-control ckEditor" name="description" id="description" rows="7">
                                </textarea>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('.leave-type-table').DataTable({
                ...
                searchable: true,
                "ajax": {
                    "url": "{{ route('hrm.interview_question_list') }}",
                    "data": function(data) {
