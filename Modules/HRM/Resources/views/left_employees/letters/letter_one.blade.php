    ...
    <div class="main">
        <div class="main_content_wrapper">
           ...
           <div id="header">
                <div class="header_wrapper">
                    ...
                    <div class="company_title">
                        ...
                        {{-- <p class="company_desc">{{ $settings->company_slogan ?? '' }}</p> --}}
                    </div>
                </div>
           </div>
           ...
           <div class="present_address mt-1">
               {{-- <table class="d-block">
                   <tr class="d-block">
                       <td style="width:30%;"><b>বর্তমান ঠিকানাঃ</b>{{ $employee->present_address }}</td>
           ...
           <div class="permanent_address" style="margin-top: 10px;">
               {{-- <table class="d-block">
                   <tr class="d-block">
                       ...
                       <td style="width: 45%;">
                           <p>গ্রামঃ <span class="relative">{{ $employee->present_village }}<span class="absolute d-content-span"></span></span></p>
           ...
           <div class="letter_body">
                ...
                <p class="b-font" style="margin-top: 6px;">আপনি গত <span class="relative"><span class="absolute d-content-span"></span> </span> তারিখ থেকে কারখানা কতৃপক্ষ্যের বিনা অনুমতিতে কর্মস্থলে অনুপস্থিত রয়েছেন। আপনার এরুপ অনুপস্থিতি
