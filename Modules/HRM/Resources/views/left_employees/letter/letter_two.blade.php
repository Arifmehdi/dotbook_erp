    ...
    <style>
        ...
        * {
        ...
        .letter_body {line-height: 1.6rem;}
    ...
    <div class="main">
        <div class="main_content_wrapper">
           ...
           <div class="letter_body">
                ...
                <p class="b-font">আপনি গত<span class="relative"> {{ $date }} <span class="absolute d-content-span"></span></span>তারিখ থেকে কারখানা কতৃপক্ষ্যের বিনা অনুমতিতে কর্মস্থলে অনুপস্থিত রয়েছেন। এ প্রেক্ষিতে কারখানা
                ...
                <p class="b-font" style="margin-top: 10px;">সুতরাং অত্র পত্র পাপ্তির ১০(দশ) দিনের মধ্যে আত্বপক্ষ সমর্থন সহ কাজে যোগদান করিতে আপনাকে নির্দেশ দেওয়া গেল ।</p>
                <p class="b-font" style="margin-top: 10px;">উক্ত সময়ের মধ্যে আপনি আত্বপক্ষ সমর্থনের জবাব সহ কাজে যোগদান করতে ব্যার্থ হলে বাংলাদেশ শ্রম-আইন ২০০৬ এর
                    ২৭(৩ক) ধারা অনুযায়ী আপনি স্বেচ্ছায় চাকুরি থেকে অব্যাহতি গ্রহন করেছেন বলে গন্য হবে।
                </p>
           </div>

           <div class="letter_sign" style="margin-top: 30px; line-height: 1.4rem;">
