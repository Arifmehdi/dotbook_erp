    ...
    <div class="body-wraper">
        <div class="sec-name">
            <div class="employee-header">
                <h6>{{ __('Attendance Rapid Update') }}</h6>
            </div>
            <x-all-buttons />
        </div>
        <div class="p-15">
                ...
                <div class="col-md-12">
                    <div class="form_element m-0 rounded">
                        <div class="element-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('hrm.attendance.employeeWiseRapidUpdate') }}" method="get"
                                        id="filter_form">
                                        @csrf
                                        <div class="form-group row align-items-end g-2">
                                            ...
                                            <div class="col-xl-3 col-md-4">
                                                <button href="#" class="btn btn-sm btn-info">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="form_element m-0 rounded">
                        <div class="element-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('hrm.attendance.dateWiseRapidUpdate') }}" id="filter_form">
                                        <div class="form-group row align-items-end g-2">
                                            <div class="col-xl-3 col-md-4">
                                                <label><strong>{{ __('Select Date') }} </strong></label>
