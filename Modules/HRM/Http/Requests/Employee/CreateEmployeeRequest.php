    ...
    public function rules()
    {
        ...
        if (request()->p_same == 1) {
            ...
            $addressRules = [
                ...
                'present_union_id' => 'required|numeric',
        ...
        $create_employee_rules = [
            ...
            'emergency_contact_person_name' => 'required|string|max:255',
            'emergency_contact_person_phone' => 'required|string|max:255',
            'emergency_contact_person_relation' => 'required|string|max:255',

            'permanent_division_id' => 'required|numeric',
            'permanent_district_id' => 'required|numeric',
            'permanent_upazila_id' => 'required|numeric',
            'permanent_union_id' => 'required|numeric',
            'permanent_village' => 'required|string|max:255',

            'employee_id' => 'required|string|unique:hrm.employees,employee_id',
        ...
        $rules = array_merge($employeeRules, $create_employee_rules);
