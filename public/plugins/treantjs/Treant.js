...
;( function() {
    ...
    TreeNode.prototype = {
        ...
        reset: function( nodeStructure, id, parentId, tree, stackParentId ) {
            ...
            this.collapsable = nodeStructure.collapsable === true ? false : ( nodeStructure.collapsable || tree.CONFIG.node.collapsable );
    ...
    Tree.CONFIG = {
        ...
        padding: 25, // the difference is seen only when the scrollbar is shown
